...
- **radiusRange** is a Float value between 0 (surface only) and 1 (full volume) that controls the randomization factor for spawn radius.
...
- **Min** provides the minimum value constraint. Adding a min value will add a slider control to the value property and on the value in the inspector if Display in the Inspector is checked.
- **Max** provides the maximum value constraint. Adding a max value will add a slider control to the value property and on the value in the inspector if Display in the Inspector is checked.
- **Value** is the Float value set on the block.
- **Mode** allows the user to select between user-defined, contextual, or system values for this block.
- **Visible on frame** toggles the display of this block's value in the Inputs section of the frame when the frame is collapsed.
- **Display in the Inspector** toggles the display of this block's name and an editable value in the inputs section for the node particle system in the inspector.
- **Inspector Group** is an optional string that can be assigned to create a group for this block in the inspector. Assigning the same string to multiple blocks will display them under a common group name.
...
- **Mode** allows the user to select between user-defined, contextual, or system values for this block.
- **Contextual Value** allows the user to select which contextual value for the particle is referenced when Mode is set to Contextual Value.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Add.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Divide.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Max.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Min.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Multiply.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Subtract.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Modulo.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Pow.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Negate.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to OneMinus.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Reciprocal.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Sign.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Sqrt.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Round.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Floor.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Ceiling.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Dot.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Distance.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Abs.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to ArcCos.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to ArcSin.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to ArcTan.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Cos.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Exp.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Exp2.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Log.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Sin.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Tan.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to ToDegrees.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to ToRadians.
...
- **Operation** determines which math operation to perform on the inputs to this block. Pre-set to Fract.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to Equal.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to NotEqual.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to LessThan.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to LessOrEqual.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to GreaterThan.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to GreaterOrEqual.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to Xor.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to Or.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Test** is the type of logical operation to perform on the inputs. Pre-set to And.
- **epsilon** is a Float value that provides tolerance for the floating-point comparison.
...
- **Reference** sets the number of recent values to keep in the debug log.
...
- **Entry point** is a list of all Teleport In blocks in the graph. Choosing a specific Teleport In block will connect the value and type from the connected Teleport In block to this Teleport Out block.
...
- **Max Simultaneous** sets the maximum number of simultaneously active sub-emitter instances. A value of 0 means unlimited.
- **Delay Between calls (ms)** sets the minimum delay in milliseconds between trigger activations.
