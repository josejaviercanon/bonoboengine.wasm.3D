...
![Grass Procedural texture](/img/extensions/proceduraltextures/grasspt.webp)
...
- **grassColors** is an array of 3 (BABYLON.Color3/4) values for the grass. These should be green, but you can create red grass if you want to
