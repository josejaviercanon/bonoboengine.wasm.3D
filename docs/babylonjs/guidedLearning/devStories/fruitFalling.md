...
![Playground to Web? Android? iOS?](/img/devStories/fruitFalling/question.webp)
...
![The Path: Playground to GitHub to NPM to Ionic](/img/devStories/fruitFalling/answer.webp!800)
...
1.  I logged into my [GitHub](https://github.com/) account.
    ...
    ![GitHub login](/img/devStories/fruitFalling/00_log_in_to_github.webp!250)
...
1.  In a [Git](https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository)-enabled
    ...
    ![cd and git clone](/img/devStories/fruitFalling/03_clone.webp!500)
1.  In an NPM-enabled terminal, I navigated into my new repo and ran
    ...
    ![PowerShell NPM install](/img/devStories/fruitFalling/04_npm_install.webp!500)
1.  Still in the root directory in my NPM-enabled terminal, I ran
    ...
    ![Browser default test app](/img/devStories/fruitFalling/05_default_test_app.webp!700)
1.  I then went back to the
    ...
    ![Copying my Playground](/img/devStories/fruitFalling/06_sprites_orthographic_falling.webp!500)
...
1.  While the NPM Package Template is designed to make it as easy as
    ...
    ![Playground.ts pasted in](/img/devStories/fruitFalling/08_update_babylon.webp!500)
1.  After making that change and running
    ...
    ![New browser Playground](/img/devStories/fruitFalling/09_playground_test_app.webp!500)
1.  One more change required! Since my code had been hosted on the
    ...
    ![Raw sprite location](/img/devStories/fruitFalling/10_raw_sprite_location.webp!700)

1.  After saving that change, all I had to do was save the file
    and wait for the test app in my browser to auto-refresh.

    ![It's working!](/img/devStories/fruitFalling/11_playground_test_app.webp!500)
...
1.  As before, I ran
    ...
    ![Asset server](/img/devStories/fruitFalling/12_asset_host_terminal.webp!500)
1.  To double-check that my server was working, I opened
    http://127.0.0.1:8181/example.txt and saw the text

    ![Browser screenshot](/img/devStories/fruitFalling/13_example_txt.webp!500)
1.  Next, I downloaded a copy of
    ...
    ![Player.png in the docs folder](/img/devStories/fruitFalling/14_assets_docs_folder.webp!350)
...
1.  Of course, once that reload happened, I realized I wouldn't be able
    ...
    ![Test app without and with correct sprite name](/img/devStories/fruitFalling/15_wrong_name_right_name.webp!500)
...
1.	I pulled apart and deleted `playground.ts` just as fast as I could.
    ...
    ![The BABYLON import](/img/devStories/fruitFalling/16_babylon_import.webp!350)
...
1.  I cleaned out the unused dependencies from the NPM Package Template
    ...
    ![Excess NPM package deletion](/img/devStories/fruitFalling/17_npm_package_deletion.webp!500)
1.  To make sure I was rendering under the intended circumstances, I
    ...
    ![index.js in test_package](/img/devStories/fruitFalling/18_index_js_in_test_package.webp!600)
1.  I used `Scene`s as a unit of organization for my game logic.

    ![Scenes used in runtime.ts](/img/devStories/fruitFalling/19_scenes_in_runtime_ts.webp!400)
...
1.  I made the consuming app (in this repo, the test app) responsible for
    ...
    ![index.js asset location code](/img/devStories/fruitFalling/21_asset_location_code.webp!500)
...
1.	GitHub Pages essentially allows you to serve static sites from certain
    ...
    *extremely* straight forward to get GitHub Pages to host your assets. To start, I
    ...
    ![Asset Host web view](/img/devStories/fruitFalling/22_asset_host_repo.webp!600)
1.  On that repo's browser site, I opened up the Settings tab, then
    scrolled down and clicked on Pages.

    ![Settings -> Pages](/img/devStories/fruitFalling/23_settings_pages.webp!400)
1.  I chose the main branch as my source, then selected `docs` as the
    ...
    ![Assets in the browser](/img/devStories/fruitFalling/24_pages_main_docs.webp!600)
1.  Next, I wanted to make the test app change its behavior depending on
    ...
    ![Checking the DEV_BUILD variable](/img/devStories/fruitFalling/25_checking_dev_variable.webp!500)
...
1.  I next ran `git status` just to confirm that the files in the `docs`
    ...
    ![They had](/img/devStories/fruitFalling/26_npm_run_build_status.webp!500)
...
1.  With that done, all that was left was to commit the built site, push
    ...
    ![GitHub Pages again](/img/devStories/fruitFalling/27_source_repo_github_pages.webp!500)
...
2.  Since I didn't need to
    ...
    ![app_package/package.json](/img/devStories/fruitFalling/28_app_package_json.webp!500)
...
1.  I declined to use the App Creation Wizard, selected a React frontend,
    ...
    ![Ionic options](/img/devStories/fruitFalling/29_ionic_start.webp!600)
...
1.  My first command to add Android created a folder in my Ionic app's root
    ...
    ![Opening in Android Studio](/img/devStories/fruitFalling/30_opening_android.webp!500)
...
1.  Using Android Studio is beyond the scope of this article, but once
    ...
    ![The default app on an AVD](/img/devStories/fruitFalling/31_default_ionic_avd.webp!300)
...
the assets needed to be added a different way. I could technically have
    ...
    ![The new assets folder](/img/devStories/fruitFalling/32_new_assets_folder.webp!500)
...
1.  Finally, I once again opened the `android` folder in Android Studio,
    ...
    ![Fruit Fallin' on AVD](/img/devStories/fruitFalling/34_ionic_fruit_fallin_avd.webp!300)
...
![What next?](/img/devStories/fruitFalling/check_plus.webp!100)
