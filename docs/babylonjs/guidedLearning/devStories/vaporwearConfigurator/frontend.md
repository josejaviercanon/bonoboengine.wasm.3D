...
1.  Using a logo from among the files provided by Allan from Vaporwear,
    ...
    ![Header component](/img/devStories/vaporwearConfigurator/chapter_frontend/01_header_js_1_24.webp)
1.  Similarly, she added quick drafts of the title and "byline" 
    ...
    ![Bylines](/img/devStories/vaporwearConfigurator/chapter_frontend/02_bylines.webp)
1.  Since she didn't yet have the 3D components and wasn't exactly sure
    ...
    ![App.js draft](/img/devStories/vaporwearConfigurator/chapter_frontend/03_app_js_9_24.webp)
1.  With the draft site working, she could have 
    ...
    ![GitHub Pages hosting](/img/devStories/vaporwearConfigurator/chapter_frontend/04_github_pages.webp)
...
1.  When the 3D experience was ready, it came in the form of a private
    ...
    ![Files in public folder](/img/devStories/vaporwearConfigurator/chapter_frontend/05_files_in_public_folder.webp)
...
1.  The heart of the Babylon Experience component, from Edie's perspective,
    ...
    ![Babylon Experience CSS](/img/devStories/vaporwearConfigurator/chapter_frontend/07_babylonExperience_css_1_7.webp)
1.  With both the canvas and the 3D assets available, Edie was able to 
    ...
    ![Babylon Experience implementation](/img/devStories/vaporwearConfigurator/chapter_frontend/08_babylonExperience_js_63_71.webp)
1.  She added an event listener to handle updates to "hotspot" 
    positions...

    ![Hotspot definitions](/img/devStories/vaporwearConfigurator/chapter_frontend/09_babylonExperience_js_135_143.webp)

    ![Hotspot placement](/img/devStories/vaporwearConfigurator/chapter_frontend/10_babylonExperience_js_75_89.webp)
1.  ...pegged the app state to the scroll position...
    
    ![Scroll state logic](/img/devStories/vaporwearConfigurator/chapter_frontend/11_babylonExperience_js_105_128.webp)
...
1.  Other elements required tweaking to accommodate the new behavior, and
    ...
    ![App.js final](/img/devStories/vaporwearConfigurator/chapter_frontend/13_app_js_8_20.webp)
1.  And thus, at long last, the new Vaporwear e-commerce site was ready
    ...
    ![Final site](/img/devStories/vaporwearConfigurator/chapter_frontend/14_live_site.webp)
