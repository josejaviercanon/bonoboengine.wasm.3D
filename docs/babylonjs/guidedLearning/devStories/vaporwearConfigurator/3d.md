...
1. Thus, she began by creating an NPM package repo and an asset host
    ...
    ![Relevant sections from another dev story](/img/devStories/vaporwearConfigurator/chapter_3d/01_fruit_fallin.webp)

1. She added Carlos's art assets to her asset host repo as soon as those
    were available.

    ![Files in folder](/img/devStories/vaporwearConfigurator/chapter_3d/02_files_in_folder.webp)
...
1. Diane chose to use her NPM package repo's `test_package` as
    ...
    ![Test package index.js](/img/devStories/vaporwearConfigurator/chapter_3d/03_test_package_indexjs.webp)
...
1. The first step to getting the watch to display was to download it.
    ...
    ![Watch download code](/img/devStories/vaporwearConfigurator/chapter_3d/04_download_watch.webp)
...
1. When Babylon imports a glTF that includes animations, it automatically
    ...
    ![Cache animations](/img/devStories/vaporwearConfigurator/chapter_3d/05_cache_animation.webp)
...
1. To avoid having to worry about the camera until later, Diane just used
    ...
    ![The watch rendering](/img/devStories/vaporwearConfigurator/chapter_3d/06_watch_rendering.webp)

1. However, this _wasn't_ rendering using the 3D Commerce-certified
    ...
    ![3D Commerce settings](/img/devStories/vaporwearConfigurator/chapter_3d/07_3d_commerce_settings.webp)
...
1. With the watch now rendering in its default state, the next step was
    ...
    ![States enum](/img/devStories/vaporwearConfigurator/chapter_3d/08_showroom_ts_43_51.webp)
...
1. To be able to test this behavior, Diane added a `createDebugUI`
    ...
    ![Debug UI](/img/devStories/vaporwearConfigurator/chapter_3d/09_state_control_gui.webp)

1. Finally, Diane added the dynamic watch face using Babylon's GUI and
    a simple coroutine mechanism to update the text.

    ![Dynamic watch face](/img/devStories/vaporwearConfigurator/chapter_3d/10_watch_ts_136_165.webp)
...
1. The first part of Diane's loading trick was to delay loading the
    ...
    ![Config asset loading logic](/img/devStories/vaporwearConfigurator/chapter_3d/11_config_assets_load.webp)
...
1. However, the side effect of this approach was that entering the
    ...
    ![Assets pre-fetch trick](/img/devStories/vaporwearConfigurator/chapter_3d/12_assets_pre-fetch.webp)
...
1. Other than loading, the only slightly complex part of enabling
    ...
    ![Bone caching](/img/devStories/vaporwearConfigurator/chapter_3d/13_watch_ts_117_118.webp)
    ...
    ![Attach studs](/img/devStories/vaporwearConfigurator/chapter_3d/14_showroom_ts_146_150.webp)
...
1. With all the assets loaded and set up as required, enabling
    ...
    ![Studs enabling/disabling](/img/devStories/vaporwearConfigurator/chapter_3d/15_showroom_ts_77_79.webp)
...
1. ...and setting named materials on named meshes, which Diane chose to
    ...
    ![Setting materials](/img/devStories/vaporwearConfigurator/chapter_3d/16_showroom_ts_213_221.webp)

1. Finally, Diane added GUI elements to the test UI to allow her to test
    the new configuration options.

    ![More GUI elements](/img/devStories/vaporwearConfigurator/chapter_3d/17_showroom_ts_276_onward.webp)
...
1. First, Diane needed to add the Showroom Camera Babylon Utility as
    ...
    ![npm install](/img/devStories/vaporwearConfigurator/chapter_3d/18_install_dependency.webp)
...
1. She then replaced the `ArcRotateCamera` she'd been using temporarily
    ...
    ![Make showroom camera](/img/devStories/vaporwearConfigurator/chapter_3d/19_make_showroom_camera.webp)
...
1. To get the full and correct camera behavior, however, Diane needed to
    ...
    ![Showroom camera states](/img/devStories/vaporwearConfigurator/chapter_3d/20_showroom_camera_states.webp)
...
1. ...a nuance of Carlos's art assets is that they had been created in
    ...
    ![Camera null transformation](/img/devStories/vaporwearConfigurator/chapter_3d/21_watch_ts_121_134.webp)
...
1. With that fixed, all that was left was to set the camera to transition
    ...
    ![Camera state transitions](/img/devStories/vaporwearConfigurator/chapter_3d/22_showroom_ts_50_73.webp)
...
1. ...and create a mechanism for tracking and reporting the "hotspot"
    ...
    ![Matchmove hotstpot visibility](/img/devStories/vaporwearConfigurator/chapter_3d/23_watch_ts_275_281.webp)
    ...
    ![Arc-rotate hotspot visibility](/img/devStories/vaporwearConfigurator/chapter_3d/24_watch_ts_308_312.webp)
    ...
    ![Hotspot state](/img/devStories/vaporwearConfigurator/chapter_3d/25_watch_ts_61_64.webp)

And, just like that, the Vaporwear 3D experience was feature-complete.

![Watch animated transition](/img/devStories/vaporwearConfigurator/chapter_3d/26_watch_transition.webp)
...
1. For most features, Diane decided to just make invocation string-based
    ...
    ![String-based API](/img/devStories/vaporwearConfigurator/chapter_3d/27_vaporwearExperience_ts_56_74.webp)
...
1. For the "hotspots," Diane chose to emulate the `addEventListener`
    ...
    ![addEventListener pattern](/img/devStories/vaporwearConfigurator/chapter_3d/28_vaporwearExperience_ts_107_123.webp)
...
1. Camera parameter settings were actually not a part of the first
    ...
    ![Camera parameters](/img/devStories/vaporwearConfigurator/chapter_3d/29_vaporwearExperience_ts_48_54.webp)
...
1. Finally, it was time to make the Vaporwear 3D experience available for
    ...
    ![npm publish](/img/devStories/vaporwearConfigurator/chapter_3d/30_npm_publish.webp)
