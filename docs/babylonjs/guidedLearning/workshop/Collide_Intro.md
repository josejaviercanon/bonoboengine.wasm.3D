...
image: 
description: A collision system built using just Babylon.js code with no physics engines
...
The aim of this series of tutorials is to consider how a collision system can be built using just Babylon.js code (i.e. no physics engines). Some of the issues involved in developing such a system are described. The ideas in this tutorial can be used to build a collision system for complex shapes. 
...
To begin with, the frame rate will be taken as constant throughout the animation, and the speed of any shape will be in units per frame.
