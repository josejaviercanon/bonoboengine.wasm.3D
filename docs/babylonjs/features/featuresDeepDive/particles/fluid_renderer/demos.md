...
|-----------------|-----------------------------------|
|![image](/img/features/fluidrenderer/demo_psys.webp!488)|![image](/img/features/fluidrenderer/demo_psys_fluid.webp!488)|

If you use the **Generate Diffuse Texture** parameter:

![image](/img/features/fluidrenderer/demo_psys_wdiffuse.webp)

With the generated diffuse texture being:

![image](/img/features/fluidrenderer/demo_psys_diffuse.webp)
...
![image](/img/features/fluidrenderer/demo_precomputed.webp)
...
![image](/img/features/fluidrenderer/demo_box_2.webp)
...
![image](/img/features/fluidrenderer/demo_heightmap_1.webp)

Instead of a basic water jet, you can inject particles according to some predefined shapes:

![image](/img/features/fluidrenderer/demo_heightmap_2.webp)
...
![image](/img/features/fluidrenderer/demo_heightmap_3.webp)

![image](/img/features/fluidrenderer/demo_heightmap_4.webp)
...
![image](/img/features/fluidrenderer/demo_glass_1.webp)

![image](/img/features/fluidrenderer/demo_glass_2.webp)

## Mesh SDF

PG: <Playground id="#XMXDAA#165" image="/img/playgroundsAndNMEs/pg-XMXDAA-117.webp" title="Mesh SDF" description="Example of real fluid simulation collision with mesh SDF"/>
...
![image](/img/features/fluidrenderer/demo_meshsdf_1.webp)

![image](/img/features/fluidrenderer/demo_meshsdf_2.webp)
