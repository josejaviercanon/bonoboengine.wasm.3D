...
Adjust emit power and update speed: <Playground id="#0K3AQ2#3939" title="Adjust Emit Power And Update Speed" description="Simple example of adjusting emit power and update speed."/>  
Cell Change Speed: <Playground id="#0K3AQ2#3941" title="Cell Change Speed" description="Simple example of adjusting the cell change speed."/>
