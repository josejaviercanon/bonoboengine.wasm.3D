...
## Torus Knot
A torus knot is a continuous shape that twists and turns around the surface of a torus. The number of twists and turns is determined by two winding integers, p and q. The simplest torus knot uses 2 and 3 for p and q. The origin of the created torus knot is at the center of the underlying torus.
