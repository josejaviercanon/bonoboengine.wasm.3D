...
The created capsule has its origin at the center of the capsule. The height minus the sum of the top and bottom radii must be > 0.
...
--------|-----|-------------
orientation?|_(Vector3)_ Direction of the capsule on creation. | Vector3.Up
...
radiusTop?|_(number)_  Override for the top radius.
radiusBottom?|_(number)_  Override for the bottom radius.
topCapSubdivisions?|_(number)_ Override for the top capSubdivisions.
bottomCapSubdivisions?|_(number)_ Override for the bottom capSubdivisions.
...
Forward orientation: <Playground id="#CL6HZ0#2" title="Create a Capsule With Forward Orientation" description="Simple example of creating a capsule with forward orientation."/>
