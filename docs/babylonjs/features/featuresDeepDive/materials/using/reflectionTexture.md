...
image: /img/playgroundsAndNMEs/divingDeeperReflectionRefraction2.webp
...
<p><Playground id="#UU7RQ#3" title="Cube Reflecting Skybox" description="A cube reflecting skybox images." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction2.webp"/>
<Playground id="#UU7RQ#5" title="Ground Reflecting Skybox" description="A ground plane reflecting skybox images." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction3.webp"/>
<Playground id="#UU7RQ#4" title="Sphere Reflecting Skybox" description="A sphere reflecting skybox images." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction4.webp"/></p>
...
<Playground id="#RY8LDL#32" title="Spheres Reflecting Equirectangular Skybox" description="Reflections and refractions of an equirectangular skybox panorama." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction9.webp"/>
...
<p><img src="/img/how_to/Materials/mona_lisa_head.webp" width="200" height="200" caption="Example flat texture (Mona Lisa)" alt="Mona Lisa's head"/></p>

<p><Playground id="#UU7RQ#1629" title="Mona Lisa in SPAAAACE, reflected using PLANAR_MODE" description="A sphere reflecting a flat Mona Lisa texture." image="/img/playgroundsAndNMEs/pg-UU7RQ-1627.webp"/></p>
...
<p><Playground id="#KA93U#243" title="Reflection Probes" description="Moving shapes reflecting each other and the ground using reflection probes." image="/img/playgroundsAndNMEs/divingDeeperReflectionProbes1.webp"/></p>
...
<p><Playground id="#1YAIO7#747" title="Mirrors" description="Several mirrors surrounding a sphere." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction11.webp"/></p>
...
<p><Playground id="#LVTTQX#1" title="Reflection Blur" description="A shape reflected in a surface with blurring." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction12.webp"/></p>
...
<p><Playground id="#22KZUW#15" title="Refraction" description="A refractive disc in a simple scene." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction13.webp"/></p>
...
<p>
<Playground id="#1YAIO7#19" title="Changing Index Of Refraction" description="A plate with varying index of refraction." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction15.webp"/>
<Playground id="#1YAIO7#20" title="Changing Refraction Depth" description="A plate with varying refraction depth." image="/img/playgroundsAndNMEs/divingDeeperReflectionRefraction14.webp"/>
</p>
...
|                                             +x (right)                                             |                                             -x (left)                                              |                                              +y (up)                                               |                                             -y (down)                                              |                                             +z (back)                                              |                                             -z (front)                                             |
| :------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------: |
| <img src="/img/how_to/Materials/testcube_px.webp" width="100" height="100" alt="RGT test pattern"/> | <img src="/img/how_to/Materials/testcube_nx.webp" width="100" height="100" alt="LFT test pattern"/> | <img src="/img/how_to/Materials/testcube_py.webp" width="100" height="100" alt="TOP test pattern"/> | <img src="/img/how_to/Materials/testcube_ny.webp" width="100" height="100" alt="BOT test pattern"/> | <img src="/img/how_to/Materials/testcube_pz.webp" width="100" height="100" alt="BCK test pattern"/> | <img src="/img/how_to/Materials/testcube_nz.webp" width="100" height="100" alt="FRT test pattern"/> |
...
<img src="/img/how_to/Materials/letter_grid.webp" width="200" height="200" alt="Letters A-Y in a grid"/><br/>
