---
title: The .babylon File Format
image: 
description: Dive deep into the inner workings of the .babylon file format.
keywords: babylon.js, advanced, .babylon
further-reading:
video-overview:
video-content:
---
...
## Basic types
.babylon files use the following conventions for basic types:
...
## Global structure
The global structure of a .babylon file is as follows:
...
    "autoAnimateLoop": boolean (can be omitted),
	...
	"spriteManagers":array of SpriteManagers (can be omitted)
}
```
## Cameras
...
## Instances
An instance is defined by the following JSON:
```javascript
{
    "name": string,
    "tags": string,
...
Please note that a parent mesh must be described before its child nodes.
...
## Example
Here is a simple example of a .babylon file:
```javascript
{
    "autoClear": true,
    "clearColor": [0, 0, 0],
...
"spriteManagers": [
{
	...
	"texture": {
		"tags": null,
		"url": "https://assets.babylonjs.com/textures/palm.png",
		"uOffset": 0,
		"vOffset": 0,
		"uScale": 1,
		"vScale": 1,
		...
		"isBlocking": true,
		"name": "https://assets.babylonjs.com/textures/palm.png",
		"hasAlpha": false,
		...
		"internalTextureLabel": "https://assets.babylonjs.com/textures/palm.png",
		"noMipmap": true
	},
	"sprites": [
		{
...
```
## SpriteManagers
A SpriteManager is defined by the following JSON:
```javascript
[
{
	"name": string,
...
```
## Sprites
A Sprite is defined by the following JSON:
```javascript
[
	{
		"name": string,
