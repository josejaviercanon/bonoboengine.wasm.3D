...
import { n as t, t as n } from "./engineStore-D0BoPdea.js";
import { t as r } from "./internalTexture-BAv1VWAH.js";
import { t as i } from "./logger-DQIzSR_y.js";
import { t as a } from "./shaderStore-CXjvw9c2.js";
import { _ as o, a as s, b as c, d as l, f as u, i as d, l as f, o as p, r as m, t as h, u as g, v as _, x as v, y } from "./precisionDate-BBQlwGEL.js";
import { t as b } from "./performanceConfigurator-DBCxCnir.js";
...
function ie(e, t, n, r, i, a, o) {
	let c, l, u = v() ? a?.getHostDocument() : null;
	...
	let f = [void 0, void 0], m = () => {
		if (f[0] && f[1]) {
			let [c, l] = f;
			s(e), p(c, e, (s, c) => {
				o && (o._vertexSourceCodeBeforeMigration = c), n && (s = n("vertex", s)), e.isFragment = !0, p(l, e, (a, c) => {
					o && (o._fragmentSourceCodeBeforeMigration = c), n && (a = n("fragment", a));
					let l = d(s, a, e);
					e = null;
					let u = ae(l.vertexCode, l.fragmentCode, t, i);
	...
	F(c, "Vertex", "", (e) => {
		o && (o._rawVertexSourceCode = e), f[0] = e, m();
	}, i), F(l, "Fragment", "Pixel", (e) => {
		o && (o._rawFragmentSourceCode = e), f[1] = e, m();
	}, i);
}
function F(e, t, n, r, i, o) {
	...
	let c;
	if (c = e[0] === "." || e[0] === "/" || e.indexOf("http") > -1 ? e : a.GetShadersRepository(i) + e, o ||= u, !o) throw Error("loadFileInjection is not defined");
	o(c + "." + t.toLowerCase() + ".fx", r);
}
function ae(e, t, n, r) {
	if (n) {
...
var I = (e, t, n, r) => {
	try {
		let i = e.context ? w(e.context) : null;
		i && (i.disableParallelShaderCompile = e.disableParallelCompilation);
		let a = e.existingPipelineContext || t(e.shaderProcessingContext);
		return a._name = e.name, e.name && i && (i.cachedPipelines[e.name] = a), n(a, e.vertex, e.fragment, !!e.createAsRaw, "", "", e.rebuildRebind, e.defines, e.transformFeedbackVaryings, "", () => {
			r(a, () => {
				e.onRenderingStateCompiled?.(a);
			});
		}), a;
	} catch (e) {
		throw i.Error("Error compiling effect"), e;
	}
}, L = class e {
	static get ShadersRepository() {
		return a.ShadersRepository;
	}
	static set ShadersRepository(e) {
		a.ShadersRepository = e;
	}
	get isDisposed() {
	...
	constructor(n, r, i, a = null, o, s = null, c = null, l = null, u = null, d, f = "", p = 0, m) {
		...
		this._engine.shaderPlatformName === "WEBGL2" && (g = re(h, this._engine._gl) ?? g), this._attributeLocationByName = {}, this.uniqueId = e._UniqueIdSeed++, g ? (this._pipelineContext = g, this._pipelineContext.setEngine(this._engine), this._onRenderingStateCompiled(this._pipelineContext), this._pipelineContext.program && (this._pipelineContext.program.__SPECTOR_rebuildProgram = this._rebuildProgram.bind(this))) : this._processShaderCodeAsync(null, !1, null, m).catch((e) => {
	...
	async _processShaderCodeAsync(e = null, t = !1, n = null, r) {
		r && await r(), this._processingContext = n || this._engine._getShaderProcessingContext(this._shaderLanguage, !1), ie({
			...
			shadersRepository: a.GetShadersRepository(this._shaderLanguage),
			includesShadersStore: a.GetIncludesShadersStore(this._shaderLanguage),
	...
	_checkIsReady(e) {
		m(() => this._isReadyInternal() || this._isDisposed, () => {}, (t) => {
	...
	_processCompilationErrors(t, n = null) {
		...
		let r = this._attributesNames, a = this._fallbacks;
		if (i.Error("Unable to compile effect:"), i.Error(`Uniforms: ${this._uniformsNames.join(" ")}`), i.Error(`Attributes: ${r.join(" ")}`), i.Error("Defines:\n" + this.defines), e.LogShaderCodeOnCompilationError) {
			let e = null, t = null, n;
			this._pipelineContext?._getVertexShaderCode() && ([n, e] = this._getShaderCodeAndErrorLine(this._pipelineContext._getVertexShaderCode(), this._compilationError, !1), n && (i.Error("Vertex code:"), i.Error(n))), this._pipelineContext?._getFragmentShaderCode() && ([n, t] = this._getShaderCodeAndErrorLine(this._pipelineContext?._getFragmentShaderCode(), this._compilationError, !0), n && (i.Error("Fragment code:"), i.Error(n))), e && i.Error(e), t && i.Error(t);
		}
		i.Error("Error: " + this._compilationError);
		let o = () => {
		...
		n && (this._pipelineContext = n, this._isReady = !0, o()), a ? (this._pipelineContext = null, a.hasMoreFallbacks ? (this._allFallbacksProcessed = !1, i.Error("Trying next fallback."), this.defines = a.reduce(this.defines, this), this._prepareEffect()) : (this._allFallbacksProcessed = !0, o(), this.onErrorObservable.clear(), this._fallbacks && this._fallbacks.unBindMesh())) : (this._allFallbacksProcessed = !0, n || o());
	}
	get isSupported() {
		return this._compilationError === "";
	}
	...
	dispose(t = !1) {
		...
		this._refCount > 0 || this._isDisposed || (this._onReleaseEffectsObserver &&= (this._engine.onReleaseEffectsObservable.remove(this._onReleaseEffectsObserver), null), this._pipelineContext && P(this._pipelineContext), this._engine._releaseEffect(this), this.clearCodeCache(), this._isDisposed = !0);
	}
	static RegisterShader(e, t, n, r = 0) {
		t && (a.GetShadersStore(r)[`${e}PixelShader`] = t), n && (a.GetShadersStore(r)[`${e}VertexShader`] = n);
	}
	static ResetCache() {
		e._BaseCache = {};
	}
};
L.LogShaderCodeOnCompilationError = !0, L.PersistentMode = !1, L.AutomaticallyClearCodeCache = !1, L._UniqueIdSeed = 0, L._BaseCache = {}, L.ShadersStore = a.ShadersStore, L.IncludesShadersStore = a.IncludesShadersStore;
//#endregion
...
z.ALWAYS = 519, z.KEEP = 7680, z.REPLACE = 7681;
//#endregion
...
var H = class e {
	...
	_flagContextRestored() {
		i.Warn(this.name + " context successfully restored."), this.onContextRestoredObservable.notifyObservers(this), this._contextWasLost = !1;
	}
	...
	_createTextureBase(t, a, o, s, c = 3, l = null, u = null, d, f, p = null, m = null, h = null, g = null, _, v, y) {
		t ||= "";
		let b = t.substring(0, 5) === "data:", x = t.substring(0, 5) === "blob:", S = b && t.indexOf(";base64,") !== -1, C = m || new r(this, 1);
		...
		let D = e.GetCompatibleTextureLoader(E, _);
		...
		let k = (e, r) => {
			s && s.removePendingData(C), t === w ? (O && C.onLoadedObservable.remove(O), n.UseFallbackTexture && t !== n.FallbackTexture && this._createTextureBase(n.FallbackTexture, a, C.invertY, s, c, null, u, d, f, p, C), e = (e || "Unknown error") + (n.UseFallbackTexture ? " - Fallback texture was used" : ""), C.onErrorObservable.notifyObservers({
				message: e,
				exception: r
			}), u && u(e, r)) : (i.Warn(`Failed to load ${t}, falling back to ${w}`), this._createTextureBase(w, a, C.invertY, s, c, l, u, d, f, p, C, h, g, _, v, y));
		};
		if (D) {
			let e = async (e) => {
			...
			!b || S ? p && (typeof p.decoding == "string" || p.close) ? n(p) : e._FileToolsLoadImage(t || "", n, k, s ? s.offlineProvider : null, _, C.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this) : typeof p == "string" || p instanceof ArrayBuffer || ArrayBuffer.isView(p) || p instanceof Blob ? e._FileToolsLoadImage(p, n, k, s ? s.offlineProvider : null, _, C.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this) : p && n(p);
		}
		return C;
	}
	_rebuildBuffers() {
	...
	getHostDocument() {
		return this._renderingCanvas && this._renderingCanvas.ownerDocument ? this._renderingCanvas.ownerDocument : y() ? document : null;
	}
	...
	createRawTexture(e, t, n, r, i, a, s, c, l, u, d, f) {
		throw o("engine.rawTexture");
	}
	createRawCubeTexture(e, t, n, r, i, a, s, c) {
		throw o("engine.rawTexture");
	}
	createRawTexture3D(e, t, n, r, i, a, s, c, l, u, d) {
		throw o("engine.rawTexture");
	}
	createRawTexture2DArray(e, t, n, r, i, a, s, c, l, u, d, f) {
		throw o("engine.rawTexture");
	}
	_sharedInit(e) {
	...
	_setupMobileChecks() {
		navigator && navigator.userAgent && (this._checkForMobile = () => {
			...
			this.hostInformation.isMobile = e.indexOf("Mobile") !== -1 || e.indexOf("Mac") !== -1 && y() && "ontouchend" in document;
	...
	createCanvas(t, n) {
		return e._CreateCanvas(t, n);
	}
	static _FileToolsLoadImage(e, t, n, r, i, a, s) {
		if (!f.loadImage) throw o("FileTools");
		return f.loadImage(e, t, n, r, i, a, s);
	}
	...
	static _FileToolsLoadFile(e, t, n, r, i, a) {
		if (f.loadFile) return f.loadFile(e, t, n, r, i, a);
		throw o("FileTools");
	}
	dispose() {
		...
		this.releaseComputeEffects?.(), L.ResetCache();
		...
		e >= 0 && n.Instances.splice(e, 1), n.Instances.length || (n.OnEnginesDisposedObservable.notifyObservers(this), n.OnEnginesDisposedObservable.clear()), this.onBeginFrameObservable.clear(), this.onEndFrameObservable.clear();
	}
	static DefaultLoadingScreenFactory(e) {
		throw o("LoadingScreen");
	}
	static MarkAllMaterialsAsDirty(e, t) {
		for (let r = 0; r < n.Instances.length; r++) {
			let i = n.Instances[r];
			for (let n = 0; n < i.scenes.length; n++) i.scenes[n].markAllMaterialsAsDirty(e, t);
		}
	}
...
H._RenderPassIdCounter = 0, H._RescalePostProcessFactory = null, H.CollisionsEpsilon = .001, H.QueueNewFrame = V;
//#endregion
...
var se = class {
	...
	postProcessor(e, t, n, r, i) {
		return i.drawBuffersExtensionDisabled && (e = e.replace(/#extension.+GL_EXT_draw_buffers.+(enable|require)/g, "")), e;
	}
}, ce = /(flat\s)?\s*varying\s*.*/, le = class {
	constructor() {
		this.shaderLanguage = 0;
	}
	...
	postProcessor(e, t, n) {
		let r = e.search(/#extension.+GL_EXT_draw_buffers.+require/) !== -1;
		if (e = e.replace(/#extension.+(GL_OVR_multiview2|GL_OES_standard_derivatives|GL_EXT_shader_texture_lod|GL_EXT_frag_depth|GL_EXT_draw_buffers).+(enable|require)/g, ""), e = e.replace(/texture2D\s*\(/g, "texture("), n) {
			let n = e.search(/layout *\(location *= *0\) *out/g) !== -1, i = t.indexOf("#define DUAL_SOURCE_BLENDING") !== -1, a = i ? "layout(location = 0, index = 0) out vec4 glFragColor;\nlayout(location = 0, index = 1) out vec4 glFragColor2;\n" : "layout(location = 0) out vec4 glFragColor;\n";
			i && (e = "#extension GL_EXT_blend_func_extended : require\n" + e), e = e.replace(/texture2DLodEXT\s*\(/g, "textureLod("), e = e.replace(/textureCubeLodEXT\s*\(/g, "textureLod("), e = e.replace(/textureCube\s*\(/g, "texture("), e = e.replace(/gl_FragDepthEXT/g, "gl_FragDepth"), e = e.replace(/gl_FragColor/g, "glFragColor"), e = e.replace(/gl_FragData/g, "glFragData"), e = e.replace(/void\s+?main\s*\(/g, (r || n ? "" : a) + "void main(");
		} else if (t.indexOf("#define VERTEXOUTPUT_INVARIANT") >= 0 && (e = "invariant gl_Position;\n" + e), t.indexOf("#define MULTIVIEW") !== -1) return "#extension GL_OVR_multiview2 : require\nlayout (num_views = 2) in;\n" + e;
		return e;
	}
}, W = class e {
	...
	constructor() {
		this.references = 0, this.capacity = 0, this.is32Bits = !1, this.uniqueId = e._Counter++;
	}
};
W._Counter = 0;
//#endregion
...
var X = class {
	...
	constructor(e = null, t) {
		if (this._MSAARenderBuffers = null, this._context = t, !e && (e = t.createTexture(), !e)) throw Error("Unable to create webGL texture");
		this.set(e);
	}
	setUsage() {}
	set(e) {
	...
	addMSAARenderBuffer(e) {
		this._MSAARenderBuffers ||= [], this._MSAARenderBuffers.push(e);
	}
	releaseMSAARenderBuffers() {
		if (this._MSAARenderBuffers) {
			for (let e of this._MSAARenderBuffers) this._context.deleteRenderbuffer(e);
...
function Z(e) {
	return e === 13 || e === 14 || e === 15 || e === 16 || e === 17 || e === 18 || e === 19;
}
function Q(e) {
	return e === 13 || e === 17 || e === 18 || e === 19;
}
//#endregion
//#region node_modules/@babylonjs/core/Engines/thinEngine.pure.js
var fe = /* @__PURE__ */ e({ ThinEngine: () => $ }), pe = class {}, $ = class e extends H {
	get name() {
		return this._name;
	}
	set name(e) {
	...
	constructor(t, n, r, a) {
		...
		if (t.getContext) {
			...
			if (this._doNotHandleContextLost ? this._onContextLost = () => {
				...
				e.preventDefault(), this._contextWasLost = !0, T(this._gl), i.Warn("WebGL context lost."), this.onContextLostObservable.notifyObservers(this);
			}, this._onContextRestored = () => {
				this._restoreEngineAfterContextLost(() => this._initGLContext());
			}, o.addEventListener("webglcontextrestored", this._onContextRestored, !1), r.powerPreference = r.powerPreference || "high-performance"), o.addEventListener("webglcontextlost", this._onContextLost, !1), this._badDesktopOS && (r.xrCompatible = !1), !r.disableWebGL2Support) try {
				this._gl = o.getContext("webgl2", r) || o.getContext("experimental-webgl2", r), this._gl && (this._webGLVersion = 2, this._shaderPlatformName = "WEBGL2", this._gl.deleteQuery || (this._webGLVersion = 1, this._shaderPlatformName = "WEBGL1"));
			} catch {}
			if (!this._gl) {
				if (!o) throw Error("The provided canvas is null or undefined.");
				try {
					this._gl = o.getContext("webgl", r) || o.getContext("experimental-webgl", r);
				} catch (e) {
					throw Error("WebGL not supported", { cause: e });
				}
			}
			if (!this._gl) throw Error("WebGL not supported");
		} else {
			this._gl = t, o = this._gl.canvas, this._gl.renderbufferStorageMultisample ? (this._webGLVersion = 2, this._shaderPlatformName = "WEBGL2") : this._shaderPlatformName = "WEBGL1";
			let e = this._gl.getContextAttributes();
			e && (r.stencil = e.stencil);
		}
		this._sharedInit(o), this._gl.pixelStorei(this._gl.UNPACK_COLORSPACE_CONVERSION_WEBGL, this._gl.NONE), r.useHighPrecisionFloats !== void 0 && (this._highPrecisionShadersAllowed = r.useHighPrecisionFloats), this.resize(), this._initGLContext(), this._initFeatures();
		for (let e = 0; e < this._caps.maxVertexAttribs; e++) this._currentBufferPointers[e] = new pe();
		this._shaderProcessor = this.webGLVersion > 1 ? new le() : new se();
		let s = `Babylon.js v${e.Version}`;
		i.Log(s + ` - ${this.description}`), this._renderingCanvas && this._renderingCanvas.setAttribute && this._renderingCanvas.setAttribute("data-engine", s);
		let c = w(this._gl);
		c.validateShaderPrograms = this.validateShaderPrograms, c.parallelShaderCompile = this._caps.parallelShaderCompile;
	}
	_clearEmptyResources() {
	...
	areAllEffectsReady() {
		for (let e in this._compiledEffects) if (!this._compiledEffects[e].isReady()) return !1;
		return !0;
	}
	_initGLContext() {
		this._caps = {
		...
		if (this._webGLVersion > 1) this._caps.depthTextureExtension = !0;
			...
			let e = this._gl.getExtension("WEBGL_depth_texture");
			e != null && (this._caps.depthTextureExtension = !0, this._gl.UNSIGNED_INT_24_8 = e.UNSIGNED_INT_24_8_WEBGL);
		}
		if (this.disableVertexArrayObjects) this._caps.vertexArrayObject = !1;
			...
			let e = this._gl.getExtension("OES_vertex_array_object");
			e != null && (this._caps.vertexArrayObject = !0, this._gl.createVertexArray = e.createVertexArrayOES.bind(e), this._gl.bindVertexArray = e.bindVertexArrayOES.bind(e), this._gl.deleteVertexArray = e.deleteVertexArrayOES.bind(e));
		}
		if (this._webGLVersion > 1) this._caps.instancedArrays = !0;
		else {
			let e = this._gl.getExtension("ANGLE_instanced_arrays");
			e == null ? this._caps.instancedArrays = !1 : (this._caps.instancedArrays = !0, this._gl.drawArraysInstanced = e.drawArraysInstancedANGLE.bind(e), this._gl.drawElementsInstanced = e.drawElementsInstancedANGLE.bind(e), this._gl.vertexAttribDivisor = e.vertexAttribDivisorANGLE.bind(e));
		}
		if (this._gl.getShaderPrecisionFormat) {
			let e = this._gl.getShaderPrecisionFormat(this._gl.VERTEX_SHADER, this._gl.HIGH_FLOAT), t = this._gl.getShaderPrecisionFormat(this._gl.FRAGMENT_SHADER, this._gl.HIGH_FLOAT);
			if (e && t && (this._caps.highPrecisionShaderSupported = e.precision !== 0 && t.precision !== 0, this._caps.shaderFloatPrecision = Math.min(e.precision, t.precision)), !this._shouldUseHighPrecisionShader) {
				let e = this._gl.getShaderPrecisionFormat(this._gl.VERTEX_SHADER, this._gl.MEDIUM_FLOAT), t = this._gl.getShaderPrecisionFormat(this._gl.FRAGMENT_SHADER, this._gl.MEDIUM_FLOAT);
				e && t && (this._caps.shaderFloatPrecision = Math.min(e.precision, t.precision));
			}
			this._caps.shaderFloatPrecision < 10 && (this._caps.shaderFloatPrecision = 10);
		}
		if (this._webGLVersion > 1) this._caps.blendMinMax = !0;
		else {
			let e = this._gl.getExtension("EXT_blend_minmax");
			e != null && (this._caps.blendMinMax = !0, this._gl.MAX = e.MAX_EXT, this._gl.MIN = e.MIN_EXT);
		}
		if (!this._caps.supportSRGBBuffers) {
			if (this._webGLVersion > 1) this._caps.supportSRGBBuffers = !0, this._glSRGBExtensionValues = {
				...
				let e = this._gl.getExtension("EXT_sRGB");
				e != null && (this._caps.supportSRGBBuffers = !0, this._glSRGBExtensionValues = {
					SRGB: e.SRGB_EXT,
			...
			if (this._creationOptions) {
				let e = this._creationOptions.forceSRGBBufferSupportState;
				e !== void 0 && (this._caps.supportSRGBBuffers = this._caps.supportSRGBBuffers && e);
			}
		}
	...
	_prepareWorkingCanvas() {
		...
		let e = this._workingCanvas.getContext("2d");
	...
	clear(t, n, r, i = !1, a = 0) {
		let o = this.stencilStateComposer.useStencilGlobalOnly;
		this.stencilStateComposer.useStencilGlobalOnly = !0, this.applyStates(), this.stencilStateComposer.useStencilGlobalOnly = o;
		let s = 0;
		if (n && t) {
			let n = !0;
			if (this._currentRenderTarget) {
				let r = this._currentRenderTarget.texture?.format;
				if (r === 8 || r === 9 || r === 10 || r === 11) {
					let r = this._currentRenderTarget.texture?.type;
					r === 7 || r === 5 ? (e._TempClearColorUint32[0] = t.r * 255, e._TempClearColorUint32[1] = t.g * 255, e._TempClearColorUint32[2] = t.b * 255, e._TempClearColorUint32[3] = t.a * 255, this._gl.clearBufferuiv(this._gl.COLOR, 0, e._TempClearColorUint32), n = !1) : (e._TempClearColorInt32[0] = t.r * 255, e._TempClearColorInt32[1] = t.g * 255, e._TempClearColorInt32[2] = t.b * 255, e._TempClearColorInt32[3] = t.a * 255, this._gl.clearBufferiv(this._gl.COLOR, 0, e._TempClearColorInt32), n = !1);
				}
			}
			n && (this._gl.clearColor(t.r, t.g, t.b, t.a === void 0 ? 1 : t.a), s |= this._gl.COLOR_BUFFER_BIT);
		}
		r && (this.useReverseDepthBuffer ? (this._depthCullingState.depthFunc = this._gl.GEQUAL, this._gl.clearDepth(0)) : this._gl.clearDepth(1), s |= this._gl.DEPTH_BUFFER_BIT), i && (this._gl.clearStencil(a), s |= this._gl.STENCIL_BUFFER_BIT), this._gl.clear(s);
	}
	_viewport(e, t, n, r) {
		(e !== this._viewportCached.x || t !== this._viewportCached.y || n !== this._viewportCached.z || r !== this._viewportCached.w) && (this._viewportCached.x = e, this._viewportCached.y = t, this._viewportCached.z = n, this._viewportCached.w = r, this._gl.viewport(e, t, n, r));
	}
	endFrame() {
	...
	bindFramebuffer(e, t = 0, n, r, a, o = 0, s = 0) {
		let c = e;
		this._currentRenderTarget && this._resolveAndGenerateMipMapsFramebuffer(this._currentRenderTarget), this._currentRenderTarget = e, this._bindUnboundFramebuffer(c._framebuffer);
		let l = this._gl;
		e.isMulti || (e.is2DArray || e.is3D ? (l.framebufferTextureLayer(l.FRAMEBUFFER, l.COLOR_ATTACHMENT0, e.texture._hardwareTexture?.underlyingResource, o, s), c._currentLOD = o) : e.isCube ? l.framebufferTexture2D(l.FRAMEBUFFER, l.COLOR_ATTACHMENT0, l.TEXTURE_CUBE_MAP_POSITIVE_X + t, e.texture._hardwareTexture?.underlyingResource, o) : c._currentLOD !== o && (l.framebufferTexture2D(l.FRAMEBUFFER, l.COLOR_ATTACHMENT0, l.TEXTURE_2D, e.texture._hardwareTexture?.underlyingResource, o), c._currentLOD = o));
		let u = e._depthStencilTexture;
		if (u) {
			...
			let n = e._depthStencilTextureWithStencil ? l.DEPTH_STENCIL_ATTACHMENT : l.DEPTH_ATTACHMENT;
			e.is2DArray || e.is3D ? l.framebufferTextureLayer(l.FRAMEBUFFER, n, u._hardwareTexture?.underlyingResource, o, s) : e.isCube ? l.framebufferTexture2D(l.FRAMEBUFFER, n, l.TEXTURE_CUBE_MAP_POSITIVE_X + t, u._hardwareTexture?.underlyingResource, o) : l.framebufferTexture2D(l.FRAMEBUFFER, n, l.TEXTURE_2D, u._hardwareTexture?.underlyingResource, o);
		}
		c._MSAAFramebuffer && this._bindUnboundFramebuffer(c._MSAAFramebuffer), this._cachedViewport && !a ? this.setViewport(this._cachedViewport, n, r) : (n || (n = e.width, o && (n /= 2 ** o)), r || (r = e.height, o && (r /= 2 ** o)), this._viewport(0, 0, n, r)), this.wipeCaches();
	}
	setStateCullFaceType(e, t) {
		let n = this.cullBackFaces ?? e ?? !0 ? this._gl.BACK : this._gl.FRONT;
		(this._depthCullingState.cullFace !== n || t) && (this._depthCullingState.cullFace = n);
	}
	setState(e, t = 0, n, r = !1, i, a, o = 0) {
		(this._depthCullingState.cull !== e || n) && (this._depthCullingState.cull = e), this.setStateCullFaceType(i, n), this.setZOffset(t), this.setZOffsetUnits(o);
		let s = r ? this._gl.CW : this._gl.CCW;
		(this._depthCullingState.frontFace !== s || n) && (this._depthCullingState.frontFace = s), this._stencilStateComposer.stencilMaterial = a;
	}
	...
	generateMipmaps(e) {
		let t = this._getTextureTarget(e);
		this._bindTextureDirectly(t, e, !0), this._gl.generateMipmap(t), this._bindTextureDirectly(t, null);
	}
	unBindFramebuffer(e, t, n) {
		let r = e;
		this._currentRenderTarget = null, this._resolveAndGenerateMipMapsFramebuffer(e, t), n && (r._MSAAFramebuffer && this._bindUnboundFramebuffer(r._framebuffer), n()), this._bindUnboundFramebuffer(null);
	}
	...
	resolveFramebuffer(e) {
		...
		r |= t._generateDepthBuffer && t.resolveMSAADepth ? n.DEPTH_BUFFER_BIT : 0, r |= t._generateStencilBuffer && t.resolveMSAAStencil ? n.STENCIL_BUFFER_BIT : 0, n.bindFramebuffer(n.READ_FRAMEBUFFER, t._MSAAFramebuffer), n.bindFramebuffer(n.DRAW_FRAMEBUFFER, t._framebuffer), n.blitFramebuffer(0, 0, e.width, e.height, 0, 0, e.width, e.height, r, n.NEAREST);
	}
	flushFramebuffer() {
		this._gl.flush();
	}
	...
	createIndexBuffer(e, t, n) {
		let r = this._gl.createBuffer(), i = new G(r);
		if (!r) throw Error("Unable to create index buffer");
		this.bindIndexBuffer(i);
		let a = this._normalizeIndexData(e);
	...
	_normalizeIndexData(e) {
		if (e.BYTES_PER_ELEMENT === 2) return e;
		if (this._caps.uintIndices) {
			if (e instanceof Uint32Array) return e;
			for (let t = 0; t < e.length; t++) if (e[t] >= 65535) return new Uint32Array(e);
	...
	bindUniformBlock(e, t, n) {
		let r = e.program, i = this._gl.getUniformBlockIndex(r, t);
		this._gl.uniformBlockBinding(r, i, n);
	}
	bindIndexBuffer(e) {
	...
	_vertexAttribPointer(e, t, n, r, i, a, o) {
		let s = this._currentBufferPointers[t];
		if (!s) return;
		let c = !1;
		s.active ? (s.buffer !== e && (s.buffer = e, c = !0), s.size !== n && (s.size = n, c = !0), s.type !== r && (s.type = r, c = !0), s.normalized !== i && (s.normalized = i, c = !0), s.stride !== a && (s.stride = a, c = !0), s.offset !== o && (s.offset = o, c = !0)) : (c = !0, s.active = !0, s.index = t, s.size = n, s.type = r, s.normalized = i, s.stride = a, s.offset = o, s.buffer = e), (c || this._vaoRecordInProgress) && (this.bindArrayBuffer(e), r === this._gl.UNSIGNED_INT || r === this._gl.INT ? this._gl.vertexAttribIPointer(t, n, r, a, o) : this._gl.vertexAttribPointer(t, n, r, i, a, o));
	}
	...
	_bindVertexBuffersAttributes(e, t, n) {
		let r = t.getAttributesNames();
		this._vaoRecordInProgress || this._unbindVertexArrayObject(), this.unbindAllAttributes();
		for (let i = 0; i < r.length; i++) {
			let a = t.getAttributeLocation(i);
			if (a >= 0) {
				let t = r[i], o = null;
				if (n && (o = n[t]), o ||= e[t], !o) continue;
				this._gl.enableVertexAttribArray(a), this._vaoRecordInProgress || (this._vertexAttribArraysEnabled[a] = !0);
				let s = o.getBuffer();
				s && (this._vertexAttribPointer(s, a, o.getSize(), o.type, o.normalized, o.byteStride, o.byteOffset), o.getIsInstanced() && (this._gl.vertexAttribDivisor(a, o.getInstanceDivisor()), this._vaoRecordInProgress || (this._currentInstanceLocations.push(a), this._currentInstanceBuffers.push(s))));
			}
		}
	}
	recordVertexArrayObject(e, t, n, r) {
		let i = this._gl.createVertexArray();
		if (!i) throw Error("Unable to create VAO");
		return this._vaoRecordInProgress = !0, this._gl.bindVertexArray(i), this._mustWipeVertexAttributes = !0, this._bindVertexBuffersAttributes(e, n, r), this.bindIndexBuffer(t), this._vaoRecordInProgress = !1, this._gl.bindVertexArray(null), i;
	}
	...
	bindBuffersDirectly(e, t, n, r, i) {
		if (this._cachedVertexBuffers !== e || this._cachedEffectForVertexBuffers !== i) {
			...
			let t = i.getAttributesCount();
			this._unbindVertexArrayObject(), this.unbindAllAttributes();
			let a = 0;
			for (let o = 0; o < t; o++) if (o < n.length) {
				let t = i.getAttributeLocation(o);
				t >= 0 && (this._gl.enableVertexAttribArray(t), this._vertexAttribArraysEnabled[t] = !0, this._vertexAttribPointer(e, t, n[o], this._gl.FLOAT, !1, r, a)), a += n[o] * 4;
			}
		}
	...
	bindBuffers(e, t, n, r) {
		(this._cachedVertexBuffers !== e || this._cachedEffectForVertexBuffers !== n) && (this._cachedVertexBuffers = e, this._cachedEffectForVertexBuffers = n, this._bindVertexBuffersAttributes(e, n, r)), this._bindIndexBufferWithCache(t);
	}
	unbindInstanceAttributes() {
		let e;
		for (let t = 0, n = this._currentInstanceLocations.length; t < n; t++) {
			let n = this._currentInstanceBuffers[t];
			e != n && n.references && (e = n, this.bindArrayBuffer(n));
			let r = this._currentInstanceLocations[t];
	...
	_releaseBuffer(e) {
		return e.references--, e.references === 0 && (this._deleteBuffer(e), !0);
	}
	_deleteBuffer(e) {
		this._gl.deleteBuffer(e.underlyingResource);
	}
	updateAndBindInstancesBuffer(e, t, n) {
		if (this.bindArrayBuffer(e), t && this._gl.bufferSubData(this._gl.ARRAY_BUFFER, 0, t), n[0].index !== void 0) this.bindInstancesBuffer(e, n, !0);
		else for (let t = 0; t < 4; t++) {
			let r = n[t];
			this._vertexAttribArraysEnabled[r] || (this._gl.enableVertexAttribArray(r), this._vertexAttribArraysEnabled[r] = !0), this._vertexAttribPointer(e, r, 4, this._gl.FLOAT, !1, 64, t * 16), this._gl.vertexAttribDivisor(r, 1), this._currentInstanceLocations.push(r), this._currentInstanceBuffers.push(e);
		}
	}
	bindInstancesBuffer(e, t, n = !0) {
		...
		for (let n = 0; n < t.length; n++) {
			let i = t[n];
			i.index === void 0 && (i.index = this._currentEffect.getAttributeLocationByName(i.attributeName)), !(i.index < 0) && (this._vertexAttribArraysEnabled[i.index] || (this._gl.enableVertexAttribArray(i.index), this._vertexAttribArraysEnabled[i.index] = !0), this._vertexAttribPointer(e, i.index, i.attributeSize, i.attributeType || this._gl.FLOAT, i.normalized || !1, r, i.offset), this._gl.vertexAttribDivisor(i.index, i.divisor === void 0 ? 1 : i.divisor), this._currentInstanceLocations.push(i.index), this._currentInstanceBuffers.push(e));
		}
	}
	disableInstanceAttributeByName(e) {
		if (!this._currentEffect) return;
		let t = this._currentEffect.getAttributeLocationByName(e);
		this.disableInstanceAttribute(t);
	}
	disableInstanceAttribute(e) {
		let t = !1, n;
		for (; (n = this._currentInstanceLocations.indexOf(e)) !== -1;) this._currentInstanceLocations.splice(n, 1), this._currentInstanceBuffers.splice(n, 1), t = !0;
	...
	draw(e, t, n, r) {
		this.drawElementsType(+!e, t, n, r);
	}
	drawPointClouds(e, t, n) {
		this.drawArraysType(2, e, t, n);
	}
	drawUnIndexed(e, t, n, r) {
		this.drawArraysType(+!e, t, n, r);
	}
	drawElementsType(e, t, n, r) {
		this.applyStates(), this._reportDrawCall();
		let i = this._drawMode(e), a = this._uintIndicesCurrentlySet ? this._gl.UNSIGNED_INT : this._gl.UNSIGNED_SHORT, o = this._uintIndicesCurrentlySet ? 4 : 2;
		r ? this._gl.drawElementsInstanced(i, n, a, t * o, r) : this._gl.drawElements(i, n, a, t * o);
	}
	drawArraysType(e, t, n, r) {
		this.applyStates(), this._reportDrawCall();
		let i = this._drawMode(e);
		r ? this._gl.drawArraysInstanced(i, t, n, r) : this._gl.drawArrays(i, t, n);
	}
	_drawMode(e) {
		switch (e) {
	...
	_releaseEffect(e) {
		...
		let t = e.getPipelineContext();
		t && this._deletePipelineContext(t);
	}
	_deletePipelineContext(e) {
		let t = e;
		t && t.program && (t.program.__SPECTOR_rebuildProgram = null, P(t), this._gl && (this._currentProgram === t.program && this._setProgram(null), this._gl.deleteProgram(t.program)));
	}
	_getGlobalDefines(e) {
		return l(e, this.isNDCHalfZRange, this.useReverseDepthBuffer, this.useExactSrgbConversions);
	}
	createEffect(e, t, n, r, i, a, o, s, c, l = 0, u) {
		let d = typeof e == "string" ? e : e.vertexToken || e.vertexSource || e.vertexElement || e.vertex, f = typeof e == "string" ? e : e.fragmentToken || e.fragmentSource || e.fragmentElement || e.fragment, p = this._getGlobalDefines(), m = t.attributes !== void 0, h = i ?? t.defines ?? "";
		p && (h += p);
		let g = d + "+" + f + "@" + h;
		if (this._compiledEffects[g]) {
			let e = this._compiledEffects[g];
			return o && e.isReady() && o(e), e._refCount++, e;
		}
		this._gl && w(this._gl);
		let _ = new L(e, t, m ? this : n, r, this, i, a, o, s, c, g, t.shaderLanguage ?? l, t.extraInitializationsAsync ?? u);
		return this._compiledEffects[g] = _, _;
	}
	_getShaderSource(e) {
		return this._gl.getShaderSource(e);
	}
	createRawShaderProgram(e, t, n, r, i = null) {
		let a = w(this._gl);
		return a._contextWasLost = this._contextWasLost, a.validateShaderPrograms = this.validateShaderPrograms, E(e, t, n, r || this._gl, i);
	}
	createShaderProgram(e, t, n, r, i, a = null) {
		let o = w(this._gl);
		return o._contextWasLost = this._contextWasLost, o.validateShaderPrograms = this.validateShaderPrograms, D(e, t, n, r, i || this._gl, a);
	}
	inlineShaderCode(e) {
		return e;
	}
	...
	_finalizePipelineContext(e) {
		return A(e, this._gl, this.validateShaderPrograms);
	}
	_preparePipelineContextAsync(e, t, n, r, i, a, o, s, c, l, u) {
		let d = w(this._gl);
		return d._contextWasLost = this._contextWasLost, d.validateShaderPrograms = this.validateShaderPrograms, d._createShaderProgramInjection = this._createShaderProgram.bind(this), d.createRawShaderProgramInjection = this.createRawShaderProgram.bind(this), d.createShaderProgramInjection = this.createShaderProgram.bind(this), d.loadFileInjection = this._loadFile.bind(this), j(e, t, n, r, i, a, o, s, c, l, u);
	}
	_createShaderProgram(e, t, n, r, i = null) {
		return k(e, t, n, r, i);
	}
	_isRenderingStateCompiled(e) {
		return !this._isDisposed && ee(e, this._gl, this.validateShaderPrograms);
	}
	...
	getUniforms(e, t) {
		let n = [], r = e;
		for (let e = 0; e < t.length; e++) n.push(this._gl.getUniformLocation(r.program, t[e]));
		return n;
	}
	getAttributes(e, t) {
		let n = [], r = e;
		for (let e = 0; e < t.length; e++) try {
			n.push(this._gl.getAttribLocation(r.program, t[e]));
		} catch {
			n.push(-1);
		}
		return n;
	...
	enableEffect(e) {
		e = e !== null && U(e) ? e.effect : e, !(!e || e === this._currentEffect) && (this._stencilStateComposer.stencilMaterial = void 0, this.bindSamplers(e), this._currentEffect = e, e.onBind && e.onBind(e), e._onBindObservable && e._onBindObservable.notifyObservers(e));
	}
	setInt(e, t) {
		return e ? (this._gl.uniform1i(e, t), !0) : !1;
	}
	setInt2(e, t, n) {
		return e ? (this._gl.uniform2i(e, t, n), !0) : !1;
	}
	setInt3(e, t, n, r) {
		return e ? (this._gl.uniform3i(e, t, n, r), !0) : !1;
	}
	setInt4(e, t, n, r, i) {
		return e ? (this._gl.uniform4i(e, t, n, r, i), !0) : !1;
	}
	setIntArray(e, t) {
	...
	setUInt2(e, t, n) {
		return e ? (this._gl.uniform2ui(e, t, n), !0) : !1;
	}
	setUInt3(e, t, n, r) {
		return e ? (this._gl.uniform3ui(e, t, n, r), !0) : !1;
	}
	setUInt4(e, t, n, r, i) {
		return e ? (this._gl.uniform4ui(e, t, n, r, i), !0) : !1;
	}
	setUIntArray(e, t) {
	...
	setFloat2(e, t, n) {
		return e ? (this._gl.uniform2f(e, t, n), !0) : !1;
	}
	setFloat3(e, t, n, r) {
		return e ? (this._gl.uniform3f(e, t, n, r), !0) : !1;
	}
	setFloat4(e, t, n, r, i) {
		return e ? (this._gl.uniform4f(e, t, n, r, i), !0) : !1;
	}
	applyStates() {
	...
	_getSamplingParameters(e, t) {
		let n = this._gl, r = n.NEAREST, i = n.NEAREST, a = !1;
		switch (e) {
			case 11:
				r = n.LINEAR, i = t ? n.LINEAR_MIPMAP_NEAREST : n.LINEAR;
				break;
			case 3:
				r = n.LINEAR, a = !0, i = t ? n.LINEAR_MIPMAP_LINEAR : n.LINEAR;
				break;
			case 8:
				a = !0, r = n.NEAREST, i = t ? n.NEAREST_MIPMAP_LINEAR : n.NEAREST;
				break;
			case 4:
				r = n.NEAREST, i = t ? n.NEAREST_MIPMAP_NEAREST : n.NEAREST;
				break;
			case 5:
				r = n.NEAREST, i = t ? n.LINEAR_MIPMAP_NEAREST : n.LINEAR;
				break;
			case 6:
				a = !0, r = n.NEAREST, i = t ? n.LINEAR_MIPMAP_LINEAR : n.LINEAR;
				break;
			case 7:
				r = n.NEAREST, i = n.LINEAR;
				break;
			case 1:
				r = n.NEAREST, i = n.NEAREST;
				break;
			case 9:
				r = n.LINEAR, i = t ? n.NEAREST_MIPMAP_NEAREST : n.NEAREST;
				break;
			case 10:
				a = !0, r = n.LINEAR, i = t ? n.NEAREST_MIPMAP_LINEAR : n.NEAREST;
				break;
			case 2:
				r = n.LINEAR, i = n.LINEAR;
				break;
			case 12: r = n.LINEAR, i = n.NEAREST;
		}
		return {
			min: i,
			mag: r,
	...
	_createTexture() {
		let e = this._gl.createTexture();
		if (!e) throw Error("Unable to create texture");
		return e;
	}
	_createHardwareTexture() {
		return new X(this._createTexture(), this._gl);
	}
	_createInternalTexture(e, t, n = !0, a = 0) {
		let o, s = !1, c = 0, l = 3, u = 5, d = !1, f = 1, p, m = !1, h = 0, g = !1;
		t !== void 0 && typeof t == "object" ? (o = !!t.generateMipMaps, s = !!t.createMipMaps, c = t.type === void 0 ? 0 : t.type, l = t.samplingMode === void 0 ? 3 : t.samplingMode, u = t.format === void 0 ? 5 : t.format, d = t.useSRGBBuffer !== void 0 && t.useSRGBBuffer, f = t.samples ?? 1, p = t.label, m = !!t.createMSAATexture, h = t.comparisonFunction || 0, g = !!t.isCube) : o = !!t, d &&= this._caps.supportSRGBBuffers && (this.webGLVersion > 1 || this.isWebGPU), (c === 1 && !this._caps.textureFloatLinearFiltering || c === 2 && !this._caps.textureHalfFloatLinearFiltering) && (l = 1), c === 1 && !this._caps.textureFloat && (c = 0, i.Warn("Float textures are not supported. Type forced to TEXTURETYPE_UNSIGNED_BYTE"));
		let _ = Z(u), v = Q(u), y = this._gl, b = new r(this, a), x = e.width || e, S = e.height || e, C = e.depth || 0, w = e.layers || 0, T = this._getSamplingParameters(l, (o || s) && !_), E = w === 0 ? C === 0 ? g ? y.TEXTURE_CUBE_MAP : y.TEXTURE_2D : y.TEXTURE_3D : y.TEXTURE_2D_ARRAY, D = _ ? this._getInternalFormatFromDepthTextureFormat(u, !0, v) : this._getRGBABufferInternalSizedFormat(c, u, d), O = _ ? v ? y.DEPTH_STENCIL : y.DEPTH_COMPONENT : this._getInternalFormat(u), k = _ ? this._getWebGLTextureTypeFromDepthTextureFormat(u) : this._getWebGLTextureType(c);
		if (this._bindTextureDirectly(E, b), w !== 0) b.is2DArray = !0, y.texImage3D(E, 0, D, x, S, w, 0, O, k, null);
		else if (C !== 0) b.is3D = !0, y.texImage3D(E, 0, D, x, S, C, 0, O, k, null);
		else if (g) {
			b.isCube = !0;
			for (let e = 0; e < 6; e++) y.texImage2D(y.TEXTURE_CUBE_MAP_POSITIVE_X + e, 0, D, x, S, 0, O, k, null);
		} else y.texImage2D(E, 0, D, x, S, 0, O, k, null);
		if (y.texParameteri(E, y.TEXTURE_MAG_FILTER, T.mag), y.texParameteri(E, y.TEXTURE_MIN_FILTER, T.min), y.texParameteri(E, y.TEXTURE_WRAP_S, y.CLAMP_TO_EDGE), y.texParameteri(E, y.TEXTURE_WRAP_T, y.CLAMP_TO_EDGE), _ && this.webGLVersion > 1 && (h === 0 ? (y.texParameteri(E, y.TEXTURE_COMPARE_FUNC, 515), y.texParameteri(E, y.TEXTURE_COMPARE_MODE, y.NONE)) : (y.texParameteri(E, y.TEXTURE_COMPARE_FUNC, h), y.texParameteri(E, y.TEXTURE_COMPARE_MODE, y.COMPARE_REF_TO_TEXTURE))), (o || s) && this._gl.generateMipmap(E), this._bindTextureDirectly(E, null), b._useSRGBBuffer = d, b.baseWidth = x, b.baseHeight = S, b.width = x, b.height = S, b.depth = w || C, b.isReady = !0, b.samples = f, b.generateMipMaps = o, b.samplingMode = l, b.type = c, b.format = u, b.label = p, b.comparisonFunction = h, this._internalTexturesCache.push(b), m) {
			let e;
			if (e = Z(b.format) ? this._setupFramebufferDepthAttachments(Q(b.format), b.format !== 19, b.width, b.height, f, b.format, !0) : this._createRenderBuffer(b.width, b.height, f, -1, this._getRGBABufferInternalSizedFormat(b.type, b.format, b._useSRGBBuffer), -1), !e) throw Error("Unable to create render buffer");
			b._autoMSAAManagement = !0;
			let t = b._hardwareTexture;
			t ||= b._hardwareTexture = this._createHardwareTexture(), t.addMSAARenderBuffer(e);
		}
		return b;
	}
	...
	createTexture(e, t, n, i, a = 3, o = null, s = null, c = null, l = null, u = null, d = null, f, p, m, h) {
		return this._createTextureBase(e, t, n, i, a, o, s, (...e) => this._prepareWebGLTexture(...e, u), (e, t, n, a, o, s) => {
			let c = this._gl, l = n.width === e && n.height === t;
			o._creationFlags = m ?? 0;
			let u = this._getTexImageParametersForCreateTexture(o.format, o._useSRGBBuffer);
			if (l) return c.texImage2D(c.TEXTURE_2D, 0, u.internalFormat, u.format, u.type, n), !1;
			let d = this._caps.maxTextureSize;
			if (n.width > d || n.height > d || !this._supportsHardwareTextureRescaling) return this._prepareWorkingCanvas(), !this._workingCanvas || !this._workingContext ? !1 : (this._workingCanvas.width = e, this._workingCanvas.height = t, this._workingContext.drawImage(n, 0, 0, n.width, n.height, 0, 0, e, t), c.texImage2D(c.TEXTURE_2D, 0, u.internalFormat, u.format, u.type, this._workingCanvas), o.width = e, o.height = t, !1);
			{
				let e = new r(this, 2);
				this._bindTextureDirectly(c.TEXTURE_2D, e, !0), c.texImage2D(c.TEXTURE_2D, 0, u.internalFormat, u.format, u.type, n), this._rescaleTexture(e, o, i, u.format, () => {
					this._releaseTexture(e), this._bindTextureDirectly(c.TEXTURE_2D, o, !0), s();
				});
			}
			return !0;
		}, c, l, u, d, f, p, h);
	...
	_getTexImageParametersForCreateTexture(e, t) {
		let n, r;
		return this.webGLVersion === 1 ? (n = this._getInternalFormat(e, t), r = n) : (n = this._getInternalFormat(e, !1), r = this._getRGBABufferInternalSizedFormat(0, e, t)), {
			internalFormat: r,
			format: n,
			type: this._gl.UNSIGNED_BYTE
		};
	}
	_rescaleTexture(e, t, n, r, i) {}
	_unpackFlipY(e) {
		this._unpackFlipYCached !== e && (this._gl.pixelStorei(this._gl.UNPACK_FLIP_Y_WEBGL, +!!e), this.enableUnpackFlipYCached && (this._unpackFlipYCached = e));
	}
	...
	updateTextureSamplingMode(e, t, n = !1) {
		let r = this._getTextureTarget(t), i = this._getSamplingParameters(e, t.useMipMaps || n);
		this._setTextureParameterInteger(r, this._gl.TEXTURE_MAG_FILTER, i.mag, t), this._setTextureParameterInteger(r, this._gl.TEXTURE_MIN_FILTER, i.min), n && i.hasMipMaps && (t.generateMipMaps = !0, this._gl.generateMipmap(r)), this._bindTextureDirectly(r, null), t.samplingMode = e;
	}
	updateTextureDimensions(e, t, n, r = 1) {}
	updateTextureWrappingMode(e, t, n = null, r = null) {
		let i = this._getTextureTarget(e);
		t !== null && (this._setTextureParameterInteger(i, this._gl.TEXTURE_WRAP_S, this._getTextureWrapMode(t), e), e._cachedWrapU = t), n !== null && (this._setTextureParameterInteger(i, this._gl.TEXTURE_WRAP_T, this._getTextureWrapMode(n), e), e._cachedWrapV = n), (e.is2DArray || e.is3D) && r !== null && (this._setTextureParameterInteger(i, this._gl.TEXTURE_WRAP_R, this._getTextureWrapMode(r), e), e._cachedWrapR = r), this._bindTextureDirectly(i, null);
	}
	_uploadCompressedDataToTextureDirectly(e, t, n, r, i, a = 0, o = 0) {
		let s = this._gl, c = s.TEXTURE_2D;
		if (e.isCube && (c = s.TEXTURE_CUBE_MAP_POSITIVE_X + a), e._useSRGBBuffer) switch (t) {
			case 37492:
			case 36196:
				this._caps.etc2 ? t = s.COMPRESSED_SRGB8_ETC2 : e._useSRGBBuffer = !1;
				break;
			case 37496:
				this._caps.etc2 ? t = s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : e._useSRGBBuffer = !1;
				break;
			case 36492:
				t = s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT;
				break;
			case 37808:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR;
				break;
			case 37809:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR;
				break;
			case 37810:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR;
				break;
			case 37811:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR;
				break;
			case 37812:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR;
				break;
			case 37813:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR;
				break;
			case 37814:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR;
				break;
			case 37815:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR;
				break;
			case 37816:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR;
				break;
			case 37817:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR;
				break;
			case 37818:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR;
				break;
			case 37819:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR;
				break;
			case 37820:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR;
				break;
			case 37821:
				t = s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR;
				break;
			case 33776:
				this._caps.s3tc_srgb ? t = s.COMPRESSED_SRGB_S3TC_DXT1_EXT : e._useSRGBBuffer = !1;
				break;
			case 33777:
				this._caps.s3tc_srgb ? t = s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT : e._useSRGBBuffer = !1;
				break;
			case 33779:
				this._caps.s3tc_srgb ? t = s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT : e._useSRGBBuffer = !1;
				break;
			default: e._useSRGBBuffer = !1;
		}
		if (e.generateMipMaps) {
			let a = e._hardwareTexture;
			a.memoryAllocated ||= (s.texStorage2D(e.isCube ? s.TEXTURE_CUBE_MAP : s.TEXTURE_2D, Math.floor(Math.log2(Math.max(n, r))) + 1, t, e.width, e.height), !0), this._gl.compressedTexSubImage2D(c, o, 0, 0, n, r, t, i);
		} else this._gl.compressedTexImage2D(c, o, t, n, r, 0, i);
	}
	_uploadDataToTextureDirectly(e, t, n = 0, r = 0, i, a = !1) {
		let o = this._gl, s = this._getWebGLTextureType(e.type), c = this._getInternalFormat(e.format), l = i === void 0 ? this._getRGBABufferInternalSizedFormat(e.type, e.format, e._useSRGBBuffer) : this._getInternalFormat(i, e._useSRGBBuffer);
		this._unpackFlipY(e.invertY);
		let u = o.TEXTURE_2D;
		e.isCube && (u = o.TEXTURE_CUBE_MAP_POSITIVE_X + n);
		let d = Math.round(Math.log(e.width) * Math.LOG2E), f = Math.round(Math.log(e.height) * Math.LOG2E), p = a ? e.width : 2 ** Math.max(d - r, 0), m = a ? e.height : 2 ** Math.max(f - r, 0);
		o.texImage2D(u, r, l, p, m, 0, c, s, t);
	}
	updateTextureData(e, t, n, r, i, a, o = 0, s = 0, c = !1) {
		let l = this._gl, u = this._getWebGLTextureType(e.type), d = this._getInternalFormat(e.format);
		this._unpackFlipY(e.invertY);
		let f = l.TEXTURE_2D, p = l.TEXTURE_2D;
		e.isCube && (p = l.TEXTURE_CUBE_MAP_POSITIVE_X + o, f = l.TEXTURE_CUBE_MAP), this._bindTextureDirectly(f, e, !0), l.texSubImage2D(p, s, n, r, i, a, d, u, t), c && this._gl.generateMipmap(p), this._bindTextureDirectly(f, null);
	}
	_uploadArrayBufferViewToTexture(e, t, n = 0, r = 0) {
		let i = this._gl, a = e.isCube ? i.TEXTURE_CUBE_MAP : i.TEXTURE_2D;
		this._bindTextureDirectly(a, e, !0), this._uploadDataToTextureDirectly(e, t, n, r), this._bindTextureDirectly(a, null, !0);
	}
	_prepareWebGLTextureContinuation(e, t, n, r, i) {
		let a = this._gl;
		if (!a) return;
		let o = this._getSamplingParameters(i, !n);
		a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, o.mag), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, o.min), !n && !r && a.generateMipmap(a.TEXTURE_2D), this._bindTextureDirectly(a.TEXTURE_2D, null), t && t.removePendingData(e), e.onLoadedObservable.notifyObservers(e), e.onLoadedObservable.clear();
	}
	_prepareWebGLTexture(e, t, n, r, i, a, o, s, c, l) {
		let u = this.getCaps().maxTextureSize, d = Math.min(u, this.needPOTTextures ? Y(r.width, u) : r.width), f = Math.min(u, this.needPOTTextures ? Y(r.height, u) : r.height), p = this._gl;
		if (p) {
			if (!e._hardwareTexture) {
				n && n.removePendingData(e);
				return;
			}
			this._bindTextureDirectly(p.TEXTURE_2D, e, !0), this._unpackFlipY(i === void 0 || !!i), e.baseWidth = r.width, e.baseHeight = r.height, e.width = d, e.height = f, e.isReady = !0, e.type = e.type === -1 ? 0 : e.type, e.format = e.format === -1 ? l ?? (t === ".jpg" && !e._useSRGBBuffer ? 4 : 5) : e.format, !s(d, f, r, t, e, () => {
				this._prepareWebGLTextureContinuation(e, n, a, o, c);
			}) && this._prepareWebGLTextureContinuation(e, n, a, o, c);
		}
	}
	_getInternalFormatFromDepthTextureFormat(e, t, n) {
		let r = this._gl;
		if (!t) return r.STENCIL_INDEX8;
		let i = n ? r.DEPTH_STENCIL : r.DEPTH_COMPONENT;
		return this.webGLVersion > 1 ? e === 15 ? i = r.DEPTH_COMPONENT16 : e === 16 ? i = r.DEPTH_COMPONENT24 : e === 17 || e === 13 ? i = n ? r.DEPTH24_STENCIL8 : r.DEPTH_COMPONENT24 : e === 14 ? i = r.DEPTH_COMPONENT32F : e === 18 && (i = n ? r.DEPTH32F_STENCIL8 : r.DEPTH_COMPONENT32F) : i = r.DEPTH_COMPONENT16, i;
	}
	_getWebGLTextureTypeFromDepthTextureFormat(e) {
		let t = this._gl, n = t.UNSIGNED_INT;
		return e === 15 ? n = t.UNSIGNED_SHORT : e === 17 || e === 13 ? n = t.UNSIGNED_INT_24_8 : e === 14 ? n = t.FLOAT : e === 18 ? n = t.FLOAT_32_UNSIGNED_INT_24_8_REV : e === 19 && (n = t.UNSIGNED_BYTE), n;
	}
	_setupFramebufferDepthAttachments(e, t, n, r, i = 1, a, o = !1) {
		let s = this._gl;
		a ??= e ? 13 : 14;
		let c = this._getInternalFormatFromDepthTextureFormat(a, t, e);
		return e && t ? this._createRenderBuffer(n, r, i, s.DEPTH_STENCIL, c, o ? -1 : s.DEPTH_STENCIL_ATTACHMENT) : t ? this._createRenderBuffer(n, r, i, c, c, o ? -1 : s.DEPTH_ATTACHMENT) : e ? this._createRenderBuffer(n, r, i, c, c, o ? -1 : s.STENCIL_ATTACHMENT) : null;
	}
	_createRenderBuffer(e, t, n, r, i, a, o = !0) {
		let s = this._gl.createRenderbuffer();
		return this._updateRenderBuffer(s, e, t, n, r, i, a, o);
	}
	_updateRenderBuffer(e, t, n, r, i, a, o, s = !0) {
		let c = this._gl;
		return c.bindRenderbuffer(c.RENDERBUFFER, e), r > 1 && c.renderbufferStorageMultisample ? c.renderbufferStorageMultisample(c.RENDERBUFFER, r, a, t, n) : c.renderbufferStorage(c.RENDERBUFFER, i, t, n), o !== -1 && c.framebufferRenderbuffer(c.FRAMEBUFFER, o, c.RENDERBUFFER, e), s && c.bindRenderbuffer(c.RENDERBUFFER, null), e;
	}
	_releaseTexture(e) {
		this._deleteTexture(e._hardwareTexture), this.unbindAllTextures();
		let t = this._internalTexturesCache.indexOf(e);
	...
	bindSamplers(e) {
		...
		for (let t = 0; t < n.length; t++) {
			let r = e.getUniform(n[t]);
			r && (this._boundUniforms[t] = r);
		}
	...
	_bindTextureDirectly(e, t, n = !1, r = !1) {
		let a = !1, o = t && t._associatedChannel > -1;
		if (n && o && (this._activeChannel = t._associatedChannel), this._boundTexturesCache[this._activeChannel] !== t || r) {
			if (this._activateCurrentTexture(), t && t.isMultiview) throw i.Error([
		...
		} else n && (a = !0, this._activateCurrentTexture());
		return o && !n && this._bindSamplerUniformToChannel(t._associatedChannel, this._activeChannel), a;
	}
	_bindTexture(e, t, n) {
		if (e === void 0) return;
		t && (t._associatedChannel = e), this._activeChannel = e;
		let r = t ? this._getTextureTarget(t) : this._gl.TEXTURE_2D;
	...
	setTexture(e, t, n, r) {
		e !== void 0 && (t && (this._boundUniforms[e] = t), this._setTexture(e, n));
	}
	_bindSamplerUniformToChannel(e, t) {
		let n = this._boundUniforms[e];
	...
	_setTexture(e, t, n = !1, r = !1, i = "") {
		if (!t) return this._boundTexturesCache[e] != null && (this._activeChannel = e, this._bindTextureDirectly(this._gl.TEXTURE_2D, null), this._bindTextureDirectly(this._gl.TEXTURE_CUBE_MAP, null), this.webGLVersion > 1 && (this._bindTextureDirectly(this._gl.TEXTURE_3D, null), this._bindTextureDirectly(this._gl.TEXTURE_2D_ARRAY, null))), !1;
		if (t.video) {
			this._activeChannel = e;
			let n = t.getInternalTexture();
			n && (n._associatedChannel = e), t.update();
		} else if (t.delayLoadState === 4) return t.delayLoad(), !1;
		let a;
		a = r ? t.depthStencilTexture : t.isReady() ? t.getInternalTexture() : t.isCube ? this.emptyCubeTexture : t.is3D ? this.emptyTexture3D : t.is2DArray ? this.emptyTexture2DArray : this.emptyTexture, !n && a && (a._associatedChannel = e);
		let o = !0;
		this._boundTexturesCache[e] === a && (n || this._bindSamplerUniformToChannel(a._associatedChannel, e), o = !1), this._activeChannel = e;
		let s = this._getTextureTarget(a);
		if (o && this._bindTextureDirectly(s, a, n), a && !a.isMultiview) {
			if (a.isCube && a._cachedCoordinatesMode !== t.coordinatesMode) {
				a._cachedCoordinatesMode = t.coordinatesMode;
				let e = +(t.coordinatesMode !== 3 && t.coordinatesMode !== 5);
				t.wrapU = e, t.wrapV = e;
			}
			a._cachedWrapU !== t.wrapU && (a._cachedWrapU = t.wrapU, this._setTextureParameterInteger(s, this._gl.TEXTURE_WRAP_S, this._getTextureWrapMode(t.wrapU), a)), a._cachedWrapV !== t.wrapV && (a._cachedWrapV = t.wrapV, this._setTextureParameterInteger(s, this._gl.TEXTURE_WRAP_T, this._getTextureWrapMode(t.wrapV), a)), a.is3D && a._cachedWrapR !== t.wrapR && (a._cachedWrapR = t.wrapR, this._setTextureParameterInteger(s, this._gl.TEXTURE_WRAP_R, this._getTextureWrapMode(t.wrapR), a)), this._setAnisotropicLevel(s, a, t.anisotropicFilteringLevel);
		}
		return !0;
	}
	setTextureArray(e, t, n, r) {
		if (!(e === void 0 || !t)) {
			(!this._textureUnits || this._textureUnits.length !== n.length) && (this._textureUnits = new Int32Array(n.length));
			for (let t = 0; t < n.length; t++) {
				let r = n[t].getInternalTexture();
				r ? (this._textureUnits[t] = e + t, r._associatedChannel = e + t) : this._textureUnits[t] = -1;
			}
			this._gl.uniform1iv(t, this._textureUnits);
			for (let e = 0; e < n.length; e++) this._setTexture(this._textureUnits[e], n[e], !0);
		}
	}
	_setAnisotropicLevel(e, t, n) {
		let r = this._caps.textureAnisotropicFilterExtension;
		t.samplingMode !== 11 && t.samplingMode !== 3 && t.samplingMode !== 2 && (n = 1), r && t._cachedAnisotropicFilteringLevel !== n && (this._setTextureParameterFloat(e, r.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(n, this._caps.maxAnisotropy), t), t._cachedAnisotropicFilteringLevel = n);
	}
	_setTextureParameterFloat(e, t, n, r) {
		this._bindTextureDirectly(e, r, !0, !0), this._gl.texParameterf(e, t, n);
	}
	_setTextureParameterInteger(e, t, n, r) {
		r && this._bindTextureDirectly(e, r, !0, !0), this._gl.texParameteri(e, t, n);
	}
	unbindAllAttributes() {
	...
	_canRenderToFramebuffer(e) {
		...
		let a = t.checkFramebufferStatus(t.FRAMEBUFFER);
		if (n &&= a === t.FRAMEBUFFER_COMPLETE, n &&= t.getError() === t.NO_ERROR, n && (t.clear(t.COLOR_BUFFER_BIT), n &&= t.getError() === t.NO_ERROR), n) {
			t.bindFramebuffer(t.FRAMEBUFFER, null);
			let e = t.RGBA, r = t.UNSIGNED_BYTE, i = /* @__PURE__ */ new Uint8Array(4);
			t.readPixels(0, 0, 1, 1, e, r, i), n &&= t.getError() === t.NO_ERROR;
		}
		for (t.deleteTexture(r), t.deleteFramebuffer(i), t.bindFramebuffer(t.FRAMEBUFFER, null); !n && t.getError() !== t.NO_ERROR;);
		return n;
	}
	...
	_getInternalFormat(e, t = !1) {
		let n = t ? this._glSRGBExtensionValues.SRGB8_ALPHA8 : this._gl.RGBA;
		switch (e) {
			case 0:
				n = this._gl.ALPHA;
				break;
			case 1:
				n = this._gl.LUMINANCE;
				break;
			case 2:
				n = this._gl.LUMINANCE_ALPHA;
				break;
			case 6:
			case 33322:
			case 36760:
			...
			case 32852:
			case 36762:
				n = t ? this._glSRGBExtensionValues.SRGB : this._gl.RGB;
				break;
			case 5:
			case 32859:
			case 36763: n = t ? this._glSRGBExtensionValues.SRGB8_ALPHA8 : this._gl.RGBA;
		}
		if (this._webGLVersion > 1) switch (e) {
			case 8:
				n = this._gl.RED_INTEGER;
				break;
			case 9:
				n = this._gl.RG_INTEGER;
				break;
			case 10:
				n = this._gl.RGB_INTEGER;
				break;
			case 11: n = this._gl.RGBA_INTEGER;
		}
		return n;
	}
	_getRGBABufferInternalSizedFormat(e, t, n = !1) {
		if (this._webGLVersion === 1) {
			if (t !== void 0) switch (t) {
				case 0: return this._gl.ALPHA;
				case 1: return this._gl.LUMINANCE;
				case 2: return this._gl.LUMINANCE_ALPHA;
				case 4: return n ? this._glSRGBExtensionValues.SRGB : this._gl.RGB;
			}
		...
		switch (e) {
			...
			case 0: switch (t) {
				...
				case 4: return n ? this._glSRGBExtensionValues.SRGB8 : this._gl.RGB8;
				case 5: return n ? this._glSRGBExtensionValues.SRGB8_ALPHA8 : this._gl.RGBA8;
		...
		return n ? this._glSRGBExtensionValues.SRGB8_ALPHA8 : this._gl.RGBA8;
	}
	readPixels(e, t, n, r, a = !0, o = !0, s = null) {
		let c = a ? 4 : 3, l = a ? this._gl.RGBA : this._gl.RGB, u = n * r * c;
		if (!s) s = new Uint8Array(u);
		else if (s.length < u) return i.Error(`Data buffer is too small to store the read pixels (${s.length} should be more than ${u})`), Promise.resolve(s);
		return o && this.flushFramebuffer(), this._gl.readPixels(e, t, n, r, l, this._gl.UNSIGNED_BYTE, s), Promise.resolve(s);
	}
	...
	static isSupported() {
		...
		if (this._IsSupported === null) try {
			let e = H._CreateCanvas(1, 1), t = e.getContext("webgl") || e.getContext("experimental-webgl");
	...
	static get HasMajorPerformanceCaveat() {
		if (this._HasMajorPerformanceCaveat === null) try {
			let e = H._CreateCanvas(1, 1), t = e.getContext("webgl", { failIfMajorPerformanceCaveat: !0 }) || e.getContext("experimental-webgl", { failIfMajorPerformanceCaveat: !0 });
...
$._TempClearColorUint32 = /*#__PURE__*/ new Uint32Array(4), $._TempClearColorInt32 = /*#__PURE__*/ new Int32Array(4), $.ExceptionList = [
	{
		key: "Chrome/63.0",
		capture: "63\\.0\\.3239\\.(\\d+)",
...
], $._ConcatenateShader = g, $._IsSupported = null, $._HasMajorPerformanceCaveat = null;
//#endregion
export { J as a, de as c, W as d, U as f, X as i, K as l, L as m, fe as n, Y as o, H as p, Q as r, ue as s, $ as t, G as u };

//# sourceMappingURL=thinEngine.pure-jQAqL4kV.js.map