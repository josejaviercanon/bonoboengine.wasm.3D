import { n as e, r as t, t as n } from "./performanceConfigurator-DKR9RfNv.js";
...
var s = class e extends a {
	...
	_swapAndDie(e, t = !0) {
		...
		let n = this._engine.getLoadedTexturesCache(), r = n.indexOf(this);
		r !== -1 && n.splice(r, 1), r = n.indexOf(e), r === -1 && n.push(e);
	}
	dispose() {
...
function u(e, t = !1) {
	if (!(t && l[e])) return l[e] = !0, `${e} needs to be imported before as it contains a side-effect required by your code.`;
}
//#endregion
...
function C(e, t, n, r, i, a) {
	let o = x(r);
	a ||= o._createShaderProgramInjection ?? E;
	let s = k(t, "vertex", r, o._contextWasLost), c = k(n, "fragment", r, o._contextWasLost);
	return a(e, s, c, r, i, o.validateShaderPrograms);
}
function w(e, t, n, r, i, a = null, o) {
	let s = x(i);
	o ||= s._createShaderProgramInjection ?? E;
	let c = s._webGLVersion > 1 ? "#version 300 es\n#define WEBGL2 \n" : "", l = ne(t, "vertex", r, c, i, s._contextWasLost), u = ne(n, "fragment", r, c, i, s._contextWasLost);
...
function E(e, t, n, r, i = null, a) {
	let o = r.createProgram();
	if (e.program = o, !o) throw Error("Unable to create program");
	return r.attachShader(o, t), r.attachShader(o, n), r.linkProgram(o), e.context = r, e.vertexShader = t, e.fragmentShader = n, e.isParallelCompiled || O(e, r, a), o;
}
function D(e, t, n) {
	let r = e;
	if (r._isDisposed) return !1;
	let i = x(t);
	return i && i.parallelShaderCompile && i.parallelShaderCompile.COMPLETION_STATUS_KHR && r.program && t.getProgramParameter(r.program, i.parallelShaderCompile.COMPLETION_STATUS_KHR) ? (O(r, t, n), !0) : !1;
}
function O(e, t, n) {
...
var ce = "attribute", le = "varying", N = class {
	constructor() {
		this.children = [];
	}
	isValid(e) {
	...
	process(e, t, n) {
		...
		if (this.line) {
			...
			if (i) {
				...
				let r = t.processor?.attributeKeywordName ?? ce, a = t.isFragment && t.processor?.varyingFragmentKeywordName ? t.processor?.varyingFragmentKeywordName : !t.isFragment && t.processor?.varyingVertexKeywordName ? t.processor?.varyingVertexKeywordName : le;
...
F.InfixToPostfixCacheLimitSize = 5e4, F.InfixToPostfixCacheCleanupSize = 25e3, F._InfixToPostfixCache = /* @__PURE__ */ new Map(), F._OperatorPriority = {
	")": 0,
	"(": 1,
	"||": 2,
	"&&": 3
...
}, he = /defined\s*?\((.+?)\)/g, L = /defined\s*?\[(.+?)\]/g, ge = /#include\s?<(.+)>(\((.*)\))*(\[(.*)\])*/g, _e = /__decl__/, R = /light\{X\}.(\w*)/g, z = /\{X\}/g, B = [], ve = /(#ifdef)|(#else)|(#elif)|(#endif)|(#ifndef)|(#if)/;
function ye(e) {
...
function V(e, t, n, r) {
	t.processor?.preProcessShaderCode && (e = t.processor.preProcessShaderCode(e, t.isFragment)), K(e, t, (e) => {
		t.processCodeAfterIncludes && (e = t.processCodeAfterIncludes(t.isFragment ? "fragment" : "vertex", e, t.defines)), n(Te(e, t, r), e);
	});
}
function be(e, t, n) {
...
function H(e) {
	...
	if (t && t.length) return new I(t[1].trim(), e[0] === "!");
	let n = [
		"==",
		"!=",
		">=",
	...
	if (i === -1) return new I(e);
	let a = e.substring(0, i).trim(), o = e.substring(i + r.length).trim();
	return new me(a, r, o);
}
function Se(e) {
	e = e.replace(he, "defined[$1]");
	let t = F.infixToPostfix(e), n = [];
	for (let e of t) if (e !== "||" && e !== "&&") n.push(e);
	else if (n.length >= 2) {
		let t = n[n.length - 1], r = n[n.length - 2];
		n.length -= 2;
		let i = e == "&&" ? new pe() : new fe();
		typeof t == "string" && (t = t.replace(L, "defined($1)")), typeof r == "string" && (r = r.replace(L, "defined($1)")), i.leftOperand = typeof r == "string" ? H(r) : r, i.rightOperand = typeof t == "string" ? H(t) : t, n.push(i);
	}
	let r = n[n.length - 1];
	return typeof r == "string" && (r = r.replace(L, "defined($1)")), typeof r == "string" ? H(r) : r;
}
function U(e, t) {
	let n = new de(), r = e.substring(0, t), i = e.substring(t);
	return i = i.substring(0, (i.indexOf("//") + 1 || i.length + 1) - 1).trim(), n.testExpression = r === "#ifdef" ? new I(i) : r === "#ifndef" ? new I(i, !0) : Se(i), n;
}
function W(e, t, n, r) {
	let i;
	for (; G(e, n, r);) {
		...
		if (r.indexOf("#") >= 0) {
			...
			if (i && i.length) {
				switch (i[0]) {
					...
					case "#if": {
						let i = new P(), a = U(r, 3);
						t.children.push(i), i.children.push(a), W(e, i, a, n);
						break;
					}
				}
				continue;
...
function Ce(e, t, n, r) {
	let i = new N(), a = new ue();
	return a.lineIndex = -1, a.lines = e.split("\n"), G(a, i, r), i.process(t, n, r);
}
function we(e, t) {
	let n = e.defines, r = {};
	for (let e of n) {
	...
	return e.processor?.shaderLanguage === 0 && (r.GL_ES = "true"), r.__VERSION__ = e.version, r[e.platformName] = "true", v(r, t?.isNDCHalfZRange, t?.useReverseDepthBuffer, t?.useExactSrgbConversions), r;
}
function Te(e, t, n) {
	let r = xe(e, t);
	...
	let i = t.defines, a = we(t, n);
	t.processor.preProcessor && (r = t.processor.preProcessor(r, i, a, t.isFragment, t.processingContext));
	let o = {};
	return r = Ce(r, a, t, o), t.processor.postProcessor && (r = t.processor.postProcessor(r, i, t.isFragment, t.processingContext, n ? { drawBuffersExtensionDisabled: !n.getCaps().drawBuffersExtension } : {}, a, o)), n?._features.needShaderCodeInlining && (r = n.inlineShaderCode(r)), r;
}
function K(e, t, n) {
	B.length = 0;
	let r;
	for (; (r = ge.exec(e)) !== null;) B.push(r);
	let i = [e], a = !1;
	for (let e of B) {
		let r = e[1];
		if (r.indexOf("__decl__") !== -1 && (r = r.replace(_e, ""), t.supportsUniformBuffers && (r = r.replace("Vertex", "Ubo").replace("Fragment", "Ubo")), r += "Declaration"), t.includesShadersStore[r]) {
			...
			if (e[4]) {
				...
				if (r.indexOf("..") !== -1) {
					...
					for (let e = i; e < a; e++) t.supportsUniformBuffers || (o = o.replace(R, (e, t) => t + "{X}")), n += o.replace(z, e.toString()) + "\n";
				} else t.supportsUniformBuffers || (n = n.replace(R, (e, t) => t + "{X}")), n = n.replace(z, r);
			}
			let o = [];
			for (let t of i) {
				let r = t.split(e[0]);
...
function Oe(e, t, n, r, i, a, o) {
	let s, c, l = d() ? a?.getHostDocument() : null;
	s = typeof t == "string" ? t : t.vertexSource ? "source:" + t.vertexSource : t.vertexElement ? l?.getElementById(t.vertexElement) || t.vertexElement : t.vertex || t, c = typeof t == "string" ? t : t.fragmentSource ? "source:" + t.fragmentSource : t.fragmentElement ? l?.getElementById(t.fragmentElement) || t.fragmentElement : t.fragment || t;
	let u = [void 0, void 0], f = () => {
		if (u[0] && u[1]) {
			let [s, c] = u;
			ye(e), V(s, e, (s, l) => {
				o && (o._vertexSourceCodeBeforeMigration = l), n && (s = n("vertex", s)), e.isFragment = !0, V(c, e, (a, c) => {
					o && (o._fragmentSourceCodeBeforeMigration = c), n && (a = n("fragment", a));
					let l = be(s, a, e);
					e = null;
					let u = ke(l.vertexCode, l.fragmentCode, t, i);
	...
	J(s, "Vertex", "", (e) => {
		o && (o._rawVertexSourceCode = e), u[0] = e, f();
	}, i), J(c, "Fragment", "Pixel", (e) => {
		o && (o._rawFragmentSourceCode = e), u[1] = e, f();
	}, i);
}
function J(e, t, n, r, a, o) {
	...
	let c;
	if (c = e[0] === "." || e[0] === "/" || e.indexOf("http") > -1 ? e : i.GetShadersRepository(a) + e, o ||= _, !o) throw Error("loadFileInjection is not defined");
...
var Ae = (e, t, n, i) => {
	try {
		let r = e.context ? x(e.context) : null;
...
var Ne = (e, t, n, r = 16, i = 3e4, a = !0, o) => {
	if (a && Me(e, t, n)) return null;
	let s = setInterval(() => {
		Me(e, t, n) ? clearInterval(s) : (i -= r, i < 0 && (clearInterval(s), n?.(/* @__PURE__ */ Error("Operation timed out after maximum retries. " + (o || "")), !0)));
	}, r);
	...
	constructor(n, r, i, a = null, o, s = null, c = null, l = null, u = null, d, f = "", p = 0, m) {
		...
		this._engine.shaderPlatformName === "WEBGL2" && (g = Ee(h, this._engine._gl) ?? g), this._attributeLocationByName = {}, this.uniqueId = e._UniqueIdSeed++, g ? (this._pipelineContext = g, this._pipelineContext.setEngine(this._engine), this._onRenderingStateCompiled(this._pipelineContext), this._pipelineContext.program && (this._pipelineContext.program.__SPECTOR_rebuildProgram = this._rebuildProgram.bind(this))) : this._processShaderCodeAsync(null, !1, null, m), this._onReleaseEffectsObserver = this._engine.onReleaseEffectsObservable.addOnce(() => {
			this._onReleaseEffectsObserver = null, !this.isDisposed && this.dispose(!0);
		});
	}
	async _processShaderCodeAsync(e = null, t = !1, n = null, r) {
		r && await r(), this._processingContext = n || this._engine._getShaderProcessingContext(this._shaderLanguage, !1), Oe({
	...
	_checkIsReady(e) {
		Ne(() => this._isReadyInternal() || this._isDisposed, () => {}, (t) => {
	...
	dispose(t = !1) {
		...
		this._refCount > 0 || this._isDisposed || (this._onReleaseEffectsObserver &&= (this._engine.onReleaseEffectsObservable.remove(this._onReleaseEffectsObserver), null), this._pipelineContext && De(this._pipelineContext), this._engine._releaseEffect(this), this.clearCodeCache(), this._isDisposed = !0);
	}
...
X.LogShaderCodeOnCompilationError = !0, X.PersistentMode = !1, X.AutomaticallyClearCodeCache = !1, X._UniqueIdSeed = 0, X._BaseCache = {}, X.ShadersStore = i.ShadersStore, X.IncludesShadersStore = i.IncludesShadersStore;
//#endregion
//#region node_modules/@babylonjs/core/Misc/precisionDate.js
var Pe = class {
	static get Now() {
		return d() && window.performance && window.performance.now ? window.performance.now() : Date.now();
	}
}, Fe = class {
	constructor(e = !0) {
	...
	setAlphaMode(e, t) {
		...
		switch (e) {
			...
			case 19:
				...
				break;
			case 20: this.setAlphaBlendFunctionParameters(1, 35065, 0, 1, t);
		}
...
var $ = class i {
	...
	_renderLoop(e) {
		this._processFrame(e), this._activeRenderLoops.length > 0 && this._frameHandler === 0 && (this._frameHandler = this._queueNewFrame(this._boundRenderFunction, this.getHostWindow()));
	}
	_renderFrame() {
	...
	getHostWindow() {
		return d() ? this._renderingCanvas && this._renderingCanvas.ownerDocument && this._renderingCanvas.ownerDocument.defaultView ? this._renderingCanvas.ownerDocument.defaultView : window : null;
	}
	...
	_createTextureBase(t, n, a, o, c = 3, l = null, u = null, d, f, p = null, m = null, h = null, g = null, _, v, y) {
		t ||= "";
		let b = t.substring(0, 5) === "data:", ee = t.substring(0, 5) === "blob:", x = b && t.indexOf(";base64,") !== -1, S = m || new s(this, 1);
		S !== m && (S.label = t.substring(0, 60));
		let C = t;
		this._transformTextureUrl && !x && !m && !p && (t = this._transformTextureUrl(t)), C !== t && (S._originalUrl = C);
		let w = t.lastIndexOf("."), T = g || (w > -1 ? t.substring(w).toLowerCase() : "");
		T.indexOf("?") > -1 && (T = T.split("?")[0]);
		let E = i.GetCompatibleTextureLoader(T, _);
		o && o.addPendingData(S), S.url = t, S.generateMipMaps = !n, S.samplingMode = c, S.invertY = a, S._useSRGBBuffer = this._getUseSRGBBuffer(!!y, n), this._doNotHandleContextLost || (S._buffer = p);
		let D = null;
		l && !m && (D = S.onLoadedObservable.add(l)), m || this._internalTexturesCache.push(S);
		let O = (i, a) => {
			o && o.removePendingData(S), t === C ? (D && S.onLoadedObservable.remove(D), e.UseFallbackTexture && t !== e.FallbackTexture && this._createTextureBase(e.FallbackTexture, n, S.invertY, o, c, null, u, d, f, p, S), i = (i || "Unknown error") + (e.UseFallbackTexture ? " - Fallback texture was used" : ""), S.onErrorObservable.notifyObservers({
				message: i,
				exception: a
			}), u && u(i, a)) : (r.Warn(`Failed to load ${t}, falling back to ${C}`), this._createTextureBase(C, n, S.invertY, o, c, l, u, d, f, p, S, h, g, _, v, y));
		};
		if (E) {
			let e = async (e) => {
				(await E).loadData(e, S, (e, t, n, r, i, a) => {
					a ? O("TextureLoader failed to load data") : d(S, T, o, {
						width: e,
						height: t
					}, S.invertY, !n, r, () => (i(), !1), c);
				}, v);
			...
			if (!p) this._loadFile(t, async (t) => {
				try {
					...
					O("Failed to parse texture data", e);
				}
			}, void 0, o ? o.offlineProvider : void 0, !0, (e, t) => {
				O("Unable to load " + (e && e.responseURL, t));
			});
			else {
				let t = async (t) => {
					try {
			...
			let e = (e) => {
				ee && !this._doNotHandleContextLost && (S._buffer = e), d(S, T, o, e, S.invertY, n, !1, f, c);
			};
			!b || x ? p && (typeof p.decoding == "string" || p.close) ? e(p) : i._FileToolsLoadImage(t || "", e, O, o ? o.offlineProvider : null, _, S.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this) : typeof p == "string" || p instanceof ArrayBuffer || ArrayBuffer.isView(p) || p instanceof Blob ? i._FileToolsLoadImage(p, e, O, o ? o.offlineProvider : null, _, S.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this) : p && e(p);
		}
		return S;
	}
	_rebuildBuffers() {
	...
	getHostDocument() {
		return this._renderingCanvas && this._renderingCanvas.ownerDocument ? this._renderingCanvas.ownerDocument : p() ? document : null;
	}
	...
	constructor(r, i, a) {
		this._colorWrite = !0, this._colorWriteChanged = !0, this._depthCullingState = new Fe(), this._stencilStateComposer = new Ie(), this._stencilState = new Z(), this._alphaState = new Le(!1), this._alphaMode = Array(8).fill(-1), this._alphaEquation = Array(8).fill(-1), this._activeRequests = [], this._badOS = !1, this._badDesktopOS = !1, this._compatibilityMode = !0, this._internalTexturesCache = [], this._currentRenderTarget = null, this._boundTexturesCache = {}, this._activeChannel = 0, this._currentTextureChannel = -1, this._viewportCached = {
			x: 0,
			y: 0,
			z: 0,
			w: 0
		}, this._isWebGPU = !1, this._enableGPUDebugMarkers = !1, this.onCanvasBlurObservable = new t(), this.onCanvasFocusObservable = new t(), this.onNewSceneAddedObservable = new t(), this.onResizeObservable = new t(), this.onCanvasPointerOutObservable = new t(), this.onEffectErrorObservable = new t(), this.disablePerformanceMonitorInBackground = !1, this.disableVertexArrayObjects = !1, this._frameId = 0, this.hostInformation = { isMobile: !1 }, this.isFullscreen = !1, this.enableOfflineSupport = !1, this.disableManifestCheck = !1, this.disableContextMenu = !0, this.currentRenderPassId = 0, this.isPointerLock = !1, this.postProcesses = [], this.canvasTabIndex = 1, this._contextWasLost = !1, this._useReverseDepthBuffer = !1, this.isNDCHalfZRange = !1, this.hasOriginBottomLeft = !0, this._renderTargetWrapperCache = [], this._compiledEffects = {}, this._isDisposed = !1, this.scenes = [], this._virtualScenes = [], this.onBeforeTextureInitObservable = new t(), this.renderEvenInBackground = !0, this.preventCacheWipeBetweenFrames = !1, this._frameHandler = 0, this._activeRenderLoops = [], this._windowIsBackground = !1, this._boundRenderFunction = (e) => this._renderLoop(e), this._lastFrameTime = 0, this._renderAccumulator = 0, this.skipFrameRender = !1, this.onBeforeShaderCompilationObservable = new t(), this.onAfterShaderCompilationObservable = new t(), this.onBeginFrameObservable = new t(), this.onEndFrameObservable = new t(), this._transformTextureUrl = null, this._uniformBuffers = [], this._storageBuffers = [], this._highPrecisionShadersAllowed = !0, this.onContextLostObservable = new t(), this.onContextRestoredObservable = new t(), this._name = "", this.premultipliedAlpha = !0, this.adaptToDeviceRatio = !1, this._lastDevicePixelRatio = 1, this._doNotHandleContextLost = !1, this.cullBackFaces = null, this._renderPassNames = ["main"], this._fps = 60, this._deltaTime = 0, this._deterministicLockstep = !1, this._lockstepMaxSteps = 4, this._timeStep = 1 / 60, this.onDisposeObservable = new t(), this.onReleaseEffectsObservable = new t(), e.Instances.push(this), this.startTime = Pe.Now, this._stencilStateComposer.stencilGlobal = this._stencilState, n.SetMatrixPrecision(!!i.useLargeWorldRendering || !!i.useHighPrecisionMatrix), f() && navigator.userAgent && (this._badOS = /iPad/i.test(navigator.userAgent) || /iPhone/i.test(navigator.userAgent), this._badDesktopOS = /^((?!chrome|android).)*safari/i.test(navigator.userAgent)), this.adaptToDeviceRatio = a ?? !1, i.antialias = r ?? i.antialias, i.deterministicLockstep = i.deterministicLockstep ?? !1, i.lockstepMaxSteps = i.lockstepMaxSteps ?? 4, i.timeStep = i.timeStep ?? 1 / 60, i.stencil = i.stencil ?? !0, this._audioContext = i.audioEngineOptions?.audioContext ?? null, this._audioDestination = i.audioEngineOptions?.audioDestination ?? null, this.premultipliedAlpha = i.premultipliedAlpha ?? !0, this._doNotHandleContextLost = !!i.doNotHandleContextLost, this._isStencilEnable = !!i.stencil, this.useExactSrgbConversions = i.useExactSrgbConversions ?? !1;
		let o = d() && window.devicePixelRatio || 1, s = i.limitDeviceRatio || o;
		a = a || i.adaptToDeviceRatio || !1, this._hardwareScalingLevel = a ? 1 / Math.min(s, o) : 1, this._lastDevicePixelRatio = o, this._creationOptions = i;
	}
	resize(e = !1) {
		let t, n;
		if (this.adaptToDeviceRatio) {
			let e = d() && window.devicePixelRatio || 1, t = this._lastDevicePixelRatio / e;
	...
	createRawTexture(e, t, n, r, i, a, o, s, c, l, d, f) {
		throw u("engine.rawTexture");
	}
	createRawCubeTexture(e, t, n, r, i, a, o, s) {
		throw u("engine.rawTexture");
	}
	createRawTexture3D(e, t, n, r, i, a, o, s, c, l, d) {
		throw u("engine.rawTexture");
	}
	createRawTexture2DArray(e, t, n, r, i, a, o, s, c, l, d, f) {
		throw u("engine.rawTexture");
	}
	_sharedInit(e) {
	...
	_setupMobileChecks() {
		navigator && navigator.userAgent && (this._checkForMobile = () => {
			...
			this.hostInformation.isMobile = e.indexOf("Mobile") !== -1 || e.indexOf("Mac") !== -1 && p() && "ontouchend" in document;
		}, this._checkForMobile(), d() && window.addEventListener("resize", this._checkForMobile));
	}
	...
	static _FileToolsLoadFile(e, t, n, r, i, a) {
		if (h.loadFile) return h.loadFile(e, t, n, r, i, a);
		throw u("FileTools");
	}
	dispose() {
...
$._RenderPassIdCounter = 0, $._RescalePostProcessFactory = null, $.CollisionsEpsilon = .001, $.QueueNewFrame = Q;
//#endregion
export { m as A, w as C, g as D, h as E, s as F, f as M, d as N, v as O, u as P, C as S, x as T, O as _, je as a, re as b, K as c, se as d, ae as f, ie as g, E as h, X as i, p as j, y as k, q as l, A as m, Le as n, Ne as o, oe as p, Pe as r, De as s, $ as t, M as u, D as v, S as w, T as x, te as y };

//# sourceMappingURL=abstractEngine-C4dI3NwB.js.map