import { a as e, u as t } from "./math.color.pure-DKgyx9hD.js";
//#region node_modules/@babylonjs/core/Maths/math.plane.js
var n = class e {
	constructor(e, n, r, i) {
		this.normal = new t(e, n, r), this.d = i;
	}
	asArray() {
		return [
			this.normal.x,
	...
	isFrontFacingTo(e, n) {
		return t.Dot(this.normal, e) <= n;
	}
	signedDistanceTo(e) {
		return t.Dot(e, this.normal) + this.d;
	}
	static FromArray(t) {
	...
	static SignedDistanceToPlaneFromPositionAndNormal(e, n, r) {
		let i = -(n.x * e.x + n.y * e.y + n.z * e.z);
		return t.Dot(r, n) + i;
	}
};
n._TmpMatrix = e.Identity();
//#endregion
...
//# sourceMappingURL=compatibilityOptions-D5dSU-sG.js.map