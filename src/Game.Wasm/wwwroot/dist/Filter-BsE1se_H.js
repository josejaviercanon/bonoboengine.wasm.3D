import { B as e, D as t, F as n, I as r, L as i, O as a, P as o, R as s, T as c, _ as l, b as u, c as d, g as f, h as ee, i as te, j as ne, k as p, m, p as re, u as ie, v as h, w as g, x as _, y as ae, z as v } from "./Geometry-DYsNE2Rs.js";
...
var oe = {
	...
	set cacheAsBitmap(e) {
		a("v8.6.0", "cacheAsBitmap is deprecated, use cacheAsTexture instead."), this.cacheAsTexture(e);
	}
};
//#endregion
...
var ce = {
	...
	addChildAt(e, t) {
		this.allowChildren || a(p, "addChildAt: Only Containers will be allowed to add children in v8.0.0");
		let { children: n } = this;
	...
	getMaskEffect(e) {
		...
		for (let t = 0; t < this._tests.length; t++) {
			let n = this._tests[t];
			if (n.test(e)) return f.get(n.maskClass, e);
		}
		return e;
	}
	returnMaskEffect(e) {
...
e.handleByList(v.MaskEffect, C._effectClasses);
//#endregion
...
var w = {
	...
	set filters(e) {
		...
		let t = this._filterEffect ||= new S();
		e = e;
	...
	set filterArea(e) {
		this._filterEffect ||= new S(), this._filterEffect.filterArea = e;
	},
	get filterArea() {
	...
	label: null,
	get name() {
		return a(p, "Container.name property has been removed, use Container.label instead"), this.label;
	},
	set name(e) {
		a(p, "Container.name property has been removed, use Container.label instead"), this.label = e;
	},
...
}, T = f.getPool(o), E = f.getPool(u), de = new o(), fe = {
	getFastGlobalBounds(e, t) {
		t ||= new u(), t.clear(), this._getGlobalBoundsRecursive(!!e, t, this.parentRenderLayer), t.isValid || t.set(0, 0, 0, 0);
	...
	_getGlobalBoundsRecursive(e, t, n) {
		...
		if ((this.renderGroup || i) && (r = E.get().clear()), this.boundsArea) t.addRect(this.boundsArea, this.worldTransform);
		else {
		...
		if (i) {
			...
			e && r.applyMatrix(n.worldTransform.copyTo(de).invert()), t.addBounds(r), E.return(r);
		} else this.renderGroup && (t.addBounds(r, this.relativeGroupTransform), E.return(r));
	}
};
//#endregion
...
function D(e, t, n) {
	n.clear();
	let r, i;
	return e.parent ? t ? r = e.parent.worldTransform : (i = T.get().identity(), r = k(e, i)) : r = o.IDENTITY, O(e, n, r, t), i && T.return(i), n.isValid || n.set(0, 0, 0, 0), n;
}
function O(e, t, n, r) {
	if (!e.visible || !e.measurable) return;
	let i;
	r ? i = e.worldTransform : (e.updateLocalTransform(), i = T.get(), i.appendFrom(e.localTransform, n));
	let a = t, s = !!e.effects.length;
	if (s && (t = E.get().clear()), e.boundsArea) t.addRect(e.boundsArea, i);
	else {
		let n = e.bounds;
		n && !n.isEmpty() && (t.matrix = i, t.addBounds(n));
		for (let n = 0; n < e.children.length; n++) O(e.children[n], t, i, r);
	}
	if (s) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addBounds?.(t);
		a.addBounds(t, o.IDENTITY), E.return(t);
	}
	r || T.return(i);
}
function k(e, t) {
	let n = e.parent;
	return n && (k(n, t), n.updateLocalTransform(), t.append(n.localTransform)), t;
}
//#endregion
//#region node_modules/pixi.js/lib/scene/container/utils/multiplyColors.mjs
var A = 16777215;
function j(e, t) {
	return e === A ? t : t === A ? e : ee(e, t);
}
//#endregion
...
var pe = {
	...
	getGlobalTransform(e = new o(), t) {
		if (t) return e.copyFrom(this.worldTransform);
		this.updateLocalTransform();
		let n = k(this, T.get().identity());
		return e.appendFrom(this.localTransform, n), T.return(n), e;
	},
	getGlobalTint(e) {
		if (e) return this.renderGroup ? M(this.renderGroup.worldColor) : this.parentRenderGroup ? M(j(this.localColor, this.parentRenderGroup.worldColor)) : this.tint;
		let t = this.localColor, n = this.parent;
		for (; n;) t = j(t, n.localColor), n = n.parent;
		return M(t);
	}
};
//#endregion
...
function N(e, t, n) {
	return t.clear(), n ||= o.IDENTITY, P(e, t, n, e, !0), t.isValid || t.set(0, 0, 0, 0), t;
}
function P(e, t, n, r, i) {
	let a;
	if (i) a = T.get(), a = n.copyTo(a);
	else {
		if (!e.visible || !e.measurable) return;
		e.updateLocalTransform();
		let t = e.localTransform;
		a = T.get(), a.appendFrom(t, n);
	}
	let s = t, c = !!e.effects.length;
	if (c && (t = E.get().clear()), e.boundsArea) t.addRect(e.boundsArea, a);
	else {
		e.renderPipeId && (t.matrix = a, t.addBounds(e.bounds));
		let n = e.children;
		for (let e = 0; e < n.length; e++) P(n[e], t, a, r, !1);
	}
	if (c) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addLocalBounds?.(t, r);
		s.addBounds(t, o.IDENTITY), E.return(t);
	}
	T.return(a);
}
//#endregion
...
function F(e, t) {
	...
	for (let e = 0; e < n.length; e++) {
		...
		(t.data[o] !== i || t.data[o + 1] !== a) && (t.data[t.index] = i, t.data[t.index + 1] = a, t.didChange = !0), t.index = o + 2, r.children.length && F(r, t);
	}
	return t.didChange;
}
//#endregion
...
var me = new o(), he = {
	...
	getLocalBounds() {
		...
		return e.index = 1, e.didChange = !1, e.data[0] !== this._didViewChangeTick && (e.didChange = !0, e.data[0] = this._didViewChangeTick), F(this, e), e.didChange && N(this, e.localBounds, me), e.localBounds;
	},
	getBounds(e, t) {
		return D(this, e, t || new u());
	}
}, I = {
	_onRender: null,
	set onRender(e) {
	...
	sortChildren() {
		this.sortDirty && (this.sortDirty = !1, this.children.sort(ge));
	}
};
function ge(e, t) {
...
var _e = {
	...
	constructor(e) {
		this._poolKeyHash = /* @__PURE__ */ Object.create(null), this._texturePool = {}, this.textureOptions = e || {}, this.enableFullScreen = !1, this.textureStyle = new c(this.textureOptions);
	}
	createTexture(e, t, n, r) {
		...
		return new _({
			source: i,
			label: `texturePool_${ve++}`
		});
	}
	getOptimalTexture(e, n, r = 1, i, a = !1) {
		let o = Math.ceil(e * r - 1e-6), s = Math.ceil(n * r - 1e-6);
		o = t(o), s = t(s);
		let c = +!!i, l = +!!a, u = (o << 17) + (s << 2) + (l << 1) + c;
		this._texturePool[u] || (this._texturePool[u] = []);
		let d = this._texturePool[u].pop();
		return d ||= this.createTexture(o, s, i, a), d.source._resolution = r, d.source.width = o / r, d.source.height = s / r, d.source.pixelWidth = o, d.source.pixelHeight = s, d.frame.x = 0, d.frame.y = 0, d.frame.width = e, d.frame.height = n, d.updateUvs(), this._poolKeyHash[d.uid] = u, d;
	}
...
var z = class {
	constructor() {
		this.renderPipeId = "renderGroup", this.root = null, this.canBundle = !1, this.renderGroupParent = null, this.renderGroupChildren = [], this.worldTransform = new o(), this.worldColorAlpha = 4294967295, this.worldColor = 16777215, this.worldAlpha = 1, this.childrenToUpdate = /* @__PURE__ */ Object.create(null), this.updateTick = 0, this.gcTick = 0, this.childrenRenderablesToUpdate = {
			list: [],
			index: 0
		}, this.structureDidChange = !0, this.instructionSet = new m(), this._onRenderContainers = [], this.textureNeedsUpdate = !0, this.isCachedAsTexture = !1, this._matrixDirty = 7;
	}
	init(e) {
	...
	disableCacheAsTexture() {
		this.isCachedAsTexture = !1, this.texture &&= (R.returnTexture(this.texture, !0), null);
	}
	updateCacheTexture() {
	...
	get inverseWorldTransform() {
		return this._matrixDirty & 1 ? (this._matrixDirty &= -2, this._inverseWorldTransform ||= new o(), this._inverseWorldTransform.copyFrom(this.worldTransform).invert()) : this._inverseWorldTransform;
	}
	get textureOffsetInverseTransform() {
		return this._matrixDirty & 2 ? (this._matrixDirty &= -3, this._textureOffsetInverseTransform ||= new o(), this._textureOffsetInverseTransform.copyFrom(this.inverseWorldTransform).translate(-this._textureBounds.x, -this._textureBounds.y)) : this._textureOffsetInverseTransform;
	}
	get inverseParentTextureTransform() {
		if (!(this._matrixDirty & 4)) return this._inverseParentTextureTransform;
		this._matrixDirty &= -5;
		let e = this._parentCacheAsTextureRenderGroup;
		return e ? (this._inverseParentTextureTransform ||= new o(), this._inverseParentTextureTransform.copyFrom(this.worldTransform).prepend(e.inverseWorldTransform).translate(-e._textureBounds.x, -e._textureBounds.y)) : this.worldTransform;
	}
...
var V = new y(null), H = new y(null), U = new y(null, 1, 1), W = new y(null), G = class t extends s {
	constructor(e = {}) {
		super(), this.uid = ne("renderable"), this._updateFlags = 15, this.renderGroup = null, this.parentRenderGroup = null, this.parentRenderGroupIndex = 0, this.didChange = !1, this.didViewUpdate = !1, this.relativeRenderGroupDepth = 0, this.children = [], this.parent = null, this.includeInBuild = !0, this.measurable = !0, this.isSimple = !0, this.parentRenderLayer = null, this.updateTick = -1, this.localTransform = new o(), this.relativeGroupTransform = new o(), this.groupTransform = this.relativeGroupTransform, this.destroyed = !1, this._position = new y(this, 0, 0), this._scale = U, this._pivot = H, this._origin = W, this._skew = V, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._rotation = 0, this.localColor = 16777215, this.localAlpha = 1, this.groupAlpha = 1, this.groupColor = 16777215, this.groupColorAlpha = 4294967295, this.localBlendMode = "inherit", this.groupBlendMode = "normal", this.localDisplayStatus = 7, this.globalDisplayStatus = 7, this._didContainerChangeTick = 0, this._didViewChangeTick = 0, this._didLocalTransformChangeId = -1, this.effects = [], B(this, e, {
			children: !0,
			parent: !0,
			effects: !0
	...
	static mixin(n) {
		a("8.8.0", "Container.mixin is deprecated, please use extensions.mixin instead."), e.mixin(t, n);
	}
	set _didChangeId(e) {
	...
	addChild(...e) {
		if (this.allowChildren || a(p, "addChild: Only Containers will be allowed to add children in v8.0.0"), e.length > 1) {
	...
	enableRenderGroup() {
		...
		e?.removeChild(this), this.renderGroup = f.get(z, this), this.groupTransform = o.IDENTITY, e?.addChild(this), this._updateIsSimple();
	}
	disableRenderGroup() {
		if (!this.renderGroup) return;
		let e = this.parentRenderGroup;
		e?.removeChild(this), f.return(this.renderGroup), this.renderGroup = null, this.groupTransform = this.relativeGroupTransform, e?.addChild(this), this._updateIsSimple();
	}
	_updateIsSimple() {
		this.isSimple = !this.renderGroup && this.effects.length === 0;
	}
	get worldTransform() {
		return this._worldTransform ||= new o(), this.renderGroup ? this._worldTransform.copyFrom(this.renderGroup.worldTransform) : this.parentRenderGroup && this._worldTransform.appendFrom(this.relativeGroupTransform, this.parentRenderGroup.worldTransform), this._worldTransform;
	}
	get x() {
	...
	get pivot() {
		return this._pivot === H && (this._pivot = new y(this, 0, 0)), this._pivot;
	}
	set pivot(e) {
		this._pivot === H && (this._pivot = new y(this, 0, 0), this._origin !== W && h("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._pivot.set(e) : this._pivot.copyFrom(e);
	}
	get skew() {
		return this._skew === V && (this._skew = new y(this, 0, 0)), this._skew;
	}
	set skew(e) {
		this._skew === V && (this._skew = new y(this, 0, 0)), this._skew.copyFrom(e);
	}
	get scale() {
		return this._scale === U && (this._scale = new y(this, 1, 1)), this._scale;
	}
	set scale(e) {
		this._scale === U && (this._scale = new y(this, 0, 0)), typeof e == "string" && (e = parseFloat(e)), typeof e == "number" ? this._scale.set(e) : this._scale.copyFrom(e);
	}
	get origin() {
		return this._origin === W && (this._origin = new y(this, 0, 0)), this._origin;
	}
	set origin(e) {
		this._origin === W && (this._origin = new y(this, 0, 0), this._pivot !== H && h("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._origin.set(e) : this._origin.copyFrom(e);
	}
	get width() {
...
e.mixin(G, ce, fe, _e, I, he, w, ue, L, oe, se, pe, le);
//#endregion
//#region node_modules/pixi.js/lib/scene/view/ViewContainer.mjs
var K = class extends G {
	constructor(e) {
		super(e), this.canBundle = !0, this.allowChildren = !1, this._roundPixels = 0, this._lastUsed = -1, this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this._bounds = new u(0, 1, 0, 0), this._boundsDirty = !0, this.autoGarbageCollect = e.autoGarbageCollect ?? !0;
	}
	get bounds() {
	...
	constructor(e = _.EMPTY) {
		e instanceof _ && (e = { texture: e });
		let { texture: t = _.EMPTY, anchor: n, roundPixels: r, width: i, height: a, ...o } = e;
		super({
			label: "Sprite",
			...o
	...
	static from(t, n = !1) {
		return t instanceof _ ? new e(t) : new e(_.from(t, n));
	}
	set texture(e) {
		e ||= _.EMPTY;
		let t = this._texture;
	...
	get visualBounds() {
		return b(this._visualBounds, this._anchor, this._texture), this._visualBounds;
	}
	get sourceBounds() {
		return a("8.6.1", "Sprite.sourceBounds is deprecated, use visualBounds instead."), this.visualBounds;
	}
	updateBounds() {
	...
	constructor(e) {
		e.resource ||= re.get().createCanvas(), e.width || (e.width = e.resource.width, e.autoDensity || (e.width /= e.resolution)), e.height || (e.height = e.resource.height, e.autoDensity || (e.height /= e.resolution)), super(e), this.uploadMethodId = "image", this.autoDensity = e.autoDensity, this.resizeCanvas(), this.transparent = !!e.transparent;
	}
	resizeCanvas() {
...
q.extension = v.TextureSource;
//#endregion
//#region node_modules/pixi.js/lib/ticker/const.mjs
var J = /* @__PURE__ */ ((e) => (e[e.INTERACTION = 50] = "INTERACTION", e[e.HIGH = 25] = "HIGH", e[e.NORMAL = 0] = "NORMAL", e[e.LOW = -25] = "LOW", e[e.UTILITY = -50] = "UTILITY", e))(J || {}), Y = class {
	...
	constructor() {
		this.autoStart = !1, this.deltaTime = 1, this.lastTime = -1, this.speed = 1, this.started = !1, this._requestId = null, this._maxElapsedMS = 100, this._minElapsedMS = 0, this._protected = !1, this._lastFrame = -1, this._head = new Y(null, null, Infinity), this.deltaMS = 1 / e.targetFPMS, this.elapsedMS = 1 / e.targetFPMS, this._tick = (e) => {
	...
	add(e, t, n = J.NORMAL) {
		return this._addListener(new Y(e, t, n));
	}
	addOnce(e, t, n = J.NORMAL) {
		return this._addListener(new Y(e, t, n, !0));
	}
	_addListener(e) {
...
var Q = Z, $ = class e extends te {
	...
	static from(t) {
		...
		return n && (a = d.from(n)), r && (o = ie.from(r)), new e({
			gpuProgram: a,
			glProgram: o,
			...i
		});
...
var Se = $;
//#endregion
export { T as _, q as a, b, G as c, R as d, N as f, E as g, D as h, J as i, B as l, j as m, Q as n, ye as o, M as p, be as r, K as s, Se as t, z as u, S as v, y as x, x as y };

//# sourceMappingURL=Filter-BsE1se_H.js.map