...
import { M as n, N as r, P as i, i as a, o, p as s, r as c } from "./abstractEngine-C4dI3NwB.js";
import { t as l } from "./logger-DQIzSR_y.js";
import { a as u, c as d, f as ee, i as f, n as te, o as p, r as ne, t as re } from "./lightConstants-t4r6lMWn.js";
import { a as m, c as h, i as g, o as ie, r as _, s as v, t as y, u as ae } from "./math.vector-BskpwSKn.js";
import { n as oe } from "./typeStore-pENEWnX2.js";
import { a as se, c as ce, i as b, l as x } from "./texture-XPOS5lxO.js";
import { r as S } from "./drawWrapper-B2Z7Hhiz.js";
import { a as le, d as ue, h as C, o as de, r as w } from "./decorators-BjxgwLXx.js";
import { a as fe, c as pe, n as T, s as me } from "./tools-CL3QBXT6.js";
...
var he = class {
	...
	add(e, t) {
		return this._data[e] === void 0 && (this._data[e] = t, ++this._count, !0);
	}
	set(e, t) {
		return this._data[e] !== void 0 && (this._data[e] = t, !0);
	}
	getAndRemove(e) {
		let t = this.get(e);
...
var E = class e {
	...
	clone() {
		return b.Clone(() => new e(), this);
	}
	serialize() {
		return b.Serialize(this);
	}
	static Parse(t) {
		return b.Parse(() => new e(), t, null, null);
	}
};
E.PrepareUniforms = ge, C([w()], E.prototype, "_globalHue", void 0), C([w()], E.prototype, "_globalDensity", void 0), C([w()], E.prototype, "_globalSaturation", void 0), C([w()], E.prototype, "_globalExposure", void 0), C([w()], E.prototype, "_highlightsHue", void 0), C([w()], E.prototype, "_highlightsDensity", void 0), C([w()], E.prototype, "_highlightsSaturation", void 0), C([w()], E.prototype, "_highlightsExposure", void 0), C([w()], E.prototype, "_midtonesHue", void 0), C([w()], E.prototype, "_midtonesDensity", void 0), C([w()], E.prototype, "_midtonesSaturation", void 0), C([w()], E.prototype, "_midtonesExposure", void 0), b._ColorCurvesParser = E.Parse;
//#endregion
//#region node_modules/@babylonjs/core/Materials/imageProcessingConfiguration.functions.js
function _e(e, t) {
	t.EXPOSURE && e.push("exposureLinear"), t.CONTRAST && e.push("contrast"), t.COLORGRADING && e.push("colorTransformSettings"), (t.VIGNETTE || t.DITHER) && e.push("vInverseScreenSize"), t.VIGNETTE && (e.push("vignetteSettings1"), e.push("vignetteSettings2")), t.COLORCURVES && ge(e), t.DITHER && e.push("ditherIntensity");
}
function ve(e, t) {
...
var D = class e {
	constructor() {
		this.colorCurves = new E(), this._colorCurvesEnabled = !1, this._colorGradingEnabled = !1, this._colorGradingWithGreenDepth = !0, this._colorGradingBGR = !0, this._exposure = 1, this._toneMappingEnabled = !1, this._toneMappingType = e.TONEMAPPING_STANDARD, this._contrast = 1, this.vignetteStretch = 0, this.vignetteCenterX = 0, this.vignetteCenterY = 0, this.vignetteWeight = 1.5, this.vignetteColor = new x(0, 0, 0, 0), this.vignetteCameraFov = .5, this._vignetteBlendMode = e.VIGNETTEMODE_MULTIPLY, this._vignetteEnabled = !1, this._ditheringEnabled = !1, this._ditheringIntensity = 1 / 255, this._skipFinalColorClamp = !1, this._applyByPostProcess = !1, this._isEnabled = !0, this.outputTextureWidth = 0, this.outputTextureHeight = 0, this.onUpdateParameters = new t();
	}
	...
	prepareDefines(t, n = !1) {
		if (n !== this.applyByPostProcess || !this._isEnabled) {
			t.VIGNETTE = !1, t.TONEMAPPING = 0, t.CONTRAST = !1, t.EXPOSURE = !1, t.COLORCURVES = !1, t.COLORGRADING = !1, t.COLORGRADING3D = !1, t.DITHER = !1, t.IMAGEPROCESSING = !1, t.SKIPFINALCOLORCLAMP = this.skipFinalColorClamp, t.IMAGEPROCESSINGPOSTPROCESS = this.applyByPostProcess && this._isEnabled;
			return;
		}
		if (t.VIGNETTE = this.vignetteEnabled, t.VIGNETTEBLENDMODEMULTIPLY = this.vignetteBlendMode === e._VIGNETTEMODE_MULTIPLY, t.VIGNETTEBLENDMODEOPAQUE = !t.VIGNETTEBLENDMODEMULTIPLY, !this._toneMappingEnabled) t.TONEMAPPING = 0;
			...
			case e.TONEMAPPING_ACES:
				t.TONEMAPPING = 2;
				break;
			default: t.TONEMAPPING = 1;
		}
		t.CONTRAST = this.contrast !== 1, t.EXPOSURE = this.exposure !== 1, t.COLORCURVES = this.colorCurvesEnabled && !!this.colorCurves, t.COLORGRADING = this.colorGradingEnabled && !!this.colorGradingTexture, t.COLORGRADING3D = t.COLORGRADING ? this.colorGradingTexture.is3D : !1, t.SAMPLER3DGREENDEPTH = this.colorGradingWithGreenDepth, t.SAMPLER3DBGRMAP = this.colorGradingBGR, t.DITHER = this._ditheringEnabled, t.IMAGEPROCESSINGPOSTPROCESS = this.applyByPostProcess, t.SKIPFINALCOLORCLAMP = this.skipFinalColorClamp, t.IMAGEPROCESSING = t.VIGNETTE || !!t.TONEMAPPING || t.CONTRAST || t.EXPOSURE || t.COLORCURVES || t.COLORGRADING || t.DITHER;
	}
	isReady() {
		return !this.colorGradingEnabled || !this.colorGradingTexture || this.colorGradingTexture.isReady();
	}
	bind(e, t) {
		if (this._colorCurvesEnabled && this.colorCurves && E.Bind(this.colorCurves, e), this._vignetteEnabled || this._ditheringEnabled) {
			let n = 1 / (this.outputTextureWidth || e.getEngine().getRenderWidth()), r = 1 / (this.outputTextureHeight || e.getEngine().getRenderHeight());
			if (e.setFloat2("vInverseScreenSize", n, r), this._ditheringEnabled && e.setFloat("ditherIntensity", .5 * this._ditheringIntensity), this._vignetteEnabled) {
				let i = t ?? r / n, a = Math.tan(this.vignetteCameraFov * .5), o = a * i, c = Math.sqrt(o * a);
				o = s(o, c, this.vignetteStretch), a = s(a, c, this.vignetteStretch), e.setFloat4("vignetteSettings1", o, a, -o * this.vignetteCenterX, -a * this.vignetteCenterY);
	...
	static Parse(t) {
		let n = b.Parse(() => new e(), t, null, null);
		return t.vignetteCentreX !== void 0 && (n.vignetteCenterX = t.vignetteCentreX), t.vignetteCentreY !== void 0 && (n.vignetteCenterY = t.vignetteCentreY), n;
	}
...
D.TONEMAPPING_STANDARD = 0, D.TONEMAPPING_ACES = 1, D.TONEMAPPING_KHR_PBR_NEUTRAL = 2, D.PrepareUniforms = _e, D.PrepareSamplers = ve, D._VIGNETTEMODE_MULTIPLY = 0, D._VIGNETTEMODE_OPAQUE = 1, C([de()], D.prototype, "colorCurves", void 0), C([w()], D.prototype, "_colorCurvesEnabled", void 0), C([ue("colorGradingTexture")], D.prototype, "_colorGradingTexture", void 0), C([w()], D.prototype, "_colorGradingEnabled", void 0), C([w()], D.prototype, "_colorGradingWithGreenDepth", void 0), C([w()], D.prototype, "_colorGradingBGR", void 0), C([w()], D.prototype, "_exposure", void 0), C([w()], D.prototype, "_toneMappingEnabled", void 0), C([w()], D.prototype, "_toneMappingType", void 0), C([w()], D.prototype, "_contrast", void 0), C([w()], D.prototype, "vignetteStretch", void 0), C([w()], D.prototype, "vignetteCenterX", void 0), C([w()], D.prototype, "vignetteCenterY", void 0), C([w()], D.prototype, "vignetteWeight", void 0), C([le()], D.prototype, "vignetteColor", void 0), C([w()], D.prototype, "vignetteCameraFov", void 0), C([w()], D.prototype, "_vignetteBlendMode", void 0), C([w()], D.prototype, "_vignetteEnabled", void 0), C([w()], D.prototype, "_ditheringEnabled", void 0), C([w()], D.prototype, "_ditheringIntensity", void 0), C([w()], D.prototype, "_skipFinalColorClamp", void 0), C([w()], D.prototype, "_applyByPostProcess", void 0), C([w()], D.prototype, "_isEnabled", void 0), C([w()], D.prototype, "outputTextureWidth", void 0), C([w()], D.prototype, "outputTextureHeight", void 0), b._ImageProcessingConfigurationParser = D.Parse, oe("BABYLON.ImageProcessingConfiguration", D);
//#endregion
...
var O = class {
	...
	getNormal(e = !1, t = !0) {
		if (!this.pickedMesh || t && !this.pickedMesh.isVerticesDataPresent(S.NormalKind)) return null;
		let n = this.pickedMesh.getIndices();
		n?.length === 0 && (n = null);
		let r, i = _.Vector3[0], a = _.Vector3[1], o = _.Vector3[2];
		if (t) {
			let e = this.pickedMesh.getVerticesData(S.NormalKind), t = n ? m.FromArrayToRef(e, n[this.faceId * 3] * 3, i) : i.copyFromFloats(e[this.faceId * 3 * 3], e[this.faceId * 3 * 3 + 1], e[this.faceId * 3 * 3 + 2]), s = n ? m.FromArrayToRef(e, n[this.faceId * 3 + 1] * 3, a) : a.copyFromFloats(e[(this.faceId * 3 + 1) * 3], e[(this.faceId * 3 + 1) * 3 + 1], e[(this.faceId * 3 + 1) * 3 + 2]), c = n ? m.FromArrayToRef(e, n[this.faceId * 3 + 2] * 3, o) : o.copyFromFloats(e[(this.faceId * 3 + 2) * 3], e[(this.faceId * 3 + 2) * 3 + 1], e[(this.faceId * 3 + 2) * 3 + 2]);
			t = t.scale(this.bu), s = s.scale(this.bv), c = c.scale(1 - this.bu - this.bv), r = new m(t.x + s.x + c.x, t.y + s.y + c.y, t.z + s.z + c.z);
		} else {
			let e = this.pickedMesh.getVerticesData(S.PositionKind), t = n ? m.FromArrayToRef(e, n[this.faceId * 3] * 3, i) : i.copyFromFloats(e[this.faceId * 3 * 3], e[this.faceId * 3 * 3 + 1], e[this.faceId * 3 * 3 + 2]), s = n ? m.FromArrayToRef(e, n[this.faceId * 3 + 1] * 3, a) : a.copyFromFloats(e[(this.faceId * 3 + 1) * 3], e[(this.faceId * 3 + 1) * 3 + 1], e[(this.faceId * 3 + 1) * 3 + 2]), c = n ? m.FromArrayToRef(e, n[this.faceId * 3 + 2] * 3, o) : o.copyFromFloats(e[(this.faceId * 3 + 2) * 3], e[(this.faceId * 3 + 2) * 3 + 1], e[(this.faceId * 3 + 2) * 3 + 2]), l = t.subtract(s), u = c.subtract(s);
			r = m.Cross(l, u);
		}
		let s = (e, t) => {
			if (this.thinInstanceIndex !== -1) {
				let n = e.thinInstanceGetWorldMatrices()[this.thinInstanceIndex];
				n && m.TransformNormalToRef(t, n, t);
			}
			let n = e.getWorldMatrix();
			e.nonUniformScaling && (_.Matrix[0].copyFrom(n), n = _.Matrix[0], n.setTranslationFromFloats(0, 0, 0), n.invert(), n.transposeToRef(_.Matrix[1]), n = _.Matrix[1]), m.TransformNormalToRef(t, n, t);
		};
		if (e && s(this.pickedMesh, r), this.ray) {
			let t = _.Vector3[0].copyFrom(r);
			e || s(this.pickedMesh, t), m.Dot(t, this.ray.direction) > 0 && r.negateInPlace();
		}
		return r.normalize(), r;
	}
	getTextureCoordinates(e = S.UVKind) {
		...
		if (!n) return null;
		let r = g.FromArray(n, t[this.faceId * 3] * 2), i = g.FromArray(n, t[this.faceId * 3 + 1] * 2), a = g.FromArray(n, t[this.faceId * 3 + 2] * 2);
		return r = r.scale(this.bu), i = i.scale(this.bv), a = a.scale(1 - this.bu - this.bv), new g(r.x + i.x + a.x, r.y + i.y + a.y);
	}
}, k = class e {
...
function ye(e, t, n) {
	return v(t, j), P(e, j, M), v(M, n), n;
}
function F(e, t, n) {
	if (!N.eyeAtCamera) return ye(e, t, n);
	let r = n.asArray(), i = t.asArray();
	for (let e = 0; e < 16; e++) r[e] = i[e];
	return r[12] = 0, r[13] = 0, r[14] = 0, n.markAsUpdated(), n;
}
function I(e, t, n, r) {
	return h(F(e, t, r), n, r), r;
}
function be(e, t, n, r) {
	return v(n, j), h(t, j, M), P(e, M, j), F(e, n, M), h(j, M, r), r;
}
function xe(e, t, n, r, i, a) {
	return v(n, j), h(t, j, M), P(e, M, j), I(e, r, i, M), h(j, M, a), a;
}
function L(e, t) {
	let n = N.getScene();
	if (!n || A === t) return t;
	A.updateFlag = t.updateFlag;
	let r = n.floatingOriginOffset;
	switch (e) {
		case "world": return P(r, t, A);
		case "view": return F(r, t, A);
		case "worldView": return be(r, t, n.getViewMatrix(), A);
		case "viewProjection": return I(r, n.getViewMatrix(), n.getProjectionMatrix(), A);
		case "worldViewProjection": return xe(r, t, n.getTransformMatrix(), n.getViewMatrix(), n.getProjectionMatrix(), A);
		default:
			if (e.startsWith("u_")) {
				let i = e.toLowerCase();
				if (i.startsWith("u_worldviewprojection")) return xe(r, t, n.getTransformMatrix(), n.getViewMatrix(), n.getProjectionMatrix(), A);
				if (i.startsWith("u_viewprojection")) return I(r, n.getViewMatrix(), n.getProjectionMatrix(), A);
				if (i.startsWith("u_worldview")) return be(r, t, n.getViewMatrix(), A);
				if (i.startsWith("u_world")) return P(r, t, A);
				if (i.startsWith("u_view")) return F(r, t, A);
			}
			return t;
	}
}
var R = f, z = a, Se = R.prototype._updateMatrixForUniform, Ce = a.prototype.setMatrix;
function we() {
	a.prototype.setMatrix = Ce, z._setMatrixOverride = void 0, R.prototype._updateMatrixForUniform = Se, R.prototype._updateMatrixForUniformOverride = void 0;
}
function Te() {
	z.prototype._setMatrixOverride = Ce, z.prototype.setMatrix = function(e, t) {
		return this._setMatrixOverride(e, L(e, t)), this;
	}, R.prototype._updateMatrixForUniformOverride = Se, R.prototype._updateMatrixForUniform = function(e, t) {
		this._updateMatrixForUniformOverride(e, L(e, t));
	};
}
//#endregion
//#region node_modules/@babylonjs/core/sceneComponent.js
var B = class {};
B.NAME_EFFECTLAYER = "EffectLayer", B.NAME_LAYER = "Layer", B.NAME_LENSFLARESYSTEM = "LensFlareSystem", B.NAME_BOUNDINGBOXRENDERER = "BoundingBoxRenderer", B.NAME_PARTICLESYSTEM = "ParticleSystem", B.NAME_GAMEPAD = "Gamepad", B.NAME_SIMPLIFICATIONQUEUE = "SimplificationQueue", B.NAME_GEOMETRYBUFFERRENDERER = "GeometryBufferRenderer", B.NAME_PREPASSRENDERER = "PrePassRenderer", B.NAME_DEPTHRENDERER = "DepthRenderer", B.NAME_DEPTHPEELINGRENDERER = "DepthPeelingRenderer", B.NAME_POSTPROCESSRENDERPIPELINEMANAGER = "PostProcessRenderPipelineManager", B.NAME_SPRITE = "Sprite", B.NAME_SUBSURFACE = "SubSurface", B.NAME_OUTLINERENDERER = "Outline", B.NAME_PROCEDURALTEXTURE = "ProceduralTexture", B.NAME_SHADOWGENERATOR = "ShadowGenerator", B.NAME_OCTREE = "Octree", B.NAME_PHYSICSENGINE = "PhysicsEngine", B.NAME_AUDIO = "Audio", B.NAME_FLUIDRENDERER = "FluidRenderer", B.NAME_IBLCDFGENERATOR = "iblCDFGenerator", B.NAME_CLUSTEREDLIGHTING = "ClusteredLighting", B.STEP_ISREADYFORMESH_EFFECTLAYER = 0, B.STEP_BEFOREEVALUATEACTIVEMESH_BOUNDINGBOXRENDERER = 0, B.STEP_EVALUATESUBMESH_BOUNDINGBOXRENDERER = 0, B.STEP_PREACTIVEMESH_BOUNDINGBOXRENDERER = 0, B.STEP_CAMERADRAWRENDERTARGET_EFFECTLAYER = 1, B.STEP_BEFORECAMERADRAW_PREPASS = 0, B.STEP_BEFORECAMERADRAW_EFFECTLAYER = 1, B.STEP_BEFORECAMERADRAW_LAYER = 2, B.STEP_BEFORERENDERTARGETDRAW_PREPASS = 0, B.STEP_BEFORERENDERTARGETDRAW_LAYER = 1, B.STEP_BEFORERENDERINGMESH_PREPASS = 0, B.STEP_BEFORERENDERINGMESH_OUTLINE = 1, B.STEP_AFTERRENDERINGMESH_PREPASS = 0, B.STEP_AFTERRENDERINGMESH_OUTLINE = 1, B.STEP_AFTERRENDERINGGROUPDRAW_EFFECTLAYER_DRAW = 0, B.STEP_AFTERRENDERINGGROUPDRAW_BOUNDINGBOXRENDERER = 1, B.STEP_BEFORECAMERAUPDATE_SIMPLIFICATIONQUEUE = 0, B.STEP_BEFORECLEAR_PROCEDURALTEXTURE = 0, B.STEP_BEFORECLEAR_PREPASS = 1, B.STEP_BEFORERENDERTARGETCLEAR_PREPASS = 0, B.STEP_AFTERRENDERTARGETDRAW_PREPASS = 0, B.STEP_AFTERRENDERTARGETDRAW_LAYER = 1, B.STEP_AFTERCAMERADRAW_PREPASS = 0, B.STEP_AFTERCAMERADRAW_EFFECTLAYER = 1, B.STEP_AFTERCAMERADRAW_LENSFLARESYSTEM = 2, B.STEP_AFTERCAMERADRAW_EFFECTLAYER_DRAW = 3, B.STEP_AFTERCAMERADRAW_LAYER = 4, B.STEP_AFTERCAMERADRAW_FLUIDRENDERER = 5, B.STEP_AFTERCAMERAPOSTPROCESS_LAYER = 0, B.STEP_AFTERRENDERTARGETPOSTPROCESS_LAYER = 0, B.STEP_AFTERRENDER_AUDIO = 0, B.STEP_GATHERRENDERTARGETS_DEPTHRENDERER = 0, B.STEP_GATHERRENDERTARGETS_GEOMETRYBUFFERRENDERER = 1, B.STEP_GATHERRENDERTARGETS_SHADOWGENERATOR = 2, B.STEP_GATHERRENDERTARGETS_POSTPROCESSRENDERPIPELINEMANAGER = 3, B.STEP_GATHERACTIVECAMERARENDERTARGETS_DEPTHRENDERER = 0, B.STEP_GATHERACTIVECAMERARENDERTARGETS_FLUIDRENDERER = 1, B.STEP_GATHERACTIVECAMERARENDERTARGETS_CLUSTEREDLIGHTING = 2, B.STEP_POINTERMOVE_SPRITE = 0, B.STEP_POINTERDOWN_SPRITE = 0, B.STEP_POINTERUP_SPRITE = 0;
var V = class e extends Array {
	constructor(e) {
		super(...e);
	}
	static Create() {
...
H.POINTERDOWN = 1, H.POINTERUP = 2, H.POINTERMOVE = 4, H.POINTERWHEEL = 8, H.POINTERPICK = 16, H.POINTERTAP = 32, H.POINTERDOUBLETAP = 64;
var Ee = class {
	constructor(e, t) {
	...
	constructor(e, t, n, r) {
		super(e, t), this.ray = null, this.originalPickingInfo = null, this.skipOnPointerObservable = !1, this.localPosition = new g(n, r);
	}
}, U = class extends Ee {
	get pickInfo() {
...
var X = class {};
X.DOM_DELTA_PIXEL = 0, X.DOM_DELTA_LINE = 1, X.DOM_DELTA_PAGE = 2;
//#endregion
//#region node_modules/@babylonjs/core/DeviceInput/eventFactory.js
var Z = class {
	static CreateDeviceEvent(e, t, n, r, i, a, o) {
		switch (e) {
			case J.Keyboard: return this._CreateKeyboardEvent(n, r, i, a);
			case J.Mouse: if (n === Y.MouseWheelX || n === Y.MouseWheelY || n === Y.MouseWheelZ) return this._CreateWheelEvent(e, t, n, r, i, a);
			case J.Touch: return this._CreatePointerEvent(e, t, n, r, i, a, o);
			default: throw `Unable to generate event for device ${J[e]}`;
		}
	}
	static _CreatePointerEvent(e, t, n, r, i, a, o) {
		let s = this._CreateMouseEvent(e, t, n, r, i, a);
		e === J.Mouse ? (s.deviceType = J.Mouse, s.pointerId = 1, s.pointerType = "mouse") : (s.deviceType = J.Touch, s.pointerId = o ?? t, s.pointerType = "touch");
		let c = 0;
		return c += i.pollInput(e, t, Y.LeftClick), c += i.pollInput(e, t, Y.RightClick) * 2, c += i.pollInput(e, t, Y.MiddleClick) * 4, s.buttons = c, n === Y.Move ? s.type = "pointermove" : n >= Y.LeftClick && n <= Y.RightClick && (s.type = r === 1 ? "pointerdown" : "pointerup", s.button = n - 2), s;
	}
	static _CreateWheelEvent(e, t, n, r, i, a) {
		let o = this._CreateMouseEvent(e, t, n, r, i, a);
		switch (o.pointerId = 1, o.type = "wheel", o.deltaMode = X.DOM_DELTA_PIXEL, o.deltaX = 0, o.deltaY = 0, o.deltaZ = 0, n) {
			case Y.MouseWheelX:
				o.deltaX = r;
				break;
			case Y.MouseWheelY:
				o.deltaY = r;
				break;
			case Y.MouseWheelZ: o.deltaZ = r;
		}
		return o;
	}
	static _CreateMouseEvent(e, t, n, r, i, a) {
		let o = this._CreateEvent(a), s = i.pollInput(e, t, Y.Horizontal), c = i.pollInput(e, t, Y.Vertical);
	...
	static _CreateKeyboardEvent(e, t, n, r) {
		...
		return this._CheckNonCharacterKeys(i, n), i.deviceType = J.Keyboard, i.deviceSlot = 0, i.inputIndex = e, i.type = t === 1 ? "keydown" : "keyup", i.key = String.fromCharCode(e), i.keyCode = e, i;
	}
	static _CheckNonCharacterKeys(e, t) {
		let n = t.isDeviceAvailable(J.Keyboard), r = n && t.pollInput(J.Keyboard, 0, 18) === 1, i = n && t.pollInput(J.Keyboard, 0, 17) === 1, a = n && (t.pollInput(J.Keyboard, 0, 91) === 1 || t.pollInput(J.Keyboard, 0, 92) === 1 || t.pollInput(J.Keyboard, 0, 93) === 1), o = n && t.pollInput(J.Keyboard, 0, 16) === 1;
	...
	constructor(e, t, n) {
		this._nativeInput = _native.DeviceInputSystem ? new _native.DeviceInputSystem(e, t, (e, t, r, i) => {
			n(e, t, Z.CreateDeviceEvent(e, t, r, i, this));
...
}, Fe = 255, Ie = Object.keys(Y).length / 2, Le = class {
	constructor(e, t, r, i) {
		this._inputs = [], this._keyboardActive = !1, this._pointerActive = !1, this._usingSafari = T.IsSafari(), this._usingMacOs = n() && /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform), this._keyboardDownEvent = (e) => {}, this._keyboardUpEvent = (e) => {}, this._keyboardBlurEvent = (e) => {}, this._pointerMoveEvent = (e) => {}, this._pointerDownEvent = (e) => {}, this._pointerUpEvent = (e) => {}, this._pointerCancelEvent = (e) => {}, this._pointerCancelTouch = (e) => {}, this._pointerLeaveEvent = (e) => {}, this._pointerWheelEvent = (e) => {}, this._pointerBlurEvent = (e) => {}, this._pointerMacOsChromeOutEvent = (e) => {}, this._eventsAttached = !1, this._mouseId = -1, this._isUsingFirefox = n() && navigator.userAgent && navigator.userAgent.indexOf("Firefox") !== -1, this._isUsingChromium = n() && navigator.userAgent && navigator.userAgent.indexOf("Chrome") !== -1, this._maxTouchPoints = 0, this._pointerInputClearObserver = null, this._gamepadConnectedEvent = (e) => {}, this._gamepadDisconnectedEvent = (e) => {}, this._eventPrefix = T.GetPointerPrefix(e), this._engine = e, this._onDeviceConnected = t, this._onDeviceDisconnected = r, this._onInputChanged = i, this._mouseId = +!this._isUsingFirefox, this._enableEvents(), this._usingMacOs && (this._metaKeys = []), this._engine._onEngineViewChanged || (this._engine._onEngineViewChanged = () => {
			this._enableEvents();
		});
	}
	pollInput(e, t, n) {
		let r = this._inputs[e][t];
		if (!r) throw `Unable to find device ${J[e]}`;
		e >= J.DualShock && e <= J.DualSense && this._updateDevice(e, t, n);
		let i = r[n];
		if (i === void 0) throw `Unable to find input ${n} for device ${J[e]} in slot ${t}`;
		return n === Y.Move && T.Warn("Unable to provide information for PointerInput.Move.  Try using PointerInput.Horizontal or PointerInput.Vertical for move data."), i;
	}
	isDeviceAvailable(e) {
	...
	_checkForConnectedDevices() {
		...
		typeof matchMedia == "function" && matchMedia("(pointer:fine)").matches && this._addPointerDevice(J.Mouse, 0, 0, 0);
	}
	_addGamePad(e) {
	...
	_addPointerDevice(e, t, n, r) {
		this._pointerActive ||= !0, this._registerDevice(e, t, Ie);
		let i = this._inputs[e][t];
		i[0] = n, i[1] = r;
	}
	_registerDevice(e, t, n) {
		if (t === void 0) throw `Unable to register device ${J[e]} to undefined slot.`;
	...
	_handleKeyActions() {
		this._keyboardDownEvent = (e) => {
			this._keyboardActive || (this._keyboardActive = !0, this._registerDevice(J.Keyboard, 0, Fe));
			let t = this._inputs[J.Keyboard][0];
			if (t) {
				t[e.keyCode] = 1;
				let n = e;
				n.inputIndex = e.keyCode, this._usingMacOs && e.metaKey && e.key !== "Meta" && (this._metaKeys.includes(e.keyCode) || this._metaKeys.push(e.keyCode)), this._onInputChanged(J.Keyboard, 0, n);
			}
			...
			if (t) {
				...
				if (n.inputIndex = e.keyCode, this._usingMacOs && e.key === "Meta" && this._metaKeys.length > 0) {
					for (let e of this._metaKeys) {
						let n = Z.CreateDeviceEvent(J.Keyboard, 0, e, 0, this, this._elementToAttachTo);
						t[e] = 0, this._onInputChanged(J.Keyboard, 0, n);
					}
					this._metaKeys.splice(0, this._metaKeys.length);
				}
				this._onInputChanged(J.Keyboard, 0, n);
			}
		}, this._keyboardBlurEvent = () => {
			if (this._keyboardActive) {
				let e = this._inputs[J.Keyboard][0];
				for (let t = 0; t < e.length; t++) if (e[t] !== 0) {
					e[t] = 0;
					let n = Z.CreateDeviceEvent(J.Keyboard, 0, t, 0, this, this._elementToAttachTo);
					this._onInputChanged(J.Keyboard, 0, n);
				}
	...
	_handlePointerActions() {
		this._maxTouchPoints = n() && navigator.maxTouchPoints || 2, this._activeTouchIds ||= Array(this._maxTouchPoints);
		for (let e = 0; e < this._maxTouchPoints; e++) this._activeTouchIds[e] = -1;
		this._pointerMoveEvent = (e) => {
			let t = this._getPointerType(e), n = t === J.Mouse ? 0 : this._activeTouchIds.indexOf(e.pointerId);
			if (t === J.Touch && n === -1) {
				let r = this._activeTouchIds.indexOf(-1);
				if (r >= 0) n = r, this._activeTouchIds[r] = e.pointerId, this._onDeviceConnected(t, n);
				else {
					T.Warn(`Max number of touches exceeded.  Ignoring touches in excess of ${this._maxTouchPoints}`);
					return;
				}
			}
			...
			if (r) {
				let i = e;
				i.inputIndex = Y.Move, r[Y.Horizontal] = e.clientX, r[Y.Vertical] = e.clientY, t === J.Touch && r[Y.LeftClick] === 0 && (r[Y.LeftClick] = 1), e.pointerId === void 0 && (e.pointerId = this._mouseId), this._onInputChanged(t, n, i), !this._usingSafari && e.button !== -1 && (i.inputIndex = e.button + 2, r[e.button + 2] = +!r[e.button + 2], this._onInputChanged(t, n, i));
			}
		}, this._pointerDownEvent = (e) => {
			let t = this._getPointerType(e), n = t === J.Mouse ? 0 : e.pointerId;
			if (t === J.Touch) {
			...
			this._inputs[t] || (this._inputs[t] = {}), this._inputs[t][n] ? t === J.Touch && this._onDeviceConnected(t, n) : this._addPointerDevice(t, n, e.clientX, e.clientY);
			let r = this._inputs[t][n];
			if (r) {
				let i = r[Y.Horizontal], a = r[Y.Vertical];
				if (t === J.Mouse) {
				...
				r[Y.Horizontal] = e.clientX, r[Y.Vertical] = e.clientY, r[e.button + 2] = 1;
				let o = e;
				o.inputIndex = e.button + 2, this._onInputChanged(t, n, o), (i !== e.clientX || a !== e.clientY) && (o.inputIndex = Y.Move, this._onInputChanged(t, n, o));
			}
			...
			if (!a && this._isUsingFirefox && this._usingMacOs && r && (i = i === 2 ? 0 : 2, a = r[i + 2] !== 0), a) {
				let a = r[Y.Horizontal], o = r[Y.Vertical];
				r[Y.Horizontal] = e.clientX, r[Y.Vertical] = e.clientY, r[i + 2] = 0;
				let s = e;
				e.pointerId === void 0 && (e.pointerId = this._mouseId), (a !== e.clientX || o !== e.clientY) && (s.inputIndex = Y.Move, this._onInputChanged(t, n, s)), s.inputIndex = i + 2, t === J.Mouse && this._mouseId >= 0 && this._elementToAttachTo.hasPointerCapture?.(this._mouseId) ? this._elementToAttachTo.releasePointerCapture(this._mouseId) : e.pointerId && this._elementToAttachTo.hasPointerCapture?.(e.pointerId) && this._elementToAttachTo.releasePointerCapture(e.pointerId), this._onInputChanged(t, n, s), t === J.Touch && this._onDeviceDisconnected(t, n);
			}
		}, this._pointerCancelTouch = (e) => {
			let t = this._activeTouchIds.indexOf(e);
			if (t === -1) return;
			this._elementToAttachTo.hasPointerCapture?.(e) && this._elementToAttachTo.releasePointerCapture(e), this._inputs[J.Touch][t][Y.LeftClick] = 0;
			let n = Z.CreateDeviceEvent(J.Touch, t, Y.LeftClick, 0, this, this._elementToAttachTo, e);
			this._onInputChanged(J.Touch, t, n), this._activeTouchIds[t] = -1, this._onDeviceDisconnected(J.Touch, t);
		}, this._pointerCancelEvent = (e) => {
			if (e.pointerType === "mouse") {
				let e = this._inputs[J.Mouse][0];
				...
				for (let t = Y.LeftClick; t <= Y.BrowserForward; t++) if (e[t] === 1) {
					e[t] = 0;
					let n = Z.CreateDeviceEvent(J.Mouse, 0, t, 0, this, this._elementToAttachTo);
					this._onInputChanged(J.Mouse, 0, n);
				}
		...
		this._pointerBlurEvent = () => {
			if (this.isDeviceAvailable(J.Mouse)) {
				let e = this._inputs[J.Mouse][0];
				this._mouseId >= 0 && this._elementToAttachTo.hasPointerCapture?.(this._mouseId) && this._elementToAttachTo.releasePointerCapture(this._mouseId);
				for (let t = Y.LeftClick; t <= Y.BrowserForward; t++) if (e[t] === 1) {
					e[t] = 0;
			...
			if (this.isDeviceAvailable(J.Touch)) {
				let e = this._inputs[J.Touch];
				for (let t = 0; t < this._activeTouchIds.length; t++) {
					let n = this._activeTouchIds[t];
					if (this._elementToAttachTo.hasPointerCapture?.(n) && this._elementToAttachTo.releasePointerCapture(n), n !== -1 && e[t]?.[Y.LeftClick] === 1) {
						e[t][Y.LeftClick] = 0;
						let r = Z.CreateDeviceEvent(J.Touch, t, Y.LeftClick, 0, this, this._elementToAttachTo, n);
						this._onInputChanged(J.Touch, t, r), this._activeTouchIds[t] = -1, this._onDeviceDisconnected(J.Touch, t);
					}
				}
			}
		}, this._pointerWheelEvent = (e) => {
			let t = J.Mouse;
			this._inputs[t] || (this._inputs[t] = []), this._inputs[t][0] || (this._pointerActive = !0, this._registerDevice(t, 0, Ie));
			let n = this._inputs[t][0];
			if (n) {
				n[Y.MouseWheelX] = e.deltaX || 0, n[Y.MouseWheelY] = e.deltaY || e.wheelDelta || 0, n[Y.MouseWheelZ] = e.deltaZ || 0;
				let r = e;
				e.pointerId === void 0 && (e.pointerId = this._mouseId), n[Y.MouseWheelX] !== 0 && (r.inputIndex = Y.MouseWheelX, this._onInputChanged(t, 0, r)), n[Y.MouseWheelY] !== 0 && (r.inputIndex = Y.MouseWheelY, this._onInputChanged(t, 0, r)), n[Y.MouseWheelZ] !== 0 && (r.inputIndex = Y.MouseWheelZ, this._onInputChanged(t, 0, r));
			}
			...
			if (this.isDeviceAvailable(J.Mouse)) {
				let e = this._inputs[J.Mouse][0];
				e[Y.MouseWheelX] = 0, e[Y.MouseWheelY] = 0, e[Y.MouseWheelZ] = 0;
			}
		});
	}
	...
	_updateDevice(e, t, n) {
		...
		if (r && e === this._gamepads[t]) {
			let i = this._inputs[e][t];
			i[n] = n >= r.buttons.length ? r.axes[n - r.buttons.length].valueOf() : r.buttons[n].value;
		}
	}
	_getGamepadDeviceType(e) {
		return e.indexOf("054c") === -1 ? e.indexOf("Xbox One") !== -1 || e.search("Xbox 360") !== -1 || e.search("xinput") !== -1 ? J.Xbox : e.indexOf("057e") === -1 ? J.Generic : J.Switch : e.indexOf("0ce6") === -1 ? J.DualShock : J.DualSense;
	}
	_getPointerType(e) {
		let t = J.Mouse;
		return (e.pointerType === "touch" || e.pointerType === "pen" || e.touches) && (t = J.Touch), t;
	}
}, Re = class {
	constructor(e, n, r = 0) {
		this.deviceType = n, this.deviceSlot = r, this.onInputChangedObservable = new t(), this._deviceInputSystem = e;
	}
	getInput(e) {
	...
	constructor(e) {
		this._registeredManagers = [], this._refCount = 0, this.registerManager = (e) => {
			for (let t = 0; t < this._devices.length; t++) {
				...
				for (let r in n) {
					let n = +r;
					e._addDevice(new Re(this._deviceInputSystem, t, n));
				}
			}
		...
		let n = (e, t) => {
			...
			for (let n of this._registeredManagers) {
				let r = new Re(this._deviceInputSystem, e, t);
				n._addDevice(r);
			}
		}, r = (e, t) => {
		...
		this._deviceInputSystem = typeof _native < "u" ? new Pe(n, r, i) : new Le(e, n, r, i);
	}
	dispose() {
	...
	constructor(e) {
		let n = Object.keys(J).length / 2;
		this._devices = Array(n), this._firstDevice = Array(n), this._engine = e, this._engine._deviceSourceManager || (this._engine._deviceSourceManager = new ze(e)), this._engine._deviceSourceManager._refCount++, this.onDeviceConnectedObservable = new t((e) => {
			for (let t of this._devices) if (t) for (let n of t) n && this.onDeviceConnectedObservable.notifyObserver(e, n);
		}), this.onDeviceDisconnectedObservable = new t(), this._engine._deviceSourceManager.registerManager(this), this._onDisposeObserver = e.onDisposeObservable.add(() => {
			this.dispose();
		});
	}
	dispose() {
...
var He = class {
	...
	constructor(t) {
		this._alreadyAttached = !1, this._meshPickProceed = !1, this._currentPickResult = null, this._previousPickResult = null, this._activePointerIds = [], this._activePointerIdsCount = 0, this._doubleClickOccured = !1, this._isSwiping = !1, this._swipeButtonPressed = -1, this._skipPointerTap = !1, this._isMultiTouchGesture = !1, this._pointerX = 0, this._pointerY = 0, this._startingPointerPosition = new g(0, 0), this._previousStartingPointerPosition = new g(0, 0), this._startingPointerTime = 0, this._previousStartingPointerTime = 0, this._pointerCaptures = {}, this._meshUnderPointerId = {}, this._movePointerInfo = null, this._cameraObserverCount = 0, this._delayedClicks = [
			null,
			null,
			null,
			null,
			null
		], this._deviceSourceManager = null, this._scene = t || e.LastCreatedScene, this._scene;
	}
	...
	get unTranslatedPointer() {
		return new g(this._unTranslatedPointerX, this._unTranslatedPointerY);
	}
	get pointerX() {
	...
	_processPointerMove(e, t) {
		...
		let a = t.inputIndex >= Y.MouseWheelX && t.inputIndex <= Y.MouseWheelZ ? H.POINTERWHEEL : H.POINTERMOVE;
		n.onPointerMove && (e ||= this._pickMove(t), n.onPointerMove(t, e, a));
		let o;
		e ? (o = new U(a, t, e), this._setRayOnPointerInfo(e, t)) : (o = new U(a, t, null, this), this._movePointerInfo = o), n.onPointerObservable.hasObservers() && n.onPointerObservable.notifyObservers(o, a);
	}
	_setRayOnPointerInfo(e, t) {
		let n = this._scene;
		e && Ve._IsPickingAvailable && (e.ray ||= n.createPickingRay(t.offsetX, t.offsetY, y.Identity(), n.activeCamera));
	}
	...
	_checkPrePointerObservable(e, t, n) {
		let r = this._scene, i = new De(n, t, this._unTranslatedPointerX, this._unTranslatedPointerY);
	...
	simulatePointerMove(e, t) {
		...
		n.inputIndex = Y.Move, !this._checkPrePointerObservable(e, n, H.POINTERMOVE) && this._processPointerMove(e, n);
	}
	simulatePointerDown(e, t) {
		let n = new PointerEvent("pointerdown", t);
		n.inputIndex = n.button + 2, !this._checkPrePointerObservable(e, n, H.POINTERDOWN) && this._processPointerDown(e, n);
	}
	_processPointerDown(e, n) {
		let r = this._scene;
		if (e?.pickedMesh) {
			this._pickedDownMesh = e.pickedMesh;
			let i = e.pickedMesh._getActionManagerForTrigger();
			if (i) {
				if (i.hasPickTriggers) switch (i.processTrigger(5, new k(e.pickedMesh, r.pointerX, r.pointerY, e.pickedMesh, n, e)), n.button) {
					case 0:
						i.processTrigger(2, new k(e.pickedMesh, r.pointerX, r.pointerY, e.pickedMesh, n, e));
						break;
					case 1:
						i.processTrigger(4, new k(e.pickedMesh, r.pointerX, r.pointerY, e.pickedMesh, n, e));
						break;
					case 2: i.processTrigger(3, new k(e.pickedMesh, r.pointerX, r.pointerY, e.pickedMesh, n, e));
				}
				i.hasSpecificTrigger(8) && window.setTimeout(() => {
					let e = r.pick(this._unTranslatedPointerX, this._unTranslatedPointerY, (e) => e.isPickable && e.isVisible && e.isReady() && e.actionManager && e.actionManager.hasSpecificTrigger(8) && e === this._pickedDownMesh, !1, r.cameraToUseForPointers);
					e?.pickedMesh && i && this._activePointerIdsCount !== 0 && Date.now() - this._startingPointerTime > t.LongPressDelay && !this._isPointerSwiping() && (this._startingPointerTime = 0, i.processTrigger(8, k.CreateNew(e.pickedMesh, n)));
				}, t.LongPressDelay);
			}
		} else for (let t of r._pointerDownStage) e = t.action(this._unTranslatedPointerX, this._unTranslatedPointerY, e, n, !1);
		let i, a = H.POINTERDOWN;
		e ? (r.onPointerDown && r.onPointerDown(n, e, a), i = new U(a, n, e), this._setRayOnPointerInfo(e, n)) : i = new U(a, n, null, this), r.onPointerObservable.hasObservers() && r.onPointerObservable.notifyObservers(i, a);
	}
	_isPointerSwiping() {
	...
	simulatePointerUp(e, t, n) {
		...
		r.inputIndex = Y.Move;
		let i = new He();
		n ? i.doubleClick = !0 : i.singleClick = !0, !this._checkPrePointerObservable(e, r, H.POINTERUP) && this._processPointerUp(e, r, i);
	}
	_processPointerUp(e, t, n) {
		...
		if (e?.pickedMesh) {
			if (this._pickedUpMesh = e.pickedMesh, this._pickedDownMesh === this._pickedUpMesh && (r.onPointerPick && r.onPointerPick(t, e), n.singleClick && !n.ignore && r.onPointerObservable.observers.length > this._cameraObserverCount)) {
				let n = H.POINTERPICK, i = new U(n, t, e);
				this._setRayOnPointerInfo(e, t), r.onPointerObservable.notifyObservers(i, n);
			}
			let i = e.pickedMesh._getActionManagerForTrigger();
			if (i && !n.ignore) {
				i.processTrigger(7, k.CreateNew(e.pickedMesh, t, e)), !n.hasSwiped && n.singleClick && i.processTrigger(1, k.CreateNew(e.pickedMesh, t, e));
				let r = e.pickedMesh._getActionManagerForTrigger(6);
				n.doubleClick && r && r.processTrigger(6, k.CreateNew(e.pickedMesh, t, e));
			}
		...
		if (this._pickedDownMesh && this._pickedDownMesh !== this._pickedUpMesh) {
			...
			e && e.processTrigger(16, k.CreateNew(this._pickedDownMesh, t));
		}
		if (!n.ignore) {
			let i = new U(H.POINTERUP, t, e);
			if (this._setRayOnPointerInfo(e, t), r.onPointerObservable.notifyObservers(i, H.POINTERUP), r.onPointerUp && r.onPointerUp(t, e, H.POINTERUP), !n.hasSwiped && !this._skipPointerTap && !this._isMultiTouchGesture) {
				let i = 0;
				if (n.singleClick ? i = H.POINTERTAP : n.doubleClick && (i = H.POINTERDOUBLETAP), i) {
					let n = new U(i, t, e);
	...
	attachControl(e = !0, n = !0, r = !0, i = null) {
		let a = this._scene, o = a.getEngine();
		i ||= o.getInputElement(), this._alreadyAttached && this.detachControl(), i && (this._alreadyAttachedTo = i), this._deviceSourceManager = new Be(o), this._initActionManager = (e) => {
			...
			return e;
		}, this._delayedSimpleClick = (e, n, r) => {
			if ((Date.now() - this._previousStartingPointerTime > t.DoubleClickDelay && !this._doubleClickOccured || e !== this._previousButtonPressed) && (this._doubleClickOccured = !1, n.singleClick = !0, n.ignore = !1, this._delayedClicks[e])) {
				let t = this._delayedClicks[e].evt, n = H.POINTERTAP, r = new U(n, t, this._currentPickResult);
				a.onPointerObservable.hasObservers() && a.onPointerObservable.hasSpecificMask(n) && a.onPointerObservable.notifyObservers(r, n), this._delayedClicks[e] = null;
			}
		}, this._initClickEvent = (e, n, r, i) => {
			let a = new He();
			this._currentPickResult = null;
			let o = null, s = e.hasSpecificMask(H.POINTERPICK) || n.hasSpecificMask(H.POINTERPICK) || e.hasSpecificMask(H.POINTERTAP) || n.hasSpecificMask(H.POINTERTAP) || e.hasSpecificMask(H.POINTERDOUBLETAP) || n.hasSpecificMask(H.POINTERDOUBLETAP);
			!s && W && (o = this._initActionManager(o, a), o && (s = o.hasPickTriggers));
			let c = !1;
			if (s &&= !this._isMultiTouchGesture, s) {
				let s = r.button;
				if (a.hasSwiped = this._isPointerSwiping(), !a.hasSwiped) {
					let l = !t.ExclusiveDoubleClickMode;
					if (l || (l = !e.hasSpecificMask(H.POINTERDOUBLETAP) && !n.hasSpecificMask(H.POINTERDOUBLETAP), l && !W.HasSpecificTrigger(6) && (o = this._initActionManager(o, a), o && (l = !o.hasSpecificTrigger(6)))), l) (Date.now() - this._previousStartingPointerTime > t.DoubleClickDelay || s !== this._previousButtonPressed) && (a.singleClick = !0, i(a, this._currentPickResult), c = !0);
					else {
						let e = {
							evt: r,
							clickInfo: a,
							timeoutId: window.setTimeout(this._delayedSimpleClick.bind(this, s, a, i), t.DoubleClickDelay)
						};
						this._delayedClicks[s] = e;
					}
					let u = e.hasSpecificMask(H.POINTERDOUBLETAP) || n.hasSpecificMask(H.POINTERDOUBLETAP);
					!u && W.HasSpecificTrigger(6) && (o = this._initActionManager(o, a), o && (u = o.hasSpecificTrigger(6))), u && (s === this._previousButtonPressed && Date.now() - this._previousStartingPointerTime < t.DoubleClickDelay && !this._doubleClickOccured ? (!a.hasSwiped && !this._isPointerSwiping() ? (this._previousStartingPointerTime = 0, this._doubleClickOccured = !0, a.doubleClick = !0, a.ignore = !1, t.ExclusiveDoubleClickMode && this._delayedClicks[s] && (clearTimeout(this._delayedClicks[s]?.timeoutId), this._delayedClicks[s] = null), i(a, this._currentPickResult)) : (this._doubleClickOccured = !1, this._previousStartingPointerTime = this._startingPointerTime, this._previousStartingPointerPosition.x = this._startingPointerPosition.x, this._previousStartingPointerPosition.y = this._startingPointerPosition.y, this._previousButtonPressed = s, t.ExclusiveDoubleClickMode ? (this._delayedClicks[s] && (clearTimeout(this._delayedClicks[s]?.timeoutId), this._delayedClicks[s] = null), i(a, this._previousPickResult)) : i(a, this._currentPickResult)), c = !0) : (this._doubleClickOccured = !1, this._previousStartingPointerTime = this._startingPointerTime, this._previousStartingPointerPosition.x = this._startingPointerPosition.x, this._previousStartingPointerPosition.y = this._startingPointerPosition.y, this._previousButtonPressed = s));
				}
			}
			c || i(a, this._currentPickResult);
		}, this._onPointerMove = (e) => {
			if (this._updatePointerPosition(e), !this._isSwiping && this._swipeButtonPressed !== -1 && (this._isSwiping = Math.abs(this._startingPointerPosition.x - this._pointerX) > t.DragMovementThreshold || Math.abs(this._startingPointerPosition.y - this._pointerY) > t.DragMovementThreshold), o.isPointerLock && o._verifyPointerLock(), this._checkPrePointerObservable(null, e, e.inputIndex >= Y.MouseWheelX && e.inputIndex <= Y.MouseWheelZ ? H.POINTERWHEEL : H.POINTERMOVE) || !a.cameraToUseForPointers && !a.activeCamera) return;
			if (a.skipPointerMovePicking) {
				this._processPointerMove(new O(), e);
				return;
			}
			...
			let n = a._registeredActions > 0 || a.constantlyUpdateMeshUnderPointer ? this._pickMove(e) : null;
			this._processPointerMove(n, e);
		}, this._onPointerDown = (e) => {
			let n = this._activePointerIds.indexOf(-1);
			if (n === -1 ? this._activePointerIds.push(e.pointerId) : this._activePointerIds[n] = e.pointerId, this._activePointerIdsCount++, this._pickedDownMesh = null, this._meshPickProceed = !1, t.ExclusiveDoubleClickMode) {
				for (let t = 0; t < this._delayedClicks.length; t++) if (this._delayedClicks[t]) {
					if (e.button === t) clearTimeout(this._delayedClicks[t]?.timeoutId);
					else {
						let e = this._delayedClicks[t].clickInfo;
						this._doubleClickOccured = !1, e.singleClick = !0, e.ignore = !1;
						let n = this._delayedClicks[t].evt, r = H.POINTERTAP, i = new U(r, n, this._currentPickResult);
						a.onPointerObservable.hasObservers() && a.onPointerObservable.hasSpecificMask(r) && a.onPointerObservable.notifyObservers(i, r), this._delayedClicks[t] = null;
					}
				}
			}
			if (this._updatePointerPosition(e), this._swipeButtonPressed === -1 && (this._swipeButtonPressed = e.button), a.preventDefaultOnPointerDown && i && (e.preventDefault(), i.focus()), this._startingPointerPosition.x = this._pointerX, this._startingPointerPosition.y = this._pointerY, this._startingPointerTime = Date.now(), this._checkPrePointerObservable(null, e, H.POINTERDOWN) || !a.cameraToUseForPointers && !a.activeCamera) return;
			this._pointerCaptures[e.pointerId] = !0, a.pointerDownPredicate ||= (e) => e.isPickable && e.isVisible && e.isReady() && e.isEnabled() && (!a.cameraToUseForPointers || (a.cameraToUseForPointers.layerMask & e.layerMask) !== 0), this._pickedDownMesh = null;
			let r;
			r = a.skipPointerDownPicking || a._registeredActions === 0 && !this._checkForPicking() && !a.onPointerDown ? new O() : a.pick(this._unTranslatedPointerX, this._unTranslatedPointerY, a.pointerDownPredicate, a.pointerDownFastCheck, a.cameraToUseForPointers, a.pointerDownTrianglePredicate), this._processPointerDown(r, e);
		}, this._onPointerUp = (e) => {
			...
			t !== -1 && (this._activePointerIds[t] = -1, this._activePointerIdsCount--, this._pickedUpMesh = null, this._meshPickProceed = !1, this._updatePointerPosition(e), a.preventDefaultOnPointerUp && i && (e.preventDefault(), i.focus()), this._initClickEvent(a.onPrePointerObservable, a.onPointerObservable, e, (t, n) => {
				if (a.onPrePointerObservable.hasObservers() && (this._skipPointerTap = !1, !t.ignore)) {
					if (this._checkPrePointerObservable(null, e, H.POINTERUP)) {
					...
					t.hasSwiped || (t.singleClick && a.onPrePointerObservable.hasSpecificMask(H.POINTERTAP) && this._checkPrePointerObservable(null, e, H.POINTERTAP) && (this._skipPointerTap = !0), t.doubleClick && a.onPrePointerObservable.hasSpecificMask(H.POINTERDOUBLETAP) && this._checkPrePointerObservable(null, e, H.POINTERDOUBLETAP) && (this._skipPointerTap = !0));
				}
				if (!this._pointerCaptures[e.pointerId]) {
					this._swipeButtonPressed === e.button && (this._isSwiping = !1, this._swipeButtonPressed = -1);
					return;
				}
				e.buttons === 0 && (this._pointerCaptures[e.pointerId] = !1), !(!a.cameraToUseForPointers && !a.activeCamera) && (a.pointerUpPredicate ||= (e) => e.isPickable && e.isVisible && e.isReady() && e.isEnabled() && (!a.cameraToUseForPointers || (a.cameraToUseForPointers.layerMask & e.layerMask) !== 0), !this._meshPickProceed && (W && W.HasTriggers || this._checkForPicking() || a.onPointerUp) && this._initActionManager(null, t), n ||= this._currentPickResult, this._processPointerUp(n, e, t), this._previousPickResult = this._currentPickResult, this._swipeButtonPressed === e.button && (this._isSwiping = !1, this._swipeButtonPressed = -1));
			}));
		}, this._onKeyDown = (e) => {
			let t = G.KEYDOWN;
			...
			a.actionManager && a.actionManager.processTrigger(14, k.CreateNewFromScene(a, e));
		}, this._onKeyUp = (e) => {
			let t = G.KEYUP;
			if (a.onPreKeyboardObservable.hasObservers()) {
				let n = new q(t, e);
			...
			a.actionManager && a.actionManager.processTrigger(15, k.CreateNewFromScene(a, e));
		}, this._deviceSourceManager.onDeviceConnectedObservable.add((t) => {
			t.deviceType === J.Mouse ? t.onInputChangedObservable.add((i) => {
				this._originMouseEvent = i, i.inputIndex === Y.LeftClick || i.inputIndex === Y.MiddleClick || i.inputIndex === Y.RightClick || i.inputIndex === Y.BrowserBack || i.inputIndex === Y.BrowserForward ? n && t.getInput(i.inputIndex) === 1 ? this._onPointerDown(i) : e && t.getInput(i.inputIndex) === 0 && this._onPointerUp(i) : r && (i.inputIndex === Y.Move || i.inputIndex === Y.MouseWheelX || i.inputIndex === Y.MouseWheelY || i.inputIndex === Y.MouseWheelZ) && this._onPointerMove(i);
			}) : t.deviceType === J.Touch ? t.onInputChangedObservable.add((i) => {
				i.inputIndex === Y.LeftClick && (n && t.getInput(i.inputIndex) === 1 ? (this._onPointerDown(i), this._activePointerIdsCount > 1 && (this._isMultiTouchGesture = !0)) : e && t.getInput(i.inputIndex) === 0 && (this._onPointerUp(i), this._activePointerIdsCount === 0 && (this._isMultiTouchGesture = !1))), r && i.inputIndex === Y.Move && this._onPointerMove(i);
			}) : t.deviceType === J.Keyboard && t.onInputChangedObservable.add((e) => {
	...
	setPointerOverMesh(e, t = 0, n, r) {
		...
		i && (a = i._getActionManagerForTrigger(10), a && a.processTrigger(10, new k(i, this._pointerX, this._pointerY, e, r, { pointerId: t }))), e ? (this._meshUnderPointerId[t] = e, this._pointerOverMesh = e, a = e._getActionManagerForTrigger(9), a && a.processTrigger(9, new k(e, this._pointerX, this._pointerY, e, r, {
			pointerId: t,
			pickResult: n
...
Q.DragMovementThreshold = 10, Q.LongPressDelay = 500, Q.DoubleClickDelay = 300, Q.ExclusiveDoubleClickMode = !1;
//#endregion
...
var $ = class n {
	static DefaultMaterialFactory(e) {
		throw i("StandardMaterial");
	}
	static CollisionCoordinatorFactory() {
		throw i("DefaultCollisionCoordinator");
	}
	get clearColor() {
		...
		if (e !== this._performancePriority) {
			switch (this._performancePriority = e, e) {
				...
				case 1:
					...
					break;
				case 2: this.skipFrustumClipping = !0, this._renderingManager.maintainStateBetweenFrames = !0, this.skipPointerMovePicking = !0, this.autoClear = !1;
			}
	...
	static get DragMovementThreshold() {
		return Q.DragMovementThreshold;
	}
	static set DragMovementThreshold(e) {
		Q.DragMovementThreshold = e;
	}
	static get LongPressDelay() {
		return Q.LongPressDelay;
	}
	static set LongPressDelay(e) {
		Q.LongPressDelay = e;
	}
	static get DoubleClickDelay() {
		return Q.DoubleClickDelay;
	}
	static set DoubleClickDelay(e) {
		Q.DoubleClickDelay = e;
	}
	static get ExclusiveDoubleClickMode() {
		return Q.ExclusiveDoubleClickMode;
	}
	static set ExclusiveDoubleClickMode(e) {
		Q.ExclusiveDoubleClickMode = e;
	}
	get _eyePosition() {
		return this._forcedViewPosition ?? this.activeCamera?.globalPosition ?? m.ZeroReadOnly;
	}
	bindEyePosition(e, t = "vEyePosition", n = !1) {
		let r = this._eyePosition, i = this.useRightHandedSystem === (this._mirroredCameraPosition != null), a = this.floatingOriginOffset, o = Ge.set(r.x, r.y, r.z, i ? -1 : 1), s = o.subtractFromFloatsToRef(a.x, a.y, a.z, 0, Ke);
	...
	set activeCameras(e) {
		this._unObserveActiveCameras &&= (this._unObserveActiveCameras(), null), e && (this._unObserveActiveCameras = ae(e, () => {
	...
	get _hasDefaultMaterial() {
		return n.DefaultMaterialFactory !== n._OriginalDefaultMaterialFactory;
	}
	get defaultMaterial() {
		return this._defaultMaterial ||= n.DefaultMaterialFactory(this), this._defaultMaterial;
	}
	...
	get collisionCoordinator() {
		return this._collisionCoordinator || (this._collisionCoordinator = n.CollisionCoordinatorFactory(), this._collisionCoordinator.init(this)), this._collisionCoordinator;
	}
	...
	constructor(i, a) {
		this._inputManager = new Q(this), this.cameraToUseForPointers = null, this._isScene = !0, this._blockEntityCollection = !1, this.autoClear = !0, this.autoClearDepthAndStencil = !0, this._clearColor = new x(.2, .2, .3, 1), this.onClearColorChangedObservable = new t(), this.ambientColor = new ce(0, 0, 0), this.environmentIntensity = 1, this.iblIntensity = 1, this._performancePriority = 0, this.onScenePerformancePriorityChangedObservable = new t(), this._forceWireframe = !1, this._skipFrustumClipping = !1, this._forcePointsCloud = !1, this.rootNodes = [], this.cameras = [], this.lights = [], this.meshes = [], this.skeletons = [], this.particleSystems = [], this.animations = [], this.animationGroups = [], this.multiMaterials = [], this.materials = [], this.morphTargetManagers = [], this.geometries = [], this.transformNodes = [], this.actionManagers = [], this.objectRenderers = [], this.textures = [], this._environmentTexture = null, this.postProcesses = [], this.effectLayers = [], this.sounds = null, this.layers = [], this.lensFlareSystems = [], this.proceduralTextures = [], this.animationsEnabled = !0, this._animationPropertiesOverride = null, this.useConstantAnimationDeltaTime = !1, this.constantlyUpdateMeshUnderPointer = !1, this.hoverCursor = "pointer", this.defaultCursor = "", this.doNotHandleCursors = !1, this.preventDefaultOnPointerDown = !0, this.preventDefaultOnPointerUp = !0, this.metadata = null, this.reservedDataStore = null, this.disableOfflineSupportExceptionRules = [], this.onDisposeObservable = new t(), this._onDisposeObserver = null, this.onBeforeRenderObservable = new t(), this._onBeforeRenderObserver = null, this.onAfterRenderObservable = new t(), this.onAfterRenderCameraObservable = new t(), this._onAfterRenderObserver = null, this.onBeforeAnimationsObservable = new t(), this.onAfterAnimationsObservable = new t(), this.onBeforeDrawPhaseObservable = new t(), this.onAfterDrawPhaseObservable = new t(), this.onReadyObservable = new t(), this.onBeforeCameraRenderObservable = new t(), this._onBeforeCameraRenderObserver = null, this.onAfterCameraRenderObservable = new t(), this._onAfterCameraRenderObserver = null, this.onBeforeActiveMeshesEvaluationObservable = new t(), this.onAfterActiveMeshesEvaluationObservable = new t(), this.onBeforeParticlesRenderingObservable = new t(), this.onAfterParticlesRenderingObservable = new t(), this.onDataLoadedObservable = new t(), this.onNewCameraAddedObservable = new t(), this.onCameraRemovedObservable = new t(), this.onNewLightAddedObservable = new t(), this.onLightRemovedObservable = new t(), this.onNewGeometryAddedObservable = new t(), this.onGeometryRemovedObservable = new t(), this.onNewTransformNodeAddedObservable = new t(), this.onTransformNodeRemovedObservable = new t(), this.onNewMeshAddedObservable = new t(), this.onMeshRemovedObservable = new t(), this.onNewSkeletonAddedObservable = new t(), this.onSkeletonRemovedObservable = new t(), this.onNewParticleSystemAddedObservable = new t(), this.onParticleSystemRemovedObservable = new t(), this.onNewAnimationGroupAddedObservable = new t(), this.onAnimationGroupRemovedObservable = new t(), this.onNewMaterialAddedObservable = new t(), this.onNewMultiMaterialAddedObservable = new t(), this.onMaterialRemovedObservable = new t(), this.onMultiMaterialRemovedObservable = new t(), this.onNewTextureAddedObservable = new t(), this.onTextureRemovedObservable = new t(), this.onNewFrameGraphAddedObservable = new t(), this.onFrameGraphRemovedObservable = new t(), this.onNewObjectRendererAddedObservable = new t(), this.onObjectRendererRemovedObservable = new t(), this.onNewPostProcessAddedObservable = new t(), this.onPostProcessRemovedObservable = new t(), this.onNewEffectLayerAddedObservable = new t(), this.onEffectLayerRemovedObservable = new t(), this.onBeforeRenderTargetsRenderObservable = new t(), this.onAfterRenderTargetsRenderObservable = new t(), this.onBeforeStepObservable = new t(), this.onAfterStepObservable = new t(), this.onActiveCameraChanged = new t(), this.onActiveCamerasChanged = new t(), this.onBeforeRenderingGroupObservable = new t(), this.onAfterRenderingGroupObservable = new t(), this.onMeshImportedObservable = new t(), this.onAnimationFileImportedObservable = new t(), this.onEnvironmentTextureChangedObservable = new t(), this.onMeshUnderPointerUpdatedObservable = new t(), this._registeredForLateAnimationBindings = new p(256), this._pointerPickingConfiguration = new We(), this.onPrePointerObservable = new t(), this.onPointerObservable = new t(), this.onPreKeyboardObservable = new t(), this.onKeyboardObservable = new t(), this._useRightHandedSystem = !1, this._timeAccumulator = 0, this._currentStepId = 0, this._currentInternalStep = 0, this._fogEnabled = !0, this._fogMode = n.FOGMODE_NONE, this.fogColor = new ce(.2, .2, .3), this.fogDensity = .1, this.fogStart = 0, this.fogEnd = 1e3, this.needsPreviousWorldMatrices = !1, this._shadowsEnabled = !0, this._lightsEnabled = !0, this._unObserveActiveCameras = null, this._texturesEnabled = !0, this._frameGraph = null, this.frameGraphs = [], this.physicsEnabled = !0, this.particlesEnabled = !0, this.spritesEnabled = !0, this._skeletonsEnabled = !0, this.lensFlaresEnabled = !0, this.collisionsEnabled = !0, this.gravity = new m(0, -9.807, 0), this.postProcessesEnabled = !0, this.renderTargetsEnabled = !0, this.dumpNextRenderTargets = !1, this.customRenderTargets = [], this.importedMeshesFiles = [], this.probesEnabled = !0, this._meshesForIntersections = new p(256), this.proceduralTexturesEnabled = !0, this._totalVertices = new d(), this._activeIndices = new d(), this._activeParticles = new d(), this._activeBones = new d(), this._animationTime = 0, this.animationTimeScale = 1, this._renderId = 0, this._frameId = 0, this._executeWhenReadyTimeoutId = null, this._intermediateRendering = !1, this._defaultFrameBufferCleared = !1, this._viewUpdateFlag = -1, this._projectionUpdateFlag = -1, this._toBeDisposed = Array(256), this._activeRequests = [], this._pendingData = [], this._isDisposed = !1, this._isReadyChecks = [], this.dispatchAllSubMeshesOfActiveMeshes = !1, this._activeMeshes = new u(256), this._processedMaterials = new u(256), this._renderTargets = new p(256), this._materialsRenderTargets = new p(256), this._activeParticleSystems = new u(256), this._activeSkeletons = new p(32), this._softwareSkinnedMeshes = new p(32), this._activeAnimatables = [], this._transformMatrix = y.Zero(), this.requireLightSorting = !1, this._components = [], this._serializableComponents = [], this._transientComponents = [], this._beforeCameraUpdateStage = V.Create(), this._beforeClearStage = V.Create(), this._beforeRenderTargetClearStage = V.Create(), this._gatherRenderTargetsStage = V.Create(), this._gatherActiveCameraRenderTargetsStage = V.Create(), this._isReadyForMeshStage = V.Create(), this._beforeEvaluateActiveMeshStage = V.Create(), this._evaluateSubMeshStage = V.Create(), this._preActiveMeshStage = V.Create(), this._cameraDrawRenderTargetStage = V.Create(), this._beforeCameraDrawStage = V.Create(), this._beforeRenderTargetDrawStage = V.Create(), this._beforeRenderingGroupDrawStage = V.Create(), this._beforeRenderingMeshStage = V.Create(), this._afterRenderingMeshStage = V.Create(), this._afterRenderingGroupDrawStage = V.Create(), this._afterCameraDrawStage = V.Create(), this._afterCameraPostProcessStage = V.Create(), this._afterRenderTargetDrawStage = V.Create(), this._afterRenderTargetPostProcessStage = V.Create(), this._afterRenderStage = V.Create(), this._pointerMoveStage = V.Create(), this._pointerDownStage = V.Create(), this._pointerUpStage = V.Create(), this._geometriesByUniqueId = null, this._uniqueId = 0, this._defaultMeshCandidates = {
			data: [],
			length: 0
		}, this._defaultSubMeshCandidates = {
			data: [],
			length: 0
		}, this.onReadyTimeoutObservable = new t(), this.onReadyTimeoutDuration = 12e4, this._timeoutChecksStartTime = 0, this._floatingOriginScene = void 0, this._preventFreeActiveMeshesAndRenderingGroups = !1, this._activeMeshesFrozen = !1, this._activeMeshesFrozenButKeepClipping = !1, this._skipEvaluateActiveMeshesCompletely = !1, this._freezeActiveMeshesCancel = null, this._useCurrentFrameBuffer = !1, this._allowPostProcessClearColor = !0, this.getDeterministicFrameTime = () => this._engine.getTimeStep(), this._getFloatingOriginScene = () => this._floatingOriginScene, this._registeredActions = 0, this._blockMaterialDirtyMechanism = !1, this._perfCollector = null, this.activeCameras = [], this._uniqueId = this.getUniqueId();
		let o = {
		...
		i = this._engine = i || e.LastCreatedEngine, o.virtual ? i._virtualScenes.push(this) : (e._LastCreatedScene = this, i.scenes.push(this)), (i.getCreationOptions().useLargeWorldRendering || a?.useFloatingOrigin) && (Te(), this._floatingOriginScene = this, N.getScene = this._getFloatingOriginScene), this._uid = null, this._renderingManager = new te(this), ne && (this.postProcessManager = new ne(this)), r() && this.attachControl(), this._createUbo(), D && (this._imageProcessingConfiguration = new D()), this.setDefaultCandidateProviders(), o.useGeometryUniqueIdsMap && (this._geometriesByUniqueId = {}), this.useMaterialMeshMap = o.useMaterialMeshMap, this.useClonedMeshMap = o.useClonedMeshMap, (!a || !a.virtual) && i.onNewSceneAddedObservable.notifyObservers(this);
	}
	getClassName() {
		return "Scene";
	}
	...
	isReady(e = !0) {
		...
		for (this._pendingData.length > 0 && (i = !1), this.prePassRenderer?.update(), this.useOrderIndependentTransparency && this.depthPeelingRenderer && (i &&= this.depthPeelingRenderer.isReady()), e && (this._processedMaterials.reset(), this._materialsRenderTargets.reset()), t = 0; t < this.meshes.length; t++) {
			...
			if (o) {
				if (o._storeEffectOnSubMeshes) for (let e of r.subMeshes) {
					let t = e.getMaterial();
		...
		if (e) for (t = 0; t < this._materialsRenderTargets.length; ++t) this._materialsRenderTargets.data[t].isReadyForRendering() || (i = !1);
	...
	_checkIsReady(e = !1) {
		if (this._registerTransientComponents(), this._timeoutChecksStartTime === 0) this._timeoutChecksStartTime = c.Now;
		else if (this.onReadyTimeoutDuration > 0 && c.Now - this._timeoutChecksStartTime > this.onReadyTimeoutDuration) {
	...
	setTransformMatrix(e, t, n, r) {
		this._multiviewSceneUboIsActive = !!(n && r && this._multiviewSceneUbo), (this._viewUpdateFlag !== e.updateFlag || this._projectionUpdateFlag !== t.updateFlag) && (this._viewUpdateFlag = e.updateFlag, this._projectionUpdateFlag = t.updateFlag, this._viewMatrix = e, this._projectionMatrix = t, this._viewMatrix.multiplyToRef(this._projectionMatrix, this._transformMatrix), this._frustumPlanes ? ee.GetPlanesToRef(this._transformMatrix, this._frustumPlanes) : this._frustumPlanes = ee.GetPlanes(this._transformMatrix), this._multiviewSceneUboIsActive && this._multiviewSceneUbo.useUbo ? this._updateMultiviewUbo(n, r) : this._sceneUbo.useUbo && (this._sceneUbo.updateMatrix("viewProjection", this._transformMatrix), this._sceneUbo.updateMatrix("view", this._viewMatrix), this._sceneUbo.updateMatrix("projection", this._projectionMatrix)));
	}
	...
	createSceneUniformBuffer(e, t) {
		let n = typeof t == "boolean" ? t : t?.trackUBOsInFrame, r = new f(this._engine, void 0, !1, e ?? "scene", void 0, n);
	...
	get floatingOriginOffset() {
		return this.floatingOriginMode ? this._eyePosition : m.ZeroReadOnly;
	}
	getUniqueId() {
		return Ue.UniqueId;
	}
	addMesh(e, t = !1) {
		if (!this._blockEntityCollection && (this.meshes.push(e), e._resyncLightSources(), e.parent || e._addToSceneRootNodes(), T.SetImmediate(() => {
	...
	removeCamera(e) {
		...
		return this.activeCamera === e && (this.activeCamera = this.cameras.length > 0 ? this.cameras[0] : null), this.onCameraRemovedObservable.notifyObservers(e), t;
	}
	...
	addCamera(e) {
		this._blockEntityCollection || (this.cameras.push(e), T.SetImmediate(() => {
			this.onNewCameraAddedObservable.notifyObservers(e);
		}), e.parent || e._addToSceneRootNodes());
	}
	addSkeleton(e) {
		this._blockEntityCollection || (this.skeletons.push(e), T.SetImmediate(() => {
			this.onNewSkeletonAddedObservable.notifyObservers(e);
		}));
	}
	addParticleSystem(e) {
		this._blockEntityCollection || (this.particleSystems.push(e), T.SetImmediate(() => {
	...
	addAnimationGroup(e) {
		this._blockEntityCollection || (this.animationGroups.push(e), T.SetImmediate(() => {
			this.onNewAnimationGroupAddedObservable.notifyObservers(e);
		}));
	}
	addMultiMaterial(e) {
		this._blockEntityCollection || (this.multiMaterials.push(e), T.SetImmediate(() => {
			this.onNewMultiMaterialAddedObservable.notifyObservers(e);
		}));
	}
	addMaterial(e) {
		this._blockEntityCollection || (e.getScene() !== this || e._indexInSceneMaterialArray === -1) && (e._indexInSceneMaterialArray = this.materials.length, this.materials.push(e), T.SetImmediate(() => {
	...
	addFrameGraph(e) {
		this.frameGraphs.push(e), T.SetImmediate(() => {
			this.onNewFrameGraphAddedObservable.notifyObservers(e);
		});
	}
	addObjectRenderer(e) {
		this.objectRenderers.push(e), T.SetImmediate(() => {
			this.onNewObjectRendererAddedObservable.notifyObservers(e);
		});
	}
	addPostProcess(e) {
		this._blockEntityCollection || (this.postProcesses.push(e), T.SetImmediate(() => {
			this.onNewPostProcessAddedObservable.notifyObservers(e);
		}));
	}
	addEffectLayer(e) {
		this._blockEntityCollection || (this.effectLayers.push(e), T.SetImmediate(() => {
	...
	pushGeometry(e, t) {
		return !t && this._getGeometryByUniqueId(e.uniqueId) ? !1 : (this.addGeometry(e), T.SetImmediate(() => {
	...
	get uid() {
		return this._uid ||= T.RandomId(), this._uid;
	}
	addExternalData(e, t) {
		return this._externalData ||= new he(), this._externalData.add(e, t);
	}
	getExternalData(e) {
		return this._externalData ? this._externalData.get(e) : null;
	}
	getOrAddExternalDataWithFactory(e, t) {
		return this._externalData ||= new he(), this._externalData.getOrAddWithFactory(e, t);
	}
	...
	freezeActiveMeshes(e = !1, t, n, r = !0, i = !1) {
		if (this.frameGraph) {
			this._renderWithFrameGraph(!0, !1, !0);
			let a = this.frameGraph.getTasksByClassName(["FrameGraphObjectRendererTask", "FrameGraphGeometryRendererTask"]);
			for (let e of a) e.objectRenderer._freezeActiveMeshes(r);
			return this._freezeActiveMeshesCancel = o(() => {
				let e = !0, t = !0;
				for (let n of a) e &&= n.objectRenderer._isFrozen, t &&= n.objectRenderer._freezeActiveMeshesCancel !== null;
				if (e) return !0;
				if (!t) throw Error("Freezing active meshes was cancelled");
				return !1;
			}, () => {
				this._freezeActiveMeshesCancel = null, this._activeMeshesFrozen = !0, this._activeMeshesFrozenButKeepClipping = i, this._skipEvaluateActiveMeshesCompletely = e, t?.();
			}, (e, t) => {
				if (this._freezeActiveMeshesCancel = null, this.unfreezeActiveMeshes(), t) {
					...
					n ? n(t) : (l.Error(t), e && l.Error(e));
				} else {
					let t = "Scene: An unexpected error occurred while trying to freeze active meshes.";
					n ? n(t) : (l.Error(t), e && (l.Error(e), e.stack && l.Error(e.stack)));
				}
			}), this;
		}
		return this.executeWhenReady(() => {
			...
			if (this._frustumPlanes || this.updateTransformMatrix(), this._evaluateActiveMeshes(), this._activeMeshesFrozen = !0, this._activeMeshesFrozenButKeepClipping = i, this._skipEvaluateActiveMeshesCompletely = e, r) for (let e = 0; e < this._activeMeshes.length; e++) this._activeMeshes.data[e]._freeze();
			t && t();
		}), this;
	}
	...
	_renderForCamera(e, t, n = !0) {
		...
		if (this.renderTargetsEnabled) {
			...
			if (this._renderTargets.length > 0) {
				T.StartPerformanceCounter("Render targets", this._renderTargets.length > 0);
				...
				t && e && (t.renderList.data = e, t.renderList.length = e.length), T.EndPerformanceCounter("Render targets", this._renderTargets.length > 0), this._renderId++;
			}
		...
		for (let e = 0; e < this._meshesForIntersections.length; e++) {
			...
			if (t.actionManager) for (let e = 0; t.actionManager && e < t.actionManager.actions.length; e++) {
				...
				if (n.trigger === 12 || n.trigger === 13) {
					...
					i && a === -1 ? n.trigger === 12 ? (n._executeCurrent(k.CreateNew(t, void 0, r)), t._intersectionsInProgress.push(r)) : n.trigger === 13 && t._intersectionsInProgress.push(r) : !i && a > -1 && (n.trigger === 13 && n._executeCurrent(k.CreateNew(t, void 0, r)), (!t.actionManager.hasSpecificTrigger(13, (e) => {
						let t = e.mesh ? e.mesh : e;
						return r === t;
					}) || n.trigger === 13) && t._intersectionsInProgress.splice(a, 1));
				}
			}
		}
	}
	...
	animate() {
		if (this._engine.isDeterministicLockStep()) {
			let e = Math.max(n.MinDeltaTime, Math.min(this._engine.getDeltaTime(), n.MaxDeltaTime)) + this._timeAccumulator, t = this._engine.getTimeStep(), r = 1e3 / t / 1e3, i = 0, a = this._engine.getLockstepMaxSteps(), o = Math.floor(e / t);
			for (o = Math.min(o, a); e > 0 && i < o;) this.onBeforeStepObservable.notifyObservers(this), this._animationRatio = t * r, this._animate(t), this.onAfterAnimationsObservable.notifyObservers(this), this.physicsEnabled && this._advancePhysicsEngineStep(t), this.onAfterStepObservable.notifyObservers(this), this._currentStepId++, i++, e -= t;
			this._timeAccumulator = e < 0 ? 0 : e;
		} else {
			let e = this.useConstantAnimationDeltaTime ? 16 : Math.max(n.MinDeltaTime, Math.min(this._engine.getDeltaTime(), n.MaxDeltaTime));
	...
	_renderWithFrameGraph(e = !0, t = !1, n = !1) {
		...
		if (this.renderTargetsEnabled) {
			this.environmentTexture && this.environmentTexture.isRenderTarget && this._renderTargets.pushNoDuplicate(this.environmentTexture), this._renderTargets.concatWithNoDuplicate(this.customRenderTargets), T.StartPerformanceCounter("Custom render targets", this._renderTargets.length > 0);
			...
			T.EndPerformanceCounter("Custom render targets", this._renderTargets.length > 0), this._renderId++;
		}
	...
	render(e = !0, t = !1) {
		if (!this.isDisposed) {
			if (this.onReadyObservable.hasObservers() && this._executeWhenReadyTimeoutId === null && this._checkIsReady(), N.getScene = this._getFloatingOriginScene, this._frameId++, this._defaultFrameBufferCleared = !1, this._checkCameraRenderTarget(this.activeCamera), this.activeCameras?.length) for (let e of this.activeCameras) this._checkCameraRenderTarget(e);
			...
			if (this.customRenderFunction) this._renderId++, this._engine.currentRenderPassId = 0, this.customRenderFunction(e, t);
				...
				if (this.renderTargetsEnabled) {
					T.StartPerformanceCounter("Custom render targets", this.customRenderTargets.length > 0);
					...
					T.EndPerformanceCounter("Custom render targets", this.customRenderTargets.length > 0), this._renderId++;
				}
	...
	dispose() {
		...
		let t = this._activeRequests.slice();
		for (let e of t) e.abort();
		this._activeRequests.length = 0;
		try {
			this.onDisposeObservable.notifyObservers(this);
		} catch (e) {
			l.Error("An error occurred while calling onDisposeObservable!", e);
		}
	...
	getWorldExtends(e) {
		let t = new m(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE), n = new m(-Number.MAX_VALUE, -Number.MAX_VALUE, -Number.MAX_VALUE);
		e ||= (() => !0);
		...
		for (let e of r) {
			...
			m.CheckExtends(i, t, n), m.CheckExtends(a, t, n);
		}
	...
	createPickingRay(e, t, n, r, a = !1) {
		throw i("Ray");
	}
	createPickingRayToRef(e, t, n, r, a, o = !1, s = !1) {
		throw i("Ray");
	}
	...
	pick(e, t, n, r, a, o) {
		let s = i("Ray", !0);
		return s && l.Warn(s), new O();
	}
	pickWithBoundingInfo(e, t, n, r, a) {
		let o = i("Ray", !0);
		return o && l.Warn(o), new O();
	}
	pickWithRay(e, t, n, r) {
		throw i("Ray");
	}
	...
	_getByTags(e, t, n) {
		...
		for (let i in e) {
			let a = e[i];
			se && se.MatchesQuery(a, t) && (!n || n(a)) && r.push(a);
		}
		return r;
	}
	getMeshesByTags(e, t) {
	...
	_loadFile(e, t, n, r, i, a, o) {
		let s = fe(e, t, n, r ? this.offlineProvider : void 0, i, a, o);
	...
	_requestFile(e, t, n, r, i, a, o) {
		let s = pe(e, t, n, r ? this.offlineProvider : void 0, i, a, o);
		return this._activeRequests.push(s), s.onCompleteObservable.add((e) => {
			this._activeRequests.splice(this._activeRequests.indexOf(e), 1);
		}), s;
	}
	...
	getPerfCollector() {
		throw i("performanceViewerSceneExtension");
	}
	setActiveCameraByID(e) {
...
$.FOGMODE_NONE = 0, $.FOGMODE_EXP = 1, $.FOGMODE_EXP2 = 2, $.FOGMODE_LINEAR = 3, $.MinDeltaTime = 1, $.MaxDeltaTime = 1e3, $._OriginalDefaultMaterialFactory = $.DefaultMaterialFactory, oe("BABYLON.Scene", $);
//#endregion
export { B as a, D as c, H as i, X as n, N as o, G as r, O as s, $ as t };

//# sourceMappingURL=scene-DOrQhig3.js.map