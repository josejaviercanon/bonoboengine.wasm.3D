...
function E(e = "default") {
	return ee[e] === void 0 && (ee[e] = -1), ++ee[e];
}
//#endregion
//#region node_modules/pixi.js/lib/utils/logging/deprecation.mjs
var te = /* @__PURE__ */ new Set(), ne = "8.0.0", re = "8.3.4", D = {
	quiet: !1,
	noColor: !1
}, O = ((e, t, n = 3) => {
	if (D.quiet || te.has(t)) return;
	let r = (/* @__PURE__ */ Error()).stack, i = `${t}
Deprecated since v${e}`, a = typeof console.groupCollapsed == "function" && !D.noColor;
...
function le(e) {
	let t = ce[e];
	return t === void 0 && (ce[e] = E("resource")), t;
}
var ue = class e extends o {
	constructor(t = {}) {
	...
	set wrapMode(e) {
		O(ne, "TextureStyle.wrapMode is now TextureStyle.addressMode"), this.addressMode = e;
	}
	get wrapMode() {
	...
	_generateResourceId() {
		...
		return this._sharedResourceId = le(e), this._resourceId;
	}
	destroy() {
...
var de = ue, fe = class e extends o {
	...
	unload() {
		this._resourceId = E("resource"), this.emit("change", this), this.emit("unload", this);
	...
	resize(e, t, n) {
		...
		return this.width = r / n, this.height = i / n, this._resolution = n, this.pixelWidth === r && this.pixelHeight === i ? !1 : (this._refreshPOT(), this.pixelWidth = r, this.pixelHeight = i, this.emit("resize", this), this._resourceId = E("resource"), this.emit("change", this), !0);
	}
	updateMipmaps() {
	...
	_refreshPOT() {
		this.isPowerOfTwo = oe(this.pixelWidth) && oe(this.pixelHeight);
	}
	static test(e) {
...
var pe = new f(), me = class {
	...
	update() {
		...
		r && (pe.set(n.width / r.width, 0, 0, n.height / r.height, -r.x / r.width, -r.y / r.height), this.mapCoord.append(pe));
	...
	constructor({ source: e, label: t, frame: n, orig: r, trim: i, defaultAnchor: a, defaultBorders: o, rotate: s, dynamic: c } = {}) {
		if (super(), this.uid = E("texture"), this.uvs = {
			x0: 0,
			y0: 0,
			x1: 0,
			y1: 0,
			...
			x3: 0,
			y3: 0
		}, this.frame = new T(), this.noFrame = !1, this.dynamic = !1, this.isTexture = !0, this.label = t, this.source = e?.source ?? new k(), this.noFrame = !n, n) this.frame.copyFrom(n);
		else {
	...
	get textureMatrix() {
		return this._textureMatrix ||= new me(this), this._textureMatrix;
	}
	get width() {
	...
	get baseTexture() {
		return O(ne, "Texture.baseTexture is now Texture.source"), this._source;
	}
};
j.EMPTY = new j({
	label: "EMPTY",
	source: new k({ label: "EMPTY" })
}), j.EMPTY.destroy = ie, j.WHITE = new j({
	source: new A({
...
var he = new f(), ge = class e {
	constructor(e = Infinity, t = Infinity, n = -Infinity, r = -Infinity) {
		this.minX = Infinity, this.minY = Infinity, this.maxX = -Infinity, this.maxY = -Infinity, this.matrix = he, this.minX = e, this.minY = t, this.maxX = n, this.maxY = r;
	}
	isEmpty() {
	...
	clear() {
		return this.minX = Infinity, this.minY = Infinity, this.maxX = -Infinity, this.maxY = -Infinity, this.matrix = he, this;
	}
	set(e, t, n, r) {
	...
	var t, n, r, i;
}, Ee = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, De = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Oe = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, ke = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, R = {
	string: [
		[function(e) {
			var t = be.exec(e);
			return t ? (e = t[1]).length <= 4 ? {
				...
				a: e.length === 8 ? N(parseInt(e.substr(6, 2), 16) / 255, 2) : 1
			} : null : null;
		}, "hex"],
		[function(e) {
			var t = Oe.exec(e) || ke.exec(e);
			return t ? t[2] !== t[4] || t[4] !== t[6] ? null : ye({
		...
		[function(e) {
			var t = Ee.exec(e) || De.exec(e);
			if (!t) return null;
			var n, r;
			return Te(Ce({
				h: (n = t[1], r = t[2], r === void 0 && (r = "deg"), Number(n) * (_e[r] || 1)),
				s: Number(t[3]),
				l: Number(t[4]),
	...
	object: [
		...
		[function(e) {
			...
			return !M(t) || !M(n) || !M(r) ? null : Se(function(e) {
				return {
					h: ve(e.h),
					s: P(e.s, 0, 100),
					v: P(e.v, 0, 100),
	...
	return typeof e == "string" ? Ae(e.trim(), R.string) : typeof e == "object" && e ? Ae(e, R.object) : [null, void 0];
}, z = function(e, t) {
	var n = L(e);
	return {
		h: n.h,
	...
	function e(e) {
		this.parsed = je(e)[0], this.rgba = this.parsed || {
			r: 0,
			g: 0,
			b: 0,
			a: 1
	...
	return e.prototype.isValid = function() {
		...
		return N(B(this.rgba), 2);
	}, e.prototype.isDark = function() {
		return B(this.rgba) < .5;
	}, e.prototype.isLight = function() {
		return B(this.rgba) >= .5;
	}, e.prototype.toHex = function() {
		return e = F(this.rgba), t = e.r, n = e.g, r = e.b, a = (i = e.a) < 1 ? I(N(255 * i)) : "", "#" + I(t) + I(n) + I(r) + a;
		var e, t, n, r, i, a;
	}, e.prototype.toRgb = function() {
		return F(this.rgba);
	}, e.prototype.toRgbString = function() {
		return e = F(this.rgba), t = e.r, n = e.g, r = e.b, (i = e.a) < 1 ? "rgba(" + t + ", " + n + ", " + r + ", " + i + ")" : "rgb(" + t + ", " + n + ", " + r + ")";
		var e, t, n, r, i;
	}, e.prototype.toHsl = function() {
		return we(L(this.rgba));
	}, e.prototype.toHslString = function() {
		return e = we(L(this.rgba)), t = e.h, n = e.s, r = e.l, (i = e.a) < 1 ? "hsla(" + t + ", " + n + "%, " + r + "%, " + i + ")" : "hsl(" + t + ", " + n + "%, " + r + "%)";
		var e, t, n, r, i;
	}, e.prototype.toHsv = function() {
		return e = xe(this.rgba), {
			h: N(e.h),
			s: N(e.s),
			v: N(e.v),
			a: N(e.a, 3)
		...
		return e === void 0 && (e = .1), H(z(this.rgba, e));
	}, e.prototype.desaturate = function(e) {
		return e === void 0 && (e = .1), H(z(this.rgba, -e));
	}, e.prototype.grayscale = function() {
		return H(z(this.rgba, -1));
	}, e.prototype.lighten = function(e) {
		return e === void 0 && (e = .1), H(Me(this.rgba, e));
	}, e.prototype.darken = function(e) {
		return e === void 0 && (e = .1), H(Me(this.rgba, -e));
	}, e.prototype.rotate = function(e) {
		return e === void 0 && (e = 15), this.hue(this.hue() + e);
	}, e.prototype.alpha = function(e) {
		return typeof e == "number" ? H({
			r: (t = this.rgba).r,
			g: t.g,
			b: t.b,
			a: e
		...
		return this.toHex() === H(e).toHex();
	}, e;
}(), H = function(e) {
	return e instanceof V ? e : new V(e);
}, Ne = [], Pe = function(e) {
	e.forEach(function(e) {
		Ne.indexOf(e) < 0 && (e(V, R), Ne.push(e));
	});
};
//#endregion
...
U.shared = new U(), U._temp = new U(), U.HEX_PATTERN = /^(#|0x)?(([a-f0-9]{3}){1,2}([a-f0-9]{2})?)$/i;
var Ie = U, Le = 0, Re = 500;
function ze(...e) {
	Le !== Re && (Le++, Le === Re ? console.warn("PixiJS Warning: too many warnings, no more warnings will be reported to the console by PixiJS.") : console.warn("PixiJS Warning: ", ...e));
}
//#endregion
...
var Be = {
	...
	getPool(e) {
		return this._poolsByClass.has(e) || this._poolsByClass.set(e, new Ve(e)), this._poolsByClass.get(e);
	}
	stats() {
		let e = {};
...
var We = class {
	constructor() {
		this.uid = E("instructionSet"), this.instructions = [], this.instructionSize = 0, this.renderables = [], this.gcTick = 0;
	}
	reset() {
...
var St = class e {
	constructor(t, n) {
		this._touched = 0, this.uid = E("uniform"), this._resourceType = "uniformGroup", this._resourceId = E("resource"), this.isUniformGroup = !0, this._dirtyId = 0, this.destroyed = !1, n = {
			...e.defaultOptions,
			...n
...
var Ct = St, X = class {
...
}, Z = /* @__PURE__ */ ((e) => (e[e.WEBGL = 1] = "WEBGL", e[e.WEBGPU = 2] = "WEBGPU", e[e.CANVAS = 4] = "CANVAS", e[e.BOTH = 3] = "BOTH", e))(Z || {}), wt = class e extends o {
	constructor(e) {
	...
	constructor(e) {
		...
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this._gcLastUsed = -1, this.autoGarbageCollect = !0, this.uid = E("buffer"), this._resourceType = "buffer", this._resourceId = E("resource"), this._touched = 0, this._updateID = 1, this._dataInt32 = null, this.shrinkToFit = !0, this.destroyed = !1, t instanceof Array && (t = new Float32Array(t)), this._data = t, n ??= t?.byteLength;
		let o = !!t;
		this.descriptor = {
			size: n,
			usage: r,
	...
	setDataWithSize(e, t, n) {
		...
		if (this._data = e, this._dataInt32 = null, !r || r.length !== e.length) {
			!this.shrinkToFit && r && e.byteLength < r.byteLength ? n && this.emit("update", this) : (this.descriptor.size = e.byteLength, this._resourceId = E("resource"), this.emit("change", this));
			return;
		}
		n && this.emit("update", this);
	}
...
var Ot = class extends o {
	constructor(e = {}) {
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this.uid = E("geometry"), this._layoutKey = 0, this.instanceCount = 1, this._bounds = new ge(), this._boundsDirty = !0;
...
//#endregion
export { re as A, a as B, A as C, ae as D, se as E, u as F, l as I, c as L, T as M, C as N, O, f as P, o as R, me as S, de as T, Be as _, Z as a, ge as b, vt as c, Ye as d, W as f, He as g, Ue as h, wt as i, E as j, ne as k, ct as l, We as m, $ as n, X as o, Ke as p, Q as r, Ct as s, Ot as t, ot as u, ze as v, k as w, j as x, Ie as y, n as z };

//# sourceMappingURL=Geometry-DYsNE2Rs.js.map