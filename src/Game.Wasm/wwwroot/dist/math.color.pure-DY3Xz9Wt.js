...
import { a as n, i as r, o as i, r as a, s as o, t as s } from "./math.scalar.functions-DcC_Ew_o.js";
...
var w = (e) => parseInt(e.toString().replace(/\W/g, "")), T = class e {
	...
	static Random(t = 0, r = 1) {
		return new e(n(t, r), n(t, r));
	}
	static RandomToRef(e = 0, t = 1, r) {
		return r.copyFromFloats(n(e, t), n(e, t));
	}
...
var E = class t {
	...
	static GetAngleBetweenVectorsOnPlane(e, n, i) {
		A.Vector3[0].copyFrom(e);
		let a = A.Vector3[0];
		A.Vector3[1].copyFrom(n);
		let o = A.Vector3[1];
	...
	static SlerpToRef(e, n, r, i) {
		...
		return o.scaleInPlace(f), c.scaleInPlace(p), i.copyFrom(o).addInPlace(c), i.scaleInPlace(a(l, u, r)), i;
	}
	...
	static Random(e = 0, r = 1) {
		return new t(n(e, r), n(e, r), n(e, r));
	}
	static RandomToRef(e = 0, t = 1, r) {
		return r.copyFromFloats(n(e, t), n(e, t), n(e, t));
	}
...
var D = class e {
	...
	static Random(t = 0, r = 1) {
		return new e(n(t, r), n(t, r), n(t, r), n(t, r));
	}
	static RandomToRef(e = 0, t = 1, r) {
		return r.x = n(e, t), r.y = n(e, t), r.z = n(e, t), r.w = n(e, t), r;
	}
	static Clamp(t, n, r) {
...
var O = class e {
	...
	static RandomToRef(e = 0, t = 1, r) {
		return r.copyFromFloats(n(e, t), n(e, t), n(e, t), n(e, t));
	}
	static Minimize() {
...
var z = class e {
	...
	equalsWithEpsilon(e, t = d) {
		return o(this.r, e.r, t) && o(this.g, e.g, t) && o(this.b, e.b, t);
	}
	negate() {
...
var B = class e {
	...
	equalsWithEpsilon(e, t = d) {
		return o(this.r, e.r, t) && o(this.g, e.g, t) && o(this.b, e.b, t) && o(this.a, e.a, t);
	}
	equalsToFloats(e, t, n, r) {
	...
	toHexString(e = !1) {
		...
		if (e) return "#" + i(t) + i(n) + i(r);
		let a = Math.round(this.a * 255);
		return "#" + i(t) + i(n) + i(r) + i(a);
	}
	fromHexString(e) {
...
//# sourceMappingURL=math.color.pure-DY3Xz9Wt.js.map