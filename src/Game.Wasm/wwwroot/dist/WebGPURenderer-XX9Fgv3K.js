import { B as e, P as t, a as n, f as r, i, j as a, n as o, o as s, p as c, r as l, s as u, v as d, w as f, x as p, z as m } from "./Geometry-DYsNE2Rs.js";
import { a as ee, n as h } from "./Filter-BsE1se_H.js";
import { h as g, m as te, n as ne, r as re, t as ie } from "./RenderTargetSystem-BdHBY0GA.js";
import { t as _ } from "./getTextureBatchBindGroup-BwZmQDMD.js";
import { c as ae, d as v, h as oe, i as y, m as b, o as se, t as x } from "./GCManagedHash-CXwB9kU7.js";
import { t as S } from "./CanvasPool-CMynuo7E.js";
import { c as ce, d as le, i as ue, l as de, o as fe, p as pe, r as me, s as he, t as ge } from "./BufferResource-D3fKdRii.js";
//#region node_modules/pixi.js/lib/rendering/batcher/gpu/GpuBatchAdaptor.mjs
var C = h.for2d(), w = class {
	start(e, t, n) {
...
var _e = class {
	...
	constructor(e) {
		this._renderer = e, this._managedBuffers = new x({
			renderer: e,
			type: "resource",
	...
	createGPUBuffer(e) {
		...
		return e._updateID = 0, e._resourceId = a("resource"), e.data && (oe(e.data.buffer, t.getMappedRange(), e.data.byteOffset, e.data.byteLength), t.unmap()), e._gpuData[this._renderer.uid] = new _e(t), this._managedBuffers.add(e) && (e.on("update", this.updateBuffer, this), e.on("change", this.onBufferChange, this)), t;
	}
	onBufferChange(e) {
...
var O = class {
	...
	async _createDeviceAndAdaptor(e) {
		let t = await c.get().getNavigator().gpu.requestAdapter({
...
var I = 128, L = class {
	constructor(e) {
		this._bindGroupHash = /* @__PURE__ */ Object.create(null), this._buffers = [], this._bindGroups = [], this._bufferResources = [], this._renderer = e, this._batchBuffer = new ve({ minUniformOffsetAlignment: I });
		let t = 256 / I;
		for (let e = 0; e < t; e++) {
			let t = l.UNIFORM | l.COPY_DST;
			e === 0 && (t |= l.COPY_SRC), this._buffers.push(new o({
	...
	_getBindGroup(e) {
		if (!this._bindGroups[e]) {
			let t = new s({ 0: this._getBufferResource(e) });
...
var R = class {
	...
	setStencilMode(e) {
		this._stencilMode !== e && (this._stencilMode = e, this._stencilState = he[e], this._updatePipeHash());
	}
	setPipeline(e, t, n, r) {
	...
	getPipeline(e, t, n, r) {
		e._layoutKey || (ce(e, t.attributeData), this._generateBufferKey(e)), r ||= e.topology;
	...
	_generateBufferKey(e) {
		let t = [], n = 0, i = Object.keys(e.attributes).sort();
		for (let r = 0; r < i.length; r++) {
			let a = e.attributes[i[r]];
			t[n++] = a.offset, t[n++] = a.format, t[n++] = a.stride, t[n++] = a.instance;
		}
		let a = t.join("|");
		return e._layoutKey = r(a, "geometry"), e._layoutKey;
	}
	_generateAttributeLocationsKey(e) {
		let t = [], n = 0, i = Object.keys(e.attributeData).sort();
		for (let r = 0; r < i.length; r++) {
			let a = e.attributeData[i[r]];
			t[n++] = a.location;
		}
		let a = t.join("|");
		return e._attributeLocationsKey = r(a, "programAttributes"), e._attributeLocationsKey;
	}
...
var Ce = class {
	...
	getDescriptor(e, t, n, r = 0, i = 0) {
		...
		if ((e.stencil || e.depth) && !e.depthStencilTexture && (e.ensureDepthStencilTexture(), e.depthStencilTexture.source.sampleCount = o.msaa ? 4 : 1, e.depthStencilTexture.source.transient = !!o.msaaTextures[0]?.transient), e.depthStencilTexture) {
			let n = t & g.STENCIL ? "clear" : "load", a = t & g.DEPTH ? "clear" : "load", o = e.depthStencilTexture.source.transient ? "discard" : "store";
			c = {
	...
	constructor(e) {
		super(e), this.adaptor = new we(), this.adaptor.init(e, this);
	}
};
z.extension = {
	type: [m.WebGPUSystem],
...
var H = class {
	constructor() {
		this.defaultState = new h(), this.defaultState.blend = !0;
	}
	contextChange(e) {
		this.gpu = e;
	}
	getColorTargets(e, t) {
		let n = V[e.blendMode] || V.normal, r = [], i = {
			format: "bgra8unorm",
			writeMask: 0,
			blend: n
		};
...
var Te = {
	...
	type: "compressed",
	upload(e, t, n, r = 0) {
		let i = e.pixelWidth, a = e.pixelHeight, o = U[e.format] || Ee;
...
var G = {
	...
	upload(e, t, n, r = 0) {
		...
		if (globalThis.HTMLImageElement && i instanceof HTMLImageElement) {
			let t = c.get().createCanvas(i.width, i.height);
	...
	constructor(t) {
		this._gpuSamplers = /* @__PURE__ */ Object.create(null), this._bindGroupHash = /* @__PURE__ */ Object.create(null), this._renderer = t, t.gc.addCollection(this, "_bindGroupHash", "hash"), this._managedTextures = new x({
			renderer: t,
			type: "resource",
	...
	_initSource(e) {
		...
		return e._gpuData[this._renderer.uid] = new je(o), this._managedTextures.add(e) && (e.on("update", this.onSourceUpdate, this), e.on("resize", this.onSourceResize, this), e.on("updateMipmaps", this.onUpdateMipmaps, this)), this.onSourceUpdate(e), o;
	}
	onSourceUpdate(e) {
	...
	onUpdateMipmaps(e) {
		this._mipmapGenerator ||= new Ae(this._gpu.device);
		let t = this.getGpuSource(e);
	...
	_createTextureBindGroup(e) {
		let t = e.source;
		return this._bindGroupHash[e.uid] = new s({
			0: t,
			1: t.style,
	...
	generateCanvas(e) {
		let t = this._renderer, n = t.gpu.device.createCommandEncoder(), r = c.get().createCanvas();
		r.width = e.source.pixelWidth, r.height = e.source.pixelHeight;
		let i = r.getContext("webgpu");
		return i.configure({
			device: t.gpu.device,
			usage: GPUTextureUsage.COPY_DST | GPUTextureUsage.COPY_SRC,
			format: c.get().getNavigator().gpu.getPreferredCanvasFormat(),
...
K.extension = {
	type: [m.WebGPUSystem],
	name: "texture"
}, K.uploadExtensions = /* @__PURE__ */ Object.create(null);
var q = K;
e.handleByMap(m.TextureUploaderWebGPU, q.uploadExtensions);
//#endregion
...
e.handleByNamedList(m.WebGPUSystem, Z), e.handleByNamedList(m.WebGPUPipes, Q), e.handleByNamedList(m.WebGPUPipesAdaptor, $), e.add(...X, ...Me, ...Ne);
...
//# sourceMappingURL=WebGPURenderer-XX9Fgv3K.js.map