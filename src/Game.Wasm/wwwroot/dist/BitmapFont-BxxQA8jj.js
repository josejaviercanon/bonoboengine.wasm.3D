import { M as e, N as t, O as n, P as r, R as i, T as a, j as o, k as s, p as c, v as l, x as u, y as d } from "./Geometry-DYsNE2Rs.js";
import { r as f, t as p } from "./canvasUtils-CPkv009i.js";
import { t as m } from "./Cache-Bz6DDblo.js";
import { c as h, i as g, n as _, r as v, t as y } from "./GraphicsContext-CzF_PbZG.js";
import { t as b } from "./CanvasPool-CMynuo7E.js";
...
var E = /* @__PURE__ */ new Set([10, 13]), te = /* @__PURE__ */ new Set([
	9,
	32,
	8192,
	8193,
	...
	8287,
	12288
]), ne = /* @__PURE__ */ new Set([9, 32]), re = /* @__PURE__ */ new Set([
	45,
	8208,
	8211,
	8212,
...
function D(e) {
	return typeof e == "string" && E.has(e.charCodeAt(0));
}
function O(e, t) {
...
function A(e) {
	return typeof e == "string" && re.has(e.charCodeAt(0));
}
function j(e) {
...
function P(e) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		n.push(i), A(i) && a && !O(a) && !D(a) && (t.push(n.join("")), n.length = 0);
	}
...
function L(e, t, n, r, i, a, o, s, c) {
	let l = ee(e, t);
	if (M(t.whiteSpace)) for (let e = 0; e < l.length; e++) {
		let t = l[e];
		l[e] = {
			text: t.text.replace(I, " "),
			style: t.style
		};
	}
	let u = [], d = [];
	for (let e of l) {
		let t = e.text.split(ie);
	...
	let f = n ? R(u, t, r, a, s, c) : u, p = [], m = [], h = [], g = [], _ = [], v = 0, y = t._fontString, b = o(y);
...
function R(e, t, n, r, i, a) {
	let { letterSpacing: o, whiteSpace: s, wordWrapWidth: c, breakWords: l } = t, u = j(s), d = c + o, f = {}, p = "", m = (e, t) => {
	...
	for (let t of e) {
		let e = oe(t), n = h.length, r = (t) => {
			...
			if (g(), s.length > 0) {
				let e = s[s.length - 1];
				e.text = N(e.text), e.text.length === 0 && s.pop();
			}
			h.push(s), s = [], c = 0, f = !1;
		};
		for (let t = 0; t < e.length; t++) {
			...
			if (u) {
				let e = O(n), t = p?.text[p.text.length - 1] ?? s[s.length - 1]?.text.slice(-1) ?? "", r = t ? O(t) : !1;
				if (e && r) continue;
			}
			let x = !y, S = x ? r(t) : b;
			if (S > d && x) {
				if (c > 0 && _(), l) {
					let e = o(t);
					for (let t = 0; t < e.length; t++) {
						let n = e[t].token, r = e[t].style, o = F(n, l, a, i);
						for (let e of o) {
							let t = m(e, r);
...
var se = { willReadFrequently: !0 };
function z(e, t, n, r, i) {
	let a = n[e];
	return typeof a != "number" && (a = i(e, t, r) + t, n[e] = a), a;
}
function ce(e, t, n, r, i, a, o) {
	let s = n.getContext("2d", se);
	s.font = t._fontString;
	let c = 0, l = "", u = [], d = /* @__PURE__ */ Object.create(null), { letterSpacing: f, whiteSpace: p } = t, m = j(p), h = M(p), g = !m, _ = t.wordWrapWidth + f, v = P(e);
	for (let e = 0; e < v.length; e++) {
		let n = v[e];
		if (D(n)) {
			if (!h) {
				u.push(N(l)), g = !m, l = "", c = 0;
				continue;
			}
			n = " ";
		}
		if (m) {
			let e = O(n), t = O(l[l.length - 1]);
			if (e && t) continue;
		}
		let p = z(n, f, d, s, r);
		if (p > _) {
			if (l !== "" && (u.push(N(l)), l = "", c = 0), i(n, t.breakWords)) {
				let e = F(n, t.breakWords, o, a);
				for (let t of e) {
					let e = z(t, f, d, s, r);
					e + c > _ && (u.push(N(l)), g = !1, l = "", c = 0), l += t, c += e;
				}
			} else l.length > 0 && (u.push(N(l)), l = "", c = 0), u.push(N(n)), g = !1, l = "", c = 0;
		} else p + c > _ && (g = !1, u.push(N(l)), l = "", c = 0), (l.length > 0 || !O(n) || g) && (l += n, c += p);
	}
	let y = N(l);
...
var B = { willReadFrequently: !0 }, V = class e {
	static get experimentalLetterSpacingSupported() {
		let t = e._experimentalLetterSpacingSupported;
		if (t === void 0) {
			let n = c.get().getCanvasRenderingContext2D().prototype;
	...
	static measureText(t = " ", n, r = e._canvas, i = n.wordWrap) {
		...
		if (C(n) && w(t)) {
			let r = L(t, n, i, e._context, e._measureText, e._measureTextAdvance, e.measureFont, e.canBreakChars, e.wordWrapSplit), o = new e(t, n, r.width, r.height, r.lines, r.lineWidths, r.lineHeight, r.maxLineWidth, r.fontProperties, {
	...
	static _wordWrap(t, n, r = e._canvas) {
		return ce(t, n, r, e._measureTextAdvance, e.canBreakWords, e.canBreakChars, e.wordWrapSplit);
	}
	...
	static get _canvas() {
		if (!e.__canvas) {
			...
			try {
				...
				if (n.getContext("2d", B)?.measureText) return e.__canvas = n, n;
				t = c.get().createCanvas();
			} catch {
				t = c.get().createCanvas();
			}
	...
	static get _context() {
		return e.__context ||= e._canvas.getContext("2d", B), e.__context;
	}
};
V.METRICS_STRING = "|ÉqÅ", V.BASELINE_SYMBOL = "M", V.BASELINE_MULTIPLIER = 1.4, V.HEIGHT_MULTIPLIER = 2, V.graphemeSegmenter = (() => {
	...
	return (e) => [...e];
})(), V.experimentalLetterSpacing = !1, V._fonts = {}, V._measurementCache = S(1e3);
var H = V, le = [
	"serif",
	"sans-serif",
	"monospace",
...
var W = 1e5;
function G(e, t, n, i = 0, a = 0, o = 0) {
	if (e.texture === u.WHITE && !e.fill) return d.shared.setValue(e.color).setAlpha(e.alpha ?? 1).toHexa();
	if (!e.fill) {
		let n = t.createPattern(e.texture.source.resource, "repeat"), i = e.matrix.copyTo(r.shared);
		return i.scale(e.texture.source.pixelWidth, e.texture.source.pixelHeight), n.setTransform(i), n;
	}
	...
	if (e.fill instanceof h) {
		let r = e.fill, s = r.type === "linear", c = r.textureSpace === "local", l = 1, u = 1;
		c && n && (l = n.width + i, u = n.height + i);
		let f, p = !1;
		if (s) {
			let { start: e, end: n } = r;
			f = t.createLinearGradient(e.x * l + a, e.y * u + o, n.x * l + a, n.y * u + o), p = Math.abs(n.x - e.x) < Math.abs((n.y - e.y) * .1);
		} else {
			let { center: e, innerRadius: n, outerCenter: i, outerRadius: s } = r;
			f = t.createRadialGradient(e.x * l + a, e.y * u + o, n * l, i.x * l + a, i.y * u + o, s * l);
		}
		if (p && c && n) {
			let e = n.lineHeight / u;
			for (let t = 0; t < n.lines.length; t++) {
				let a = (t * n.lineHeight + i / 2) / u;
				r.colorStops.forEach((t) => {
					let n = a + t.offset * e;
					n = Math.max(0, Math.min(1, n)), f.addColorStop(Math.floor(n * W) / W, d.shared.setValue(t.color).toHex());
				});
			}
		} else r.colorStops.forEach((e) => {
			f.addColorStop(e.offset, d.shared.setValue(e.color).toHex());
		});
		return f;
	}
	return l("FillStyle not recognised", e), "red";
}
//#endregion
//#region node_modules/pixi.js/lib/scene/text/TextStyle.mjs
var K = class e extends i {
	constructor(t = {}) {
		super(), this.uid = o("textStyle"), this._tick = 0, this._cachedFontString = null, ue(t), t instanceof e && (t = t._toObject());
		let n = {
			...e.defaultTextStyle,
			...t
		};
	...
	set fill(e) {
		e !== this._originalFill && (this._originalFill = e, this._isFillStyle(e) && (this._originalFill = this._createProxy({
			...
			this._fill = _({ ...this._originalFill }, y.defaultFillStyle);
		})), this._fill = _(e === 0 ? "black" : e, y.defaultFillStyle), this.update());
	}
	get stroke() {
	...
	set stroke(e) {
		e !== this._originalStroke && (this._originalStroke = e, this._isFillStyle(e) && (this._originalStroke = this._createProxy({
			...y.defaultStrokeStyle,
			...e
		}, () => {
			this._stroke = v({ ...this._originalStroke }, y.defaultStrokeStyle);
		})), this._stroke = v(e, y.defaultStrokeStyle), this.update());
	}
	get tagStyles() {
	...
	get _fontString() {
		return this._cachedFontString === null && (this._cachedFontString = U(this)), this._cachedFontString;
	}
	_toObject() {
		return {
			align: this.align,
	...
	_isFillStyle(e) {
		return (e ?? null) !== null && !(d.isColorLike(e) || e instanceof h || e instanceof g);
	}
};
K.defaultDropShadow = {
	alpha: 1,
...
function ue(e) {
	...
	if (t.strokeThickness !== void 0) {
		n(s, "strokeThickness is now a part of stroke");
		let r = t.stroke, i = {};
		if (d.isColorLike(r)) i.color = r;
		else if (r instanceof h || r instanceof g) i.fill = r;
	...
	if (Array.isArray(t.fillGradientStops)) {
		if (n(s, "gradient fill is now a fill pattern: `new FillGradient(...)`"), !Array.isArray(t.fill) || t.fill.length === 0) throw Error("Invalid fill value. Expected an array of colors for gradient fill.");
		t.fill.length !== t.fillGradientStops.length && l("The number of fill colors must match the number of fill gradient stops.");
		let r = new h({
			start: {
				x: 0,
				y: 0
			...
			textureSpace: "local"
		}), i = t.fillGradientStops.slice(), a = t.fill.map((e) => d.shared.setValue(e).toNumber());
		i.forEach((e, t) => {
...
var J = class extends i {
	...
	get font() {
		return n(s, "BitmapFont.font is deprecated, please use BitmapFont.fontFamily instead."), this.fontFamily;
	}
	get pageTextures() {
		return n(s, "BitmapFont.pageTextures is deprecated, please use BitmapFont.pages instead."), this.pages;
	}
	get size() {
		return n(s, "BitmapFont.size is deprecated, please use BitmapFont.fontMetrics.fontSize instead."), this.fontMetrics.fontSize;
	}
	get distanceFieldRange() {
		return n(s, "BitmapFont.distanceFieldRange is deprecated, please use BitmapFont.distanceField.range instead."), this.distanceField.range;
	}
	get distanceFieldType() {
		return n(s, "BitmapFont.distanceFieldType is deprecated, please use BitmapFont.distanceField.type instead."), this.distanceField.type;
	}
	destroy(e = !1) {
	...
	constructor(e) {
		...
		let r = n.style.clone();
		n.overrideFill && (r._fill.color = 16777215, r._fill.alpha = 1, r._fill.texture = u.WHITE, r._fill.fill = null), this.applyFillAsTint = n.overrideFill;
		let i = r.fontSize;
		r.fontSize = this.baseMeasurementFontSize;
		let o = U(r);
		n.overrideSize ? (r._stroke && (r._stroke.width *= this.baseRenderedFontSize / i), r.dropShadow && (r.dropShadow.blur *= this.baseRenderedFontSize / i, r.dropShadow.distance *= this.baseRenderedFontSize / i)) : r.fontSize = this.baseRenderedFontSize = i, this._style = r, this._skipKerning = n.skipKerning ?? !1, this.resolution = n.resolution ?? 1, this._padding = n.padding ?? 4, n.textureStyle && (this._textureStyle = n.textureStyle instanceof a ? n.textureStyle : new a(n.textureStyle)), this.fontMetrics = H.measureFont(o), this.lineHeight = r.lineHeight || this.fontMetrics.fontSize || r.fontSize;
	}
	ensureCharacters(t) {
		let n = H.graphemeSegmenter(t).filter((e) => !this._currentChars.includes(e)).filter((e, t, n) => n.indexOf(e) === t);
		if (!n.length) return;
		this._currentChars = [...this._currentChars, ...n];
		let r;
		r = this._currentPageIndex === -1 ? this._nextPage() : this.pages[this._currentPageIndex];
		let { canvas: i, context: a } = r.canvasAndContext, o = r.texture.source, s = this._style, c = this._currentX, l = this._currentY, d = this._currentMaxCharHeight, f = this.baseRenderedFontSize / this.baseMeasurementFontSize, p = (s.dropShadow?.distance ?? 0) + (s._stroke?.width ?? 0), m = this._padding + p, h = !1, g = i.width / this.resolution, _ = i.height / this.resolution;
		for (let t = 0; t < n.length; t++) {
			let r = n[t], p = H.measureText(r, s, i, !1);
			p.lineHeight = p.height;
			let v = p.width * f, y = Math.ceil((s.fontStyle === "italic" ? 2 : 1) * v), b = p.height * f, x = y + m * 2, S = b + m * 2;
			if (h = !1, r !== "\n" && r !== "\r" && r !== "	" && r !== " " && (h = !0, d = Math.ceil(Math.max(S, d))), c + x > g && (l += d, d = S, c = 0, l + d > _)) {
				o.update();
				let e = this._nextPage();
				i = e.canvasAndContext.canvas, a = e.canvasAndContext.context, o = e.texture.source, c = 0, l = 0, d = 0;
			}
			...
			if (this.chars[r] = {
				...
				this._drawGlyph(a, p, c + m, l + m, f, s);
				let t = o.width * f, n = o.height * f, i = new e(c / t * o.width, l / n * o.height, x / t * o.width, S / n * o.height);
				this.chars[r].texture = new u({
					source: o,
					frame: i
				}), c += Math.ceil(x);
			}
		}
		o.update(), this._currentX = c, this._currentY = l, this._currentMaxCharHeight = d, this._skipKerning || this._applyKerning(n, a, f);
	}
	get pageTextures() {
		return n(s, "BitmapFont.pageTextures is deprecated, please use BitmapFont.pages instead."), this.pages;
	}
	...
	_nextPage() {
		...
		let e = this.resolution, t = b.getOptimalCanvasAndContext(this._textureSize, this._textureSize, e);
		this._setupContext(t.context, this._style, e);
		let n = e * (this.baseRenderedFontSize / this.baseMeasurementFontSize), r = new u({ source: new f({
			resource: t.canvas,
			resolution: n,
	...
	_setupContext(e, t, n) {
		t.fontSize = this.baseRenderedFontSize, e.scale(n, n), e.font = U(t), t.fontSize = this.baseMeasurementFontSize, e.textBaseline = t.textBaseline;
		let r = t._stroke, i = r?.width ?? 0;
		if (r && (e.lineWidth = i, e.lineJoin = r.join, e.miterLimit = r.miterLimit, e.strokeStyle = G(r, e)), t._fill && (e.fillStyle = G(t._fill, e)), t.dropShadow) {
			let r = t.dropShadow, i = d.shared.setValue(r.color).toArray(), a = r.blur * n, o = r.distance * n;
	...
	destroy() {
		...
		for (let e = 0; e < this.pages.length; e++) {
			...
			b.returnCanvasAndContext(t), n.destroy(!0);
		}
		this.pages = null;
	}
};
...
function Z(e, t, n, r) {
	...
	let a = i.lines[0], o = null, s = !0, c = {
		...
		positions: [],
		chars: []
	}, l = n.baseMeasurementFontSize / t.fontSize, u = t.letterSpacing * l, d = t.wordWrapWidth * l, f = t.lineHeight ? t.lineHeight * l : n.lineHeight, p = t.wordWrap && t.breakWords, m = j(t.whiteSpace), h = M(t.whiteSpace);
	if (m || h) {
		let t = [], n = m;
		for (let r = 0; r < e.length; r++) {
			let i = e[r];
	...
	let g = (e) => {
		...
		if (r) {
			let t = a.chars[e];
			for (; k(t);) a.width -= n.chars[t].xAdvance, a.spacesIndex.pop(), t = a.chars[--e];
		}
	...
	for (let r = 0; r < e.length + 1; r++) {
		...
		if (/(?:\s)/.test(i) || i === "\r" || i === "\n" || l) {
			...
			p && v(c.width + n) && (s || _(), g(c), _()), c.positions[c.index++] = c.width + e, c.chars.push(i), c.width += n, A(i) && (!s && t.wordWrap && v(a.width + c.width) && _(), g(c));
		}
		o = i;
	}
	return _(), t.align === "center" ? de(i) : t.align === "right" ? fe(i) : t.align === "justify" && pe(i), i;
}
function de(e) {
...
var Q = 0, $ = new class {
	...
	getFont(e, t) {
		...
		if (t._fill.fill && !t._stroke ? (n += t._fill.fill.styleKey, r = !1) : (t._stroke || t.dropShadow) && (n = `${t.styleKey}-bitmap`, r = !1), n += `-${t.fontStyle}`, n += `-${t.fontVariant}`, n += `-${t.fontWeight}`, !m.has(n)) {
			...
			Q++, Q > 50 && l("BitmapText", `You have dynamically created ${Q} bitmap fonts, this can be inefficient. Try pre installing your font styles using \`BitmapFont.install({name:"style1", style})\``), i.once("destroy", () => {
				Q--, m.remove(n);
			}), m.set(n, i);
		}
		let i = m.get(n);
	...
	getLayout(e, t, n = !0) {
		...
		let a = Z(H.graphemeSegmenter(e), t, r, n);
	...
	install(...e) {
		...
		}, n(s, "BitmapFontManager.install(name, style, options) is deprecated, use BitmapFontManager.install({name, style, ...options})"));
		let r = t?.name;
		...
		let i = t.style, a = i instanceof q ? i : new q(i), o = new X({
			style: a,
		...
		return o.ensureCharacters(c.join("")), m.set(`${r}-bitmap`, o), o.once("destroy", () => m.remove(`${r}-bitmap`)), o;
	}
	uninstall(e) {
		let t = `${e}-bitmap`, n = m.get(t);
		n && n.destroy();
	}
	...
	constructor(n, r) {
		super();
		let { textures: i, data: a } = n;
		Object.keys(a.pages).forEach((e) => {
			let t = a.pages[parseInt(e, 10)], n = i[t.id];
			this.pages.push({ texture: n });
		}), Object.keys(a.chars).forEach((n) => {
			let r = a.chars[n], { frame: o, source: s, rotate: c } = i[r.page], l = t.transformRectCoords(r, o, c, new e()), d = new u({
				frame: l,
				orig: new e(0, 0, r.width, r.height),
				source: s,
				rotate: c
			});
			this.chars[n] = {
...
//#endregion
export { G as a, q as i, $ as n, U as o, Z as r, H as s, he as t };

//# sourceMappingURL=BitmapFont-BxxQA8jj.js.map