import { B as e, F as t, R as n, v as r, z as i } from "./Geometry-DYsNE2Rs.js";
import { c as a, i as o, r as s, y as c } from "./Filter-BsE1se_H.js";
import "./getPo2TextureFromSource-BRMwBqWT.js";
import "./init-Ts9xUJLu.js";
...
var l = class {
	...
	_attachObserver() {
		...
		}), this._observer.observe(this._canvas)) : this._tickerAttached || s.shared.add(this.updateTranslation, this, o.HIGH);
	}
	destroy() {
		this._observer ? (this._observer.disconnect(), this._observer = null) : this._tickerAttached && s.shared.remove(this.updateTranslation), this._domElement = null, this._renderer = null, this._canvas = null, this._tickerAttached = !1, this._lastTransform = "", this._lastScaleX = null, this._lastScaleY = null;
	}
}, u = class e {
	constructor(n) {
...
var U = new class {
	...
	addTickerListener() {
		this._tickerAdded || !this.domElement || (s.system.add(this._tickerUpdate, this, o.INTERACTION), this._tickerAdded = !0);
	}
	removeTickerListener() {
		this._tickerAdded &&= (s.system.remove(this._tickerUpdate, this), !1);
	}
	pointerMoved() {
		this._didMove = !0;
	}
...
var q = 2048, J = new t(), Y = new t(), X = class {
	constructor(e) {
	...
	hitTest(e, t) {
		U.pauseUpdate = !0;
		let n = this._isPointerMoveEvent && this.enableGlobalMoveEvents ? "hitTestMoveRecursive" : "hitTestRecursive", r = this[n](this.rootTarget, this.rootTarget.eventMode, J.set(e, t), this.hitTestFn, this.hitPruneFn);
		return r && r[0];
	}
	propagate(e, t) {
		if (!e.target) return;
	...
	propagationPath(e) {
		let t = [e];
		for (let n = 0; n < q && e !== this.rootTarget && e.parent; n++) {
	...
	hitTestMoveRecursive(e, t, n, r, i, a = !1) {
		...
		if ((e.eventMode === "dynamic" || t === "dynamic") && (U.pauseUpdate = !1), e.interactiveChildren && e.children) {
			let s = e.children;
	...
	hitPruneFn(e, t) {
		if (e.hitArea && (e.worldTransform.applyInverse(t, Y), !e.hitArea.contains(Y.x, Y.y))) return !0;
	...
	hitTestFn(e, t) {
		return e.hitArea ? !0 : e?.containsPoint ? (e.worldTransform.applyInverse(t, Y), e.containsPoint(Y)) : !1;
	}
	notifyTarget(e, t) {
	...
	copyMouseData(e, t) {
		e instanceof W && t instanceof W && (t.altKey = e.altKey, t.button = e.button, t.buttons = e.buttons, t.client.copyFrom(e.client), t.ctrlKey = e.ctrlKey, t.metaKey = e.metaKey, t.movement.copyFrom(e.movement), t.screen.copyFrom(e.screen), t.shiftKey = e.shiftKey, t.global.copyFrom(e.global));
	}
	copyData(e, t) {
	...
	constructor(t) {
		this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = t, this.rootBoundary = new X(null), U.init(this), this.autoPreventDefault = !0, this._eventsAdded = !1, this._rootPointerEvent = new G(null), this._rootWheelEvent = new K(null), this.cursorStyles = {
			default: "inherit",
			pointer: "pointer"
	...
	destroy() {
		U.destroy(), this.setTargetElement(null), this.renderer = null, this._currentCursor = null;
	}
	setCursor(e) {
		e ||= "default";
		let t = !0;
	...
	_onPointerMove(e) {
		...
		this.rootBoundary.rootTarget = this.renderer.lastObjectRendered, U.pointerMoved();
		let t = this._normalizeToPointerData(e);
		for (let e = 0, n = t.length; e < n; e++) {
	...
	setTargetElement(e) {
		this._removeEvents(), this.domElement = e, U.domElement = e, this._addEvents();
	}
	_addEvents() {
	...
	_normalizeToPointerData(e) {
		...
		if (this.supportsTouchEvents && e instanceof TouchEvent) for (let n = 0, r = e.changedTouches.length; n < r; n++) {
			...
			let n = e;
			n.isPrimary === void 0 && (n.isPrimary = !0), n.width === void 0 && (n.width = 1), n.height === void 0 && (n.height = 1), n.tiltX === void 0 && (n.tiltX = 0), n.tiltY === void 0 && (n.tiltY = 0), n.pointerType === void 0 && (n.pointerType = "mouse"), n.pointerId === void 0 && (n.pointerId = Z), n.pressure === void 0 && (n.pressure = .5), n.twist === void 0 && (n.twist = 0), n.tangentialPressure === void 0 && (n.tangentialPressure = 0), n.isNormalized = !0, t.push(n);
		} else t.push(e);
		return t;
	}
	...
	_bootstrapEvent(e, t) {
		return e.originalEvent = null, e.nativeEvent = t, e.pointerId = t.pointerId, e.width = t.width, e.height = t.height, e.isPrimary = t.isPrimary, e.pointerType = t.pointerType, e.pressure = t.pressure, e.tangentialPressure = t.tangentialPressure, e.tiltX = t.tiltX, e.tiltY = t.tiltY, e.twist = t.twist, this._transferMouseData(e, t), this.mapPositionToPoint(e.screen, t.clientX, t.clientY), e.global.copyFrom(e.screen), e.offset.copyFrom(e.screen), e.isTrusted = t.isTrusted, e.type === "pointerleave" && (e.type = "pointerout"), e.type.startsWith("mouse") && (e.type = e.type.replace("mouse", "pointer")), e.type.startsWith("touch") && (e.type = ee[e.type] || e.type), e;
	}
...
var $ = Q;
e.add(B), e.mixin(a, V), e.add(H), e.add($), e.mixin(a, {
	onclick: null,
	onmousedown: null,
	onmouseenter: null,
	onmouseleave: null,
...
//# sourceMappingURL=browserAll-BpxEQdIZ.js.map