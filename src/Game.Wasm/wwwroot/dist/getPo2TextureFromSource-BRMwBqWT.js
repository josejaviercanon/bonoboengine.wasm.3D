import { B as e, C as t, M as n, b as r, p as i, v as a, w as o, x as s, z as c } from "./Geometry-DYsNE2Rs.js";
import { _ as l, a as u, c as d, d as f, f as p, g as m, h, o as g, r as _ } from "./Filter-BsE1se_H.js";
import { r as v } from "./canvasUtils-CPkv009i.js";
import { n as y, t as b } from "./Cache-Bz6DDblo.js";
//#region node_modules/pixi.js/lib/rendering/mask/utils/addMaskBounds.mjs
var x = new r();
function S(e, t, n) {
	let r = x;
	e.measurable = !0, h(e, n, r), t.addBoundsMask(r), e.measurable = !1;
}
//#endregion
...
function C(e, t, n) {
	let r = m.get();
	e.measurable = !0;
	let i = l.get().identity(), a = w(e, n, i);
	p(e, r, a), e.measurable = !1, t.addBoundsMask(r), l.return(i), m.return(r);
}
function w(e, t, n) {
	return e ? (e !== t && (w(e.parent, t, n), e.updateLocalTransform(), n.append(e.localTransform)), n) : (a("Mask bounds, renderable is not inside the root container"), n);
}
//#endregion
...
var T = class {
	...
	init(e) {
		this.mask = e, this.renderMaskToTexture = !(e instanceof g), this.mask.renderable = this.renderMaskToTexture, this.mask.includeInBuild = !this.renderMaskToTexture, this.mask.measurable = !1;
	}
	reset() {
		this.mask !== null && (this.mask.measurable = !0, this.mask = null);
	}
	addBounds(e, t) {
		this.inverse || S(this.mask, e, t);
	}
	addLocalBounds(e, t) {
		C(this.mask, e, t);
	}
...
async function k() {
	return O ??= (async () => {
		...
		return e.readPixels(0, 0, 1, 1, e.RGBA, e.UNSIGNED_BYTE, a), e.deleteFramebuffer(r), e.deleteTexture(n), e.getExtension("WEBGL_lose_context")?.loseContext(), a[0] <= a[3] ? "premultiplied-alpha" : "premultiply-alpha-on-upload";
	})(), O;
}
//#endregion
...
var A = class e extends o {
	...
	updateFrame() {
		if (!this.destroyed) {
			if (this._updateFPS) {
				let e = _.shared.elapsedMS * this.resource.playbackRate;
	...
	_configureAutoUpdate() {
		this._autoUpdate && this._isSourcePlaying() ? !this._updateFPS && this.resource.requestVideoFrameCallback ? (this._isConnectedToTicker && (_.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0), this._videoFrameRequestCallbackHandle === null && (this._videoFrameRequestCallbackHandle = this.resource.requestVideoFrameCallback(this._videoFrameRequestCallback))) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker || (_.shared.add(this.updateFrame, this), this._isConnectedToTicker = !0, this._msToNextUpdate = 0)) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker && (_.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0));
	}
	static test(e) {
		return globalThis.HTMLVideoElement && e instanceof HTMLVideoElement;
	}
};
A.extension = c.TextureSource, A.defaultOptions = {
	...o.defaultOptions,
	autoLoad: !0,
	autoPlay: !0,
	updateFPS: 0,
...
var j = A, M = [];
e.handleByList(c.TextureSource, M);
function N(e = {}) {
...
function P(e = {}, t = !1) {
	...
	if (!t && b.has(r)) return b.get(r);
	let a = new s({ source: N(i) });
	return a.on("destroy", () => {
		b.has(r) && b.remove(r);
	}), t || b.set(r, a), a;
}
function F(e, t = !1) {
	return typeof e == "string" ? b.get(e) : e instanceof o ? new s({ source: e }) : P(e, t);
}
//#endregion
//#region node_modules/pixi.js/lib/rendering/init.mjs
s.from = F, o.from = N, e.add(T, E, D, j, v, u, t);
//#endregion
...
var H = {
	...
	toAbsolute(e, t, n) {
		...
		let r = R(this.toPosix(t ?? i.get().getBaseUrl())), a = R(this.toPosix(n ?? this.rootname(r)));
		return e = this.toPosix(e), e.startsWith("/") ? H.join(a, e.slice(1)) : this.isAbsolute(e) ? e : this.join(r, e);
	},
	normalize(e) {
...
var G = (e) => !Array.isArray(e), K = class {
	...
	getAlias(e) {
		let { alias: t, src: n } = e;
		return y(t || n, (e) => typeof e == "string" ? e : Array.isArray(e) ? e.map((e) => e?.src ?? e) : e?.src ? e.src : e, !0);
	}
	removeAlias(e, t) {
		this._assetMap[e] && (t && t !== this._resolverHash[e] || (delete this._resolverHash[e], delete this._assetMap[e]));
	}
	addManifest(e) {
		this._manifest && a("[Resolver] Manifest already exists, this will be overwritten"), this._manifest = e, e.bundles.forEach((e) => {
	...
	add(e) {
		...
		let n = (e) => {
			this.hasKey(e) && a(`[Resolver] already has key: ${e} overwriting`);
		};
		y(t).forEach((e) => {
			let { src: t } = e, { data: r, format: i, loadParser: a, parser: o } = e, s = y(t).map((e) => typeof e == "string" ? W(e) : Array.isArray(e) ? e : [e]), c = this.getAlias(e);
...
var J = (e, t) => {
	...
	_processFrames(t, r = !1) {
		let i = t, a = r ? Infinity : e.BATCH_SIZE;
		for (; i - t < a && i < this._frameKeys.length;) {
			let e = this._frameKeys[i], t = this._frames[e], r = t.frame;
			if (r) {
				let i = null, a = null, o = t.trimmed !== !1 && t.sourceSize ? t.sourceSize : t.frame, c = new n(0, 0, Math.floor(o.w) / this.resolution, Math.floor(o.h) / this.resolution);
				i = t.rotated ? new n(Math.floor(r.x) / this.resolution, Math.floor(r.y) / this.resolution, Math.floor(r.h) / this.resolution, Math.floor(r.w) / this.resolution) : new n(Math.floor(r.x) / this.resolution, Math.floor(r.y) / this.resolution, Math.floor(r.w) / this.resolution, Math.floor(r.h) / this.resolution), t.trimmed !== !1 && t.spriteSourceSize && (a = new n(Math.floor(t.spriteSourceSize.x) / this.resolution, Math.floor(t.spriteSourceSize.y) / this.resolution, Math.floor(r.w) / this.resolution, Math.floor(r.h) / this.resolution)), this.textures[e] = new s({
...
var $ = {
	...
	loader: {
		...
		async parse(e, t, n) {
			let { texture: r, imageFilename: i, textureOptions: a, cachePrefix: o } = t?.data ?? {}, c = H.dirname(t.src);
			c && c.lastIndexOf("/") !== c.length - 1 && (c += "/");
			let l;
			if (r instanceof s) l = r;
			else {
				let r = J(c + (i ?? e.meta.image), t.src);
				l = (await n.load([{
					src: r,
					data: a
				}]))[r];
			...
			if (Array.isArray(d)) {
				...
				for (let r of d) {
					...
					let i = c + r;
					t.data?.ignoreMultiPack || (i = J(i, t.src), e.push(n.load({
						src: i,
						data: {
							textureOptions: a,
							ignoreMultiPack: !0
...
function te(e, t, n, r, i = !1) {
	...
	let o = f.getOptimalTexture(a.width, a.height, r, !1, i);
...
//#endregion
export { H as a, k as c, G as i, J as n, I as o, K as r, j as s, te as t };

//# sourceMappingURL=getPo2TextureFromSource-BRMwBqWT.js.map