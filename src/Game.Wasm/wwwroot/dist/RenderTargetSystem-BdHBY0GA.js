import { B as e, F as t, M as n, O as r, P as i, R as a, S as o, T as s, _ as c, a as l, b as u, c as d, g as f, j as p, k as m, o as h, p as g, s as ee, u as te, v as ne, w as _, x as v, y, z as b } from "./Geometry-DYsNE2Rs.js";
import { a as x, c as S, d as C, f as re, h as ie, m as ae, n as oe, o as se, r as w, t as ce, u as le, v as ue } from "./Filter-BsE1se_H.js";
import { m as T, n as E } from "./GCManagedHash-CXwB9kU7.js";
//#region node_modules/pixi.js/lib/environment/autoDetectEnvironment.mjs
var D = [];
e.handleByNamedList(b.Environment, D);
async function de(e) {
	if (!e) for (let e = 0; e < D.length; e++) {
		let t = D[e];
		if (t.value.test()) {
			await t.value.load();
			return;
...
function fe() {
	...
	try {
		O = Function("param1", "param2", "param3", "return param1[param2] === param3;")({ a: "b" }, "a", "b") === !0;
	} catch {
		O = !1;
	}
	return O;
...
var k = /* @__PURE__ */ ((e) => (e[e.NONE = 0] = "NONE", e[e.COLOR = 16384] = "COLOR", e[e.STENCIL = 1024] = "STENCIL", e[e.DEPTH = 256] = "DEPTH", e[e.COLOR_DEPTH = 16640] = "COLOR_DEPTH", e[e.COLOR_STENCIL = 17408] = "COLOR_STENCIL", e[e.DEPTH_STENCIL = 1280] = "DEPTH_STENCIL", e[e.ALL = 17664] = "ALL", e))(k || {}), A = class {
	constructor(e) {
	...
	constructor(e) {
		super(), this.tick = 0, this.uid = p("renderer"), this.runners = /* @__PURE__ */ Object.create(null), this.renderPipes = /* @__PURE__ */ Object.create(null), this._initOptions = {}, this._systemsHash = /* @__PURE__ */ Object.create(null), this.type = e.type, this.name = e.name, this.config = e;
		let t = [...pe, ...this.config.runners ?? []];
		this._addRunners(...t), this._unsafeEvalCheck();
	}
	async init(t = {}) {
		await de(t.skipExtensionImports === !0 || t.manageImports === !1), this._addSystems(this.config.systems), this._addPipes(this.config.renderPipes, this.config.renderPipeAdaptors);
	...
	clear(e = {}) {
		...
		y.shared.setValue(r ?? this.background.colorRgba), t.renderTarget.clear(i, n, y.shared.toArray(), a ?? 0, o ?? 0);
	}
	get resolution() {
	...
	destroy(e = !1) {
		this.runners.destroy.items.reverse(), this.runners.destroy.emit(e), (e === !0 || typeof e == "object" && e.releaseGlobalResources) && c.release(), Object.values(this.runners).forEach((e) => {
			e.destroy();
	...
	_unsafeEvalCheck() {
		if (!fe()) throw Error("Current environment does not allow unsafe-eval, please use pixi.js/unsafe-eval module to enable support.");
	}
	resetState() {
...
var me = j, M = "8.19.0", he = class {
	static init() {
		globalThis.__PIXI_APP_INIT__?.(this, M);
	}
	static destroy() {}
};
he.extension = b.Application;
var ge = class {
	constructor(e) {
		this._renderer = e;
	}
	init() {
		globalThis.__PIXI_RENDERER_INIT__?.(this._renderer, M);
	}
	destroy() {
		this._renderer = null;
	}
...
var N = class {
	...
	constructor(e, t) {
		this.state = oe.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, this._adaptor.init?.(this);
	}
	...
	buildStart(e) {
		...
		t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default || (t.default = new E({ maxTextures: this.renderer.limits.maxBatchableTextures }))), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
...
var F = P;
e.handleByMap(b.Batcher, F._availableBatchers), e.add(E);
//#endregion
//#region node_modules/pixi.js/lib/rendering/mask/alpha/AlphaMaskPipe.mjs
var Se = new u(), Ce = class extends ue {
	constructor() {
		super(), this.filters = [new be({
			sprite: new se(v.EMPTY),
			inverse: !1,
			resolution: "inherit",
			antialias: "inherit"
		})];
	...
	execute(e) {
		...
		if (e.action === "pushMaskBegin") {
			...
			if (r.inverse = e.inverse, r.channel = e.mask.channel, n) {
				...
				let n = ie(e.mask.mask, !0, Se);
				e.mask.mask.measurable = !1, n.ceil();
				let i = t.renderTarget.renderTarget.colorTexture.source, a = C.getOptimalTexture(n.width, n.height, i._resolution, i.antialias);
			...
			n && (t.type === l.WEBGL && t.renderTarget.finishRenderPass(), t.renderTarget.pop(), t.globalUniforms.pop()), t.filter.push({
				renderPipeId: "filter",
				action: "pushFilter",
			...
			n && C.returnTexture(e.filterTexture), f.return(e.filterEffect);
		}
	}
	destroy() {
...
var Te = class {
	...
	execute(e) {
		...
		e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(), r.stencil.setStencilMode(T.RENDERING_MASK_ADD, a), a++, r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(T.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(T.MASK_ACTIVE, a), r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0), a === 0 ? (r.renderTarget.clear(null, k.STENCIL), r.stencil.setStencilMode(T.DISABLED, a)) : r.stencil.setStencilMode(T.RENDERING_MASK_REMOVE, a), a--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(T.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(T.MASK_ACTIVE, a), r.colorMask.setMask(15)), this._maskStackHash[i] = a;
	}
	destroy() {
...
var z = class {
	...
	_addRenderableDirect(e, t) {
		this._renderer.renderPipes.batch.break(t), e._batchableRenderGroup &&= (f.return(e._batchableRenderGroup), null), t.add(e);
	}
	_addRenderableCacheAsTexture(e, t) {
		let n = e._batchableRenderGroup ??= f.get(N);
	...
	_executeCacheAsTexture(e) {
		if (e.textureNeedsUpdate) {
			...
			let t = new i().translate(-e._textureBounds.x, -e._textureBounds.y);
			...
			}), R(e, this._renderer.renderPipes), this._renderer.renderTarget.finishRenderPass(), this._renderer.renderTarget.pop(), this._renderer.globalUniforms.pop();
		}
	...
	_executeDirect(e) {
		...
		}), R(e, this._renderer.renderPipes), this._renderer.globalUniforms.pop();
	}
};
z.extension = {
	type: [
...
var H = class {
	...
	setBlendMode(e, t, n) {
		let r = e instanceof le;
		if (this._activeBlendMode === t) {
			this._isAdvanced && e && !r && this._renderableList?.push(e);
			return;
		}
		this._isAdvanced && this._endAdvancedBlendMode(n), this._activeBlendMode = t, e && (this._isAdvanced = !!V[t], this._isAdvanced && this._beginAdvancedBlendMode(e, n));
	}
	_beginAdvancedBlendMode(e, t) {
		this._renderer.renderPipes.batch.break(t);
		let n = this._activeBlendMode;
		if (!V[n]) {
			ne(`Unable to assign BlendMode: '${n}'. You may want to include: import 'pixi.js/advanced-blend-modes'`);
			return;
		}
		let r = this._ensureFilterEffect(n), i = e instanceof le, a = {
			renderPipeId: "filter",
			action: "pushFilter",
			filterEffect: r,
	...
	_ensureFilterEffect(e) {
		...
		return t || (t = this._filterHash[e] = new ue(), t.filters = [new V[e]()]), t;
	}
...
function Oe(e, t = !1) {
	...
	for (let t in n) {
		...
		for (let t = 0; t < s; t++) {
			let n = o[t];
			n.parentRenderGroup === e && n.relativeRenderGroupDepth === i && Ae(n, r, 0);
		}
		U(o, s), a.index = 0;
	}
	if (t) for (let n = 0; n < e.renderGroupChildren.length; n++) Oe(e.renderGroupChildren[n], t);
}
function ke(e) {
	let t = e.root, n;
	if (e.renderGroupParent) {
		let r = e.renderGroupParent;
		e.worldTransform.appendFrom(t.relativeGroupTransform, r.worldTransform), e.worldColor = ae(t.groupColor, r.worldColor), n = t.groupAlpha * r.worldAlpha;
...
function Ae(e, t, n) {
	...
	let i = e.parent;
	if (i && !i.renderGroup ? (n |= e._updateFlags, e.relativeGroupTransform.appendFrom(r, i.relativeGroupTransform), n & De && je(e, i, n)) : (n = e._updateFlags, e.relativeGroupTransform.copyFrom(r), n & De && je(e, Ee, n)), !e.renderGroup) {
		let r = e.children, i = r.length;
		for (let e = 0; e < i; e++) Ae(r[e], t, n);
...
function je(e, t, n) {
	if (n & 1) {
		e.groupColor = ae(e.localColor, t.groupColor);
...
var Ne = new i(), Pe = class {
	...
	render({ container: e, transform: t }) {
		...
		}), R(e.renderGroup, o), o.uniformBatch && o.uniformBatch.renderEnd(), t && e.renderGroup.localTransform.copyFrom(a), e.parent = n, e.renderGroup.renderGroupParent = r;
	}
	destroy() {
		this._renderer = null;
	}
	_updateCachedRenderGroups(e, t) {
		...
		if (e.invalidateMatrices(), e.isCachedAsTexture) {
			if (e.textureNeedsUpdate) {
				...
				t.ceil(), e.texture && C.returnTexture(e.texture, !0);
				let c = C.getOptimalTexture(t.width, t.height, r, i);
				c._source.style = new s({ scaleMode: a }), e.texture = c, e._textureBounds ||= new u(), e._textureBounds.copyFrom(t), o !== e.texture && e.renderGroupParent && (e.renderGroupParent.structureDidChange = !0);
			}
		} else e.texture &&= (C.returnTexture(e.texture, !0), null);
	}
	_updateRenderGroups(e) {
		let t = this._renderer, n = t.renderPipes;
		if (e.runOnRender(t), e.instructionSet.renderPipes = n, e.structureDidChange ? U(e.childrenRenderablesToUpdate.list, 0) : Me(e, n), Oe(e), e.structureDidChange ? (e.structureDidChange = !1, this._buildInstructions(e, t)) : this._updateRenderables(e), e.childrenRenderablesToUpdate.index = 0, t.renderPipes.batch.upload(e.instructionSet), !(e.isCachedAsTexture && !e.textureNeedsUpdate)) for (let t = 0; t < e.renderGroupChildren.length; t++) this._updateRenderGroups(e.renderGroupChildren[t]);
	}
...
var W = class e {
	...
	set color(e) {
		y.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && ne("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."), this._backgroundColor.setValue(e);
	}
	get alpha() {
...
var Fe = W, G = {
	...
	_normalizeOptions(e, t = {}) {
		return e instanceof S || e instanceof v ? {
			target: e,
			...t
		} : {
			...t,
	...
	async base64(t) {
		...
		if (i.toDataURL !== void 0) return i.toDataURL(G[n], r);
	...
	canvas(e) {
		...
		if (t instanceof v) return n.texture.generateCanvas(t);
		let r = n.textureGenerator.generateTexture(e), i = n.texture.generateCanvas(r);
		return r.destroy(!0), i;
	}
	pixels(e) {
		e = this._normalizeOptions(e);
		let t = e.target, n = this._renderer, r = t instanceof v ? t : n.textureGenerator.generateTexture(e), i = n.texture.getPixels(r);
		return t instanceof S && r.destroy(!0), i;
	}
	texture(e) {
		return e = this._normalizeOptions(e), e.target instanceof v ? e.target : this._renderer.textureGenerator.generateTexture(e);
	}
	download(e) {
		e = this._normalizeOptions(e);
...
K.extension = {
	...
	name: "extract"
}, K.defaultImageOptions = {
	format: "png",
	quality: 1
};
var Ie = K, Le = class e extends v {
	static create(t) {
	...
	generateTexture(e) {
		...
		a = a ? Array.isArray(a) && a.length === 4 ? a : y.shared.setValue(a).toArray() : Be;
		let o = e.frame?.copyTo(Re) || re(r, ze).rectangle, s = e.defaultAnchor && { defaultAnchor: e.defaultAnchor };
...
var We = q, Ge = class {
	...
	bind({ size: e, projectionMatrix: n, worldTransformMatrix: r, worldColor: a, offset: o }) {
		let s = this._renderer.renderTarget.renderTarget, c = this._stackIndex ? this._globalUniformDataStack[this._stackIndex - 1] : {
			projectionData: s,
			...
			worldColor: a || c.worldColor,
			offset: o || c.offset,
			bindGroup: null
		}, u = this._uniformsPool.pop() || this._createUniforms();
		this._activeUniforms.push(u);
		let d = u.uniforms;
		d.uProjectionMatrix = l.projectionMatrix, d.uResolution = l.resolution, d.uWorldTransformMatrix.copyFrom(l.worldTransformMatrix), d.uWorldTransformMatrix.tx -= l.offset.x, d.uWorldTransformMatrix.ty -= l.offset.y, xe(l.worldColor, d.uWorldColorAlpha, 0), u.update();
		let f;
		this._renderer.renderPipes.uniformBatch ? f = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(u, !1) : (f = this._bindGroupPool.pop() || new h(), this._activeBindGroups.push(f), f.setResource(u, 0)), l.bindGroup = f, this._currentGlobalUniformData = l;
	}
	push(e) {
...
var Ke = 1, qe = class {
	...
	init() {
		w.system.add(this._update, this);
	}
	repeat(e, t, n = !0) {
		let r = Ke++, i = 0;
	...
	destroy() {
		w.system.remove(this._update, this), this._tasks.length = 0;
	}
};
qe.extension = {
	type: [
...
function Ye(e) {
	if (!Je) {
		if (g.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
			let t = [
				`%c  %c  %c  %c  %c PixiJS %c v${M} (${e}) http://www.pixijs.com/
...
`,
		...
		} else globalThis.console && globalThis.console.log(`PixiJS ${M} - ${e} - http://www.pixijs.com/`);
		Je = !0;
	}
}
//#endregion
...
var J = class {
	...
	init(e) {
		if (e.hello) {
			...
			this._renderer.type === l.WEBGL && (e += ` ${this._renderer.context.webGLVersion}`), Ye(e);
		}
	}
};
J.extension = {
...
var Y = class e {
	...
	get enabled() {
		return r("8.15.0", "RenderableGCSystem.enabled is deprecated, please use the GCSystem.enabled instead."), this._renderer.gc.enabled;
	}
	set enabled(e) {
		r("8.15.0", "RenderableGCSystem.enabled is deprecated, please use the GCSystem.enabled instead."), this._renderer.gc.enabled = e;
	}
	addManagedHash(e, t) {
		r("8.15.0", "RenderableGCSystem.addManagedHash is deprecated, please use the GCSystem.addCollection instead."), this._renderer.gc.addCollection(e, t, "hash");
	}
	addManagedArray(e, t) {
		r("8.15.0", "RenderableGCSystem.addManagedArray is deprecated, please use the GCSystem.addCollection instead."), this._renderer.gc.addCollection(e, t, "array");
	}
	addRenderable(e) {
		r("8.15.0", "RenderableGCSystem.addRenderable is deprecated, please use the GCSystem instead."), this._renderer.gc.addResource(e, "renderable");
	}
	run() {
		r("8.15.0", "RenderableGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.run();
	}
	destroy() {
		this._renderer = null;
	}
...
var Xe = Y, X = class e {
	...
	set checkCount(e) {
		r("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._checkCount = e;
	}
	get maxIdle() {
		return this._renderer.gc.maxUnusedTime / 1e3 * 60;
	}
	set maxIdle(e) {
		r("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.maxUnusedTime = e / 60 * 1e3;
	}
	get checkCountMax() {
		return Math.floor(this._renderer.gc._frequency / 1e3);
	}
	set checkCountMax(e) {
		r("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead.");
	}
	get active() {
		return this._renderer.gc.enabled;
	}
	set active(e) {
		r("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.enabled = e;
	}
	constructor(e) {
	...
	run() {
		r("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."), this._renderer.gc.run();
	}
	destroy() {
		this._renderer = null;
	}
...
var Ze = X, Qe = class e {
	constructor(t = {}) {
		if (this.uid = p("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = !1, this._size = /* @__PURE__ */ new Float32Array(2), this._managedColorTextures = !1, t = {
			...e.defaultOptions,
			...t
		}, this.stencil = t.stencil, this.depth = t.depth, this.isRoot = t.isRoot, typeof t.colorTextures == "number") {
			this._managedColorTextures = !0;
			for (let e = 0; e < t.colorTextures; e++) this.colorTextures.push(new _({
				width: t.width,
				height: t.height,
		...
		this.colorTexture.source.on("resize", this.onSourceResize, this), (t.depthStencilTexture || this.stencil) && (t.depthStencilTexture instanceof v || t.depthStencilTexture instanceof _ ? this.depthStencilTexture = t.depthStencilTexture.source : this.ensureDepthStencilTexture());
	}
	get size() {
		let e = this._size;
	...
	ensureDepthStencilTexture() {
		this.depthStencilTexture ||= new _({
			width: this.width,
			height: this.height,
...
var Z = Qe, Q = /* @__PURE__ */ new Map();
c.register(Q);
function $e(e, t) {
	if (!Q.has(e)) {
		let n = new v({ source: new x({
			resource: e,
			...t
		}) }), r = () => {
...
var $ = class e {
	...
	init(t) {
		t = {
			...e.defaultOptions,
			...t
		}, t.view && (r(m, "ViewSystem.view has been renamed to ViewSystem.canvas"), t.canvas = t.view), this.screen = new n(0, 0, t.width, t.height), this.canvas = t.canvas || g.get().createCanvas(), this.antialias = !!t.antialias, this.texture = $e(this.canvas, t), this.renderTarget = new Z({
...
var it = class {
	constructor(e) {
		this.rootViewPort = new n(), this.viewport = new n(), this.mipLevel = 0, this.layer = 0, this.onRenderTargetChange = new A("onRenderTargetChange"), this.projectionMatrix = new i(), this.defaultClearColor = [
			0,
			0,
			0,
			0
	...
	_initRenderTarget(e) {
		let t = null;
		return x.test(e) && (e = $e(e).source), e instanceof Z ? t = e : e instanceof _ && (t = new Z({ colorTextures: [e] }), e.source instanceof x && (t.isRoot = !0), e.once("destroy", () => {
...
//#endregion
export { H as a, L as c, N as d, xe as f, fe as g, k as h, Le as i, I as l, me as m, tt as n, B as o, he as p, et as r, z as s, it as t, F as u };

//# sourceMappingURL=RenderTargetSystem-BdHBY0GA.js.map