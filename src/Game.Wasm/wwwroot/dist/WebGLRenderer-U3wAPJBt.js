import { B as e, M as t, P as n, a as r, i, l as a, p as o, r as s, s as c, t as l, u, v as d, w as f, x as p, z as m } from "./Geometry-DYsNE2Rs.js";
import { a as h, n as g } from "./Filter-BsE1se_H.js";
import { h as _, m as ee, n as te, r as ne, t as re } from "./RenderTargetSystem-BdHBY0GA.js";
import { a as v, f as ie, l as ae, m as y, r as oe, s as se, t as b, u as x } from "./GCManagedHash-CXwB9kU7.js";
import { a as S, c as ce, f as C, i as le, n as ue, o as de, s as fe, t as pe, u as me } from "./BufferResource-D3fKdRii.js";
//#region node_modules/pixi.js/lib/utils/browser/isSafari.mjs
function he() {
	let { userAgent: e } = o.get().getNavigator();
...
var w = /* @__PURE__ */ ((e) => (e[e.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER", e[e.ARRAY_BUFFER = 34962] = "ARRAY_BUFFER", e[e.UNIFORM_BUFFER = 35345] = "UNIFORM_BUFFER", e))(w || {}), _e = class {
	constructor(e, t) {
	...
	updateBuffer(e) {
		...
		let r = e.data, i = e.descriptor.usage & s.STATIC ? t.STATIC_DRAW : t.DYNAMIC_DRAW;
	...
	createGLBuffer(e) {
		...
		e.descriptor.usage & s.INDEX ? n = w.ELEMENT_ARRAY_BUFFER : e.descriptor.usage & s.UNIFORM && (n = w.UNIFORM_BUFFER);
		let r = new _e(t.createBuffer(), n);
...
var E = class e {
	...
	init(t) {
		...
		if (t.context && n && (d("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."), n = !1), this.canvas = n ? o.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this._renderer.view.canvas, t.context) this.initFromContext(t.context);
		else {
	...
	initFromContext(e) {
		this.gl = e, this.webGLVersion = e instanceof o.get().getWebGLRenderingContext() ? 1 : 2, this.getExtensions(), this.validateContext(e), this._renderer.runners.contextChange.emit(e);
	...
	activateVao(e, t) {
		...
		for (let e in i) {
			...
			if (u) {
				...
				let t = a(s.format), i = be(s.format);
...
var we = new l({ attributes: { aPosition: [
	-1,
	-1,
	3,
	-1,
	...
	init(t = {}) {
		...
		this.useBackBuffer = n, this._antialias = r, this._renderer.context.supports.msaa || (d("antialiasing, is not supported on when using the back buffer"), this._antialias = !1), this._state = g.for2d();
		let a = new u({
			vertex: "\n                attribute vec2 aPosition;\n                out vec2 vUv;\n\n                void main() {\n                    gl_Position = vec4(aPosition, 0.0, 1.0);\n\n                    vUv = (aPosition + 1.0) / 2.0;\n\n                    // flip dem UVs\n                    vUv.y = 1.0 - vUv.y;\n                }",
			fragment: "\n                in vec2 vUv;\n                out vec4 finalColor;\n\n                uniform sampler2D uTexture;\n\n                void main() {\n                    finalColor = texture(uTexture, vUv);\n                }",
			name: "big-triangle"
		});
		this._bigTriangleShader = new i({
			glProgram: a,
	...
	_getBackBufferTexture(e) {
		return this._backBufferTexture = this._backBufferTexture || new p({ source: new f({
			width: e.width,
			height: e.height,
...
A.extension = {
	...
	name: "backBuffer",
	priority: 1
}, A.defaultOptions = { useBackBuffer: !1 };
var Te = A, j = class {
	constructor(e) {
...
var N = class {
	...
	contextChange() {
		...
		this.maxTextures = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS), this.maxBatchableTextures = ie(this.maxTextures, e);
...
var Ee = class {
	...
	setStencilMode(e, t) {
		let n = this._renderTargetStencilState[this._activeRenderTarget.uid], r = this._gl, i = fe[e], a = this._stencilCache;
...
function De(e) {
	...
	for (let e = 0; e < t.length; e++) {
		let i = t[e];
		if (n = F[i.data.type], !n) throw Error(`Unknown type ${i.data.type}`);
...
function Oe(e, t) {
	let n = Math.max(F[e.data.type] / 16, 1), r = e.data.value.length / e.data.size, i = (4 - r % 4) % 4, a = e.data.type.indexOf("i32") >= 0 ? "dataInt32" : "data";
	return `
        v = uv.${e.data.name};
        offset += ${t};
...
var Ae = class {
	...
	initGpuRenderTarget(e) {
		let t = this._renderer.gl, n = new Ee();
		return n._attachedMipLevel = 0, n._attachedLayer = 0, e.colorTexture instanceof h ? (this._renderer.context.ensureCanvasSize(e.colorTexture.resource), n.framebuffer = null, n) : (this._initColor(e, n), t.bindFramebuffer(t.FRAMEBUFFER, null), n);
	}
	...
	clear(e, t, n, r, i = 0, a = 0) {
		...
		typeof t == "boolean" && (t = t ? _.ALL : _.NONE);
	...
	prerender(e) {
		...
		this._renderer.context.multiView && h.test(t) && this._renderer.context.ensureCanvasSize(t);
	}
	postrender(e) {
		if (this._renderer.context.multiView && h.test(e.colorTexture.resource)) {
...
function je(e, t) {
	...
	for (let s in e.groups) {
		...
		for (let u in l.resources) {
			...
			if (d instanceof c) {
				if (d.ubo) {
					let t = e._uniformBindMap[s][Number(u)];
					n.push(`
                        sS.bindUniformBlock(
                            resources[${u}],
                            '${t}',
				...
				let c = e._uniformBindMap[s][u], l = o.uniformData[c];
...
function B(e, t) {
	switch (e) {
		...
		case "bool": return !1;
		case "bvec2": return z(2 * t);
		case "bvec3": return z(3 * t);
		case "bvec4": return z(4 * t);
...
function Fe(e, t, n = !1) {
	...
	if (n) {
		o.sort((e, t) => e > t ? 1 : -1);
		for (let n = 0; n < o.length; n++) r[o[n]].location = n, t.bindAttribLocation(e, n, o[n]);
		t.linkProgram(e);
	} else for (let n = 0; n < o.length; n++) r[o[n]].location = t.getAttribLocation(e, o[n]);
	return r;
}
//#endregion
...
function Le(e, t) {
	...
	for (let i = 0; i < r; i++) {
		let r = t.getActiveUniform(e, i), a = r.name.replace(/\[.*?\]$/, ""), o = !!r.name.match(/\[.*?\]$/), s = U(t, r.type);
		n[a] = {
			name: a,
			index: i,
			type: s,
...
function Re(e, t, n, r) {
	e.getProgramParameter(t, e.LINK_STATUS) || (e.getShaderParameter(n, e.COMPILE_STATUS) || W(e, n), e.getShaderParameter(r, e.COMPILE_STATUS) || W(e, r), console.error("PixiJS Error: Could not initialize shader."), e.getProgramInfoLog(t) !== "" && console.warn("PixiJS Warning: gl.getProgramInfoLog()", e.getProgramInfoLog(t)));
}
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/generateProgram.mjs
function ze(e, t) {
	let n = R(e, e.VERTEX_SHADER, t.vertex), r = R(e, e.FRAGMENT_SHADER, t.fragment), i = e.createProgram();
	e.attachShader(i, n), e.attachShader(i, r);
	let a = t.transformFeedbackVaryings;
	a && (typeof e.transformFeedbackVaryings == "function" ? e.transformFeedbackVaryings(i, a.names, a.bufferMode === "separate" ? e.SEPARATE_ATTRIBS : e.INTERLEAVED_ATTRIBS) : d("TransformFeedback is not supported but TransformFeedbackVaryings are given.")), e.linkProgram(i), e.getProgramParameter(i, e.LINK_STATUS) || Re(e, i, n, r), t._attributeData = Fe(i, e, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(t.vertex)), t._uniformData = Le(i, e), t._uniformBlockData = Ie(i, e), e.deleteShader(n), e.deleteShader(r);
	let o = {};
	for (let n in t._uniformData) {
		let r = t._uniformData[n];
		o[n] = {
			location: e.getUniformLocation(i, n),
			value: B(r.type, r.size)
		};
	}
	return new Me(i, o);
}
...
var G = {
	...
	bind(e, t) {
		...
		G.textureCount = 0, G.blockIndex = 0;
		let n = this._shaderSyncFunctions[e.glProgram._key];
		n ||= this._shaderSyncFunctions[e.glProgram._key] = this._generateShaderSync(e, this), this._renderer.buffer.nextBindBase(!!e.glProgram.transformFeedbackVaryings), n(this._renderer, e, G);
	}
	updateUniformGroup(e) {
		this._renderer.uniformGroup.updateUniformGroup(e, this._activeProgram, G);
	}
	...
	_createProgramData(e) {
		let t = e._key;
		return this._programDataHash[t] = ze(this._gl, e), this._programDataHash[t];
	}
	destroy() {
	...
	for (let r in e.uniforms) {
		if (!t[r]) {
			e.uniforms[r] instanceof c ? e.uniforms[r].ubo ? n.push(`
                    ...
                    `) : e.uniforms[r] instanceof pe && n.push(`
		...
		if (!a) {
			let e = (i.size === 1 ? Be : Ve)[i.type].replace("location", `ud["${r}"].location`);
			n.push(`
            cu = ud["${r}"];
            cv = cu.value;
            v = uv["${r}"];
...
function Ue(e) {
	...
	if (t.normal = [e.ONE, e.ONE_MINUS_SRC_ALPHA], t.add = [e.ONE, e.ONE], t.multiply = [
		...
		e.ONE,
		e.ONE_MINUS_SRC_ALPHA
	], t.erase = [e.ZERO, e.ONE_MINUS_SRC_ALPHA], !(e instanceof o.get().getWebGLRenderingContext())) t.min = [
		e.ONE,
		e.ONE,
		e.ONE,
		e.ONE,
...
var Xe = J, Ze = class {
	...
	upload(e, t, n, r, i, a) {
		...
		let s = e.pixelWidth, c = e.pixelHeight, l = !!$e[e.format];
...
function lt(e, t, n, r, i, a, o, s) {
	...
	if (!s || e.addressModeU !== "repeat" || e.addressModeV !== "repeat" || e.addressModeW !== "repeat") {
		let n = Z[o ? "clamp-to-edge" : e.addressModeU], r = Z[o ? "clamp-to-edge" : e.addressModeV], a = Z[o ? "clamp-to-edge" : e.addressModeW];
		t[i](c, t.TEXTURE_WRAP_S, n), t[i](c, t.TEXTURE_WRAP_T, r), t.TEXTURE_WRAP_R && t[i](c, t.TEXTURE_WRAP_R, a);
	}
	if ((!s || e.magFilter !== "linear") && t[i](c, t.TEXTURE_MAG_FILTER, ot[e.magFilter]), n) {
		if (!s || e.mipmapFilter !== "linear") {
			let n = st[e.minFilter][e.mipmapFilter];
			t[i](c, t.TEXTURE_MIN_FILTER, n);
		}
	} else t[i](c, t.TEXTURE_MIN_FILTER, ot[e.minFilter]);
	...
	e.compare && t[i](c, t.TEXTURE_COMPARE_FUNC, ct[e.compare]);
}
//#endregion
...
function dt(e, t) {
	let n = {}, r = e.RGBA;
	return e instanceof o.get().getWebGLRenderingContext() ? t.srgb && (n = {
...
var mt = 4, Q = class e {
	...
	bindSource(e, t = 0) {
		...
		if (e._gcLastUsed = this._renderer.gc.now, this._boundTextures[t] !== e) {
			this._boundTextures[t] = e, this._activateLocation(t), e ||= p.EMPTY.source;
	...
	_initSource(e) {
		let t = this._gl, n = new Ze(t.createTexture());
	...
	updateStyle(e, t) {
		...
		n.bindTexture(r.target, r.texture), this._boundTextures[this._activeTextureLocation] = e, lt(e.style, n, e.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", r.target, !this._renderer.context.supports.nonPowOf2wrapping && !e.isPowerOfTwo, t);
	}
	...
	_initSampler(e) {
		...
		return this._glSamplers[e._resourceId] = n, lt(e, t, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", n, !1, !0), this._glSamplers[e._resourceId];
	}
	_getGlSampler(e) {
	...
	generateCanvas(e) {
		let { pixels: t, width: n, height: r } = this.getPixels(e), i = o.get().createCanvas();
	...
	getPixels(e) {
		let t = e.source.resolution, n = e.frame, r = Math.max(Math.round(n.width * t), 1), i = Math.max(Math.round(n.height * t), 1), a = new Uint8Array(mt * r * i), o = this._renderer, s = o.renderTarget.getRenderTarget(e), c = o.renderTarget.getGpuRenderTarget(s), l = o.gl;
	...
	resetState() {
		this._activeTextureLocation = -1, this._boundTextures.fill(p.EMPTY.source), this._boundSamplers = /* @__PURE__ */ Object.create(null);
		let e = this._gl;
...
var ht = Q;
e.handleByMap(m.TextureUploaderWebGL, ht.uploadExtensions);
//#endregion
...
var $ = class {
	contextChange(e) {
		...
		}), r = e.limits.maxBatchableTextures, a = x({
			name: "graphics",
			bits: [
				ae,
				se(r),
...
e.handleByNamedList(m.WebGLSystem, bt), e.handleByNamedList(m.WebGLPipes, xt), e.handleByNamedList(m.WebGLPipesAdaptor, St), e.add(..._t, ...vt, ...yt);
...
//# sourceMappingURL=WebGLRenderer-U3wAPJBt.js.map