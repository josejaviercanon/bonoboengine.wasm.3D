...
partial struct Tree
{
    ...
    /// Handy for 
    /// </summary>
    /// <param name="child">Child to estimate the cost of.</param>
    /// <returns>Estimated cost of the child.</returns>
    internal static float EstimateCost(NodeChild child) => ComputeBoundsMetric(Unsafe.As<NodeChild, BoundingBox4>(ref child)) * child.LeafCount;
