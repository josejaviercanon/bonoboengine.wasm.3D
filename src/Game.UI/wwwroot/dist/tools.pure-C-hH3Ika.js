...
function te(e) {
	let t = C(e), n = t.length, r = new Uint8Array(new ArrayBuffer(n));
...
}, C = (e) => atob(e), w = (e) => typeof Uint8Array.fromBase64 == "function" ? Uint8Array.fromBase64(e).buffer : te(e);
//#endregion
...
function D(e, t, r, i, a, o, s, c) {
	let l = t * T(r), u = s * t;
	if (r !== 5126 || a !== l) {
		let n = new Float32Array(u);
		return E(e, i, a, t, r, u, o, (e, r) => {
...
var j = /*#__PURE__*/ new RegExp(/^data:([^,]+\/[^,]+)?;base64,/i), M = class e extends x {
	constructor(t, n) {
	...
	if (e instanceof ArrayBuffer || ArrayBuffer.isView(e)) {
		if (typeof Blob < "u" && typeof URL < "u") {
			let t;
			t = e instanceof ArrayBuffer ? e : A(e), c = URL.createObjectURL(new Blob([t], { type: a })), l = !0;
		} else c = `data:${a};base64,` + S(e);
	...
	return o.onloadend = () => s.onCompleteObservable.notifyObservers(s), a && (o.onerror = () => {
		a(new ae(`Unable to read ${t.name}`, t));
	}), o.onload = (e) => {
		n(e.target.result);
	...
	if (u.indexOf("file:") !== -1) {
		...
		if (t) return R(t, r, i, o, c ? (e) => c(void 0, new M(e.message, e.file)) : void 0);
	}
	...
	return B(u, (e, t) => {
		...
		c(e.request, new M(e.message, e.request));
	} : void 0, l);
}, B = (r, i, a, o, s, c, l) => {
			...
			if (e) {
				...
				s && (e.responseType = "arraybuffer"), a && e.addEventListener("progress", a), m && e.addEventListener("loadend", m), r = () => {
					if (!(f || !e) && e.readyState === (XMLHttpRequest.DONE || 4)) {
						...
						let l = new N("Error status: " + e.status + " " + e.statusText + " - Unable to load " + d, e);
						c && c(l);
					}
	...
	return p;
}, V = () => typeof location < "u" && location.protocol === "file:", H = (e) => j.test(e), U = (e) => {
	let t = j.exec(e);
...
var G = (e) => C(e.split(",")[1]), K, q = (e, t, n, r, i, a, o, s, c, l) => {
	K = {
...
//#endregion
export { S as _, z as a, g as b, oe as c, E as d, A as f, w as g, O as h, X as i, B as l, T as m, $ as n, L as o, D as p, Z as r, R as s, ce as t, k as u, b as v, m as x, x as y };

//# sourceMappingURL=tools.pure-C-hH3Ika.js.map