...
import { r as n, t as r } from "./halfFloat-D-N8ggSr.js";
import { t as i } from "./cubemapToSphericalPolynomial-IJmwPlSP.js";
...
var p = /*#__PURE__*/ d("DXT1"), m = /*#__PURE__*/ d("DXT3"), h = /*#__PURE__*/ d("DXT5"), g = /*#__PURE__*/ d("DX10"), _ = 113, v = 116, y = 2, b = 10, x = 88, S = 31, ee = 0, te = 1, C = 2, w = 3, T = 4, E = 7, D = 20, O = 21, k = 22, A = 23, j = 24, M = 25, N = 26, P = 28, F = 32, I = class d {
	...
	static _GetHalfFloatRGBAArrayBuffer(e, t, r, i, a, o) {
		if (d.StoreLODInAlphaChannel) {
			let s = new Uint16Array(i), c = new Uint16Array(a, r), l = 0;
			for (let r = 0; r < t; r++) for (let t = 0; t < e; t++) {
				let i = (t + r * e) * 4;
				s[l] = c[i], s[l + 1] = c[i + 1], s[l + 2] = c[i + 2], s[l + 3] = n(o), l += 4;
			}
			return s;
		}
	...
	static _GetFloatAsHalfFloatRGBAArrayBuffer(e, t, r, i, a, o) {
		let s = new Uint16Array(i), c = new Float32Array(a, r), l = 0;
		for (let r = 0; r < t; r++) for (let t = 0; t < e; t++) s[l] = n(c[l]), s[l + 1] = n(c[l + 1]), s[l + 2] = n(c[l + 2]), d.StoreLODInAlphaChannel ? s[l + 3] = n(o) : s[l + 3] = n(c[l + 3]), l += 4;
		return s;
	}
	...
	static UploadDDSLevels(t, n, r, s, c, l, u = -1, D, P = !0) {
		let F = null;
				...
				if (u === -1 || u === G) {
					...
					if (!s.isCompressed && s.isFourCC) {
						...
						if (t._badOS || t._badDesktopOS || !$.textureHalfFloat && !$.textureFloat) J === 128 ? (a = d._GetFloatAsUIntRGBAArrayBuffer(z, B, r.byteOffset + H, V, r.buffer, i), F && i == 0 && F.push(d._GetFloatRGBAArrayBuffer(z, B, r.byteOffset + H, V, r.buffer, i))) : J === 64 && (a = d._GetHalfFloatAsUIntRGBAArrayBuffer(z, B, r.byteOffset + H, V, r.buffer, i), F && i == 0 && F.push(d._GetHalfFloatAsFloatRGBAArrayBuffer(z, B, r.byteOffset + H, V, r.buffer, i))), n.type = 0;
							...
							n.type = o, a = s(z, B, r.byteOffset + H, V, r.buffer, i), F && i == 0 && F.push(c ? c(z, B, r.byteOffset + H, V, r.buffer, i) : a);
						}
						a && t._uploadDataToTextureDirectly(n, a, e, i);
					} else if (s.isRGB) n.type = 0, J === 24 ? (n.format = 4, V = z * B * 3, U = d._GetRGBArrayBuffer(z, B, r.byteOffset + H, V, r.buffer, X, Z, Q), t._uploadDataToTextureDirectly(n, U, e, i)) : (n.format = 5, V = z * B * 4, U = d._GetRGBAArrayBuffer(z, B, r.byteOffset + H, V, r.buffer, X, Z, Q, ne), t._uploadDataToTextureDirectly(n, U, e, i));
					else if (s.isLuminance) {
						let a = t._getUnpackAlignement(), o = z;
						V = Math.floor((z + a - 1) / a) * a * (B - 1) + o, U = d._GetLuminanceArrayBuffer(z, B, r.byteOffset + H, V, r.buffer), n.format = 1, n.type = 0, t._uploadDataToTextureDirectly(n, U, e, i);
					} else V = Math.max(4, z) / 4 * Math.max(4, B) / 4 * q, U = new Uint8Array(r.buffer, r.byteOffset + H, V), n.type = 0, t._uploadCompressedDataToTextureDirectly(n, K, z, B, U, e, i);
				}
...
//# sourceMappingURL=dds.pure-CZG1A_RM.js.map