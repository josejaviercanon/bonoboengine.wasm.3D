...
import { _ as n, g as r, h as i } from "./precisionDate-BBQlwGEL.js";
import { a, d as o, l as s, n as c, o as l, t as u, u as d } from "./math.color.pure-DTHwqqGz.js";
import { _ as f, m as p, r as m, u as h, v as g } from "./decorators-Dol0xxIL.js";
import { x as ee } from "./tools.pure-C-hH3Ika.js";
...
var _ = class e {
	...
	static MatchesQuery(t, n) {
		return n === void 0 ? !0 : n === "" ? e.HasTags(t) : v.Eval(n, (n) => e.HasTags(t) && t._tags[n]);
	}
}, b = function(e, t, n, r = {}) {
	let i = e();
	y && y.HasTags(t) && y.AddTagsTo(i, y.GetTags(t, !0));
	let a = p(i), o = {};
	for (let e in a) {
		let s = a[e], c = t[e], l = s.type;
		if (c != null && (e !== "uniqueId" || x.AllowLoadingUniqueId)) switch (l) {
			case 0:
			case 6:
			case 9:
			case 11:
	...
	static ParseProperties(t, n, r, i) {
		...
		let f = p(n);
		for (let p in f) {
			let m = f[p], h = t[m.sourceName || p], g = m.type;
	...
	static Parse(t, n, r, i = null) {
		let a = t();
		return y && y.AddTagsTo(a, n.tags), e.ParseProperties(n, a, r, i), a;
	}
	static Clone(e, t, n = {}) {
		return b(e, t, !1, n);
	}
...
x.AllowLoadingUniqueId = !1, x._ImageProcessingConfigurationParser = (e) => {
	throw n("ImageProcessingConfiguration");
}, x._FresnelParametersParser = (e) => {
	throw n("FresnelParameters");
}, x._ColorCurvesParser = (e) => {
	throw n("ColorCurves");
}, x._TextureParser = (e, t, r) => {
	throw n("Texture");
};
//#endregion
...
var S, C = (() => {
	var n;
	let r = te, i = [], o, s = [], c = [], l, u = [], d = [], p, _ = [], v = [], y, b = [], S = [], C, w = [], T = [], E, D = [], O = [], k, A = [], j = [], M, N = [], P = [], F, I = [], L = [], R, z = [], B = [], V, H, U, ne = [], W = [], G, K = [], q = [], J, Y, X, Z, Q, re = [], ie = [], ae, oe = [], $ = [], se, ce, le, ue, de, fe = [], pe = [];
	return n = class extends r {
		...
		constructor(r, a = null) {
			super(null), this.uniqueId = (g(this, i), g(this, s, void 0)), this.name = (g(this, c), g(this, u, void 0)), this.displayName = (g(this, d), g(this, _, void 0)), this.metadata = (g(this, v), g(this, b, null)), this._internalMetadata = g(this, S), this.reservedDataStore = null, this._hasAlpha = g(this, w, !1), this._getAlphaFromRGB = (g(this, T), g(this, D, !1)), this.level = (g(this, O), g(this, A, 1)), this._coordinatesIndex = (g(this, j), g(this, N, 0)), this.optimizeUVAllocation = (g(this, P), g(this, I, !0)), this._coordinatesMode = (g(this, L), g(this, z, 0)), this.wrapR = (g(this, B), g(this, ne, 1)), this.anisotropicFilteringLevel = (g(this, W), g(this, K, n.DEFAULT_ANISOTROPIC_FILTERING_LEVEL)), this._isCube = (g(this, q), !1), this._gammaSpace = !0, this.invertZ = g(this, re, !1), this.lodLevelInAlpha = (g(this, ie), g(this, oe, !1)), this._dominantDirection = (g(this, $), null), this.isRenderTarget = g(this, fe, !1), this._prefiltered = (g(this, pe), !1), this._forceSerialize = !1, this.animations = [], this.onDisposeObservable = new e(), this._onDisposeObserver = null, this._scene = null, this._uid = null, this._parentContainer = null, this._loadingError = !1, r ? n._IsScene(r) ? this._scene = r : this._engine = r : this._scene = t.LastCreatedScene, this._scene && (this.uniqueId = this._scene.getUniqueId(), this._scene.addTexture(this), this._engine = this._scene.getEngine()), this._texture = a, this._uid = null;
		}
		getScene() {
			return this._scene;
		}
		...
		serialize(e = !1) {
			...
			let t = x.Serialize(this);
			return x.AppendSerializedAnimations(this, t), t;
		}
		...
		o = [m()], l = [m()], p = [m()], y = [m()], C = [m("hasAlpha")], E = [m("getAlphaFromRGB")], k = [m()], M = [m("coordinatesIndex")], F = [m()], R = [m("coordinatesMode")], V = [m()], H = [m()], U = [m()], G = [m()], J = [m()], Y = [m()], X = [m()], Z = [m()], Q = [m()], ae = [m()], se = [m()], ce = [m()], le = [m()], ue = [h()], de = [m()], f(n, null, V, {
			kind: "getter",
			name: "wrapU",
			static: !1,
			private: !1,
...
(S = C.prototype).forceSphericalPolynomialsRecompute ?? (S.forceSphericalPolynomialsRecompute = i("BaseTexture", "forceSphericalPolynomialsRecompute")), Object.getOwnPropertyDescriptor(C.prototype, "sphericalPolynomial") || Object.defineProperty(C.prototype, "sphericalPolynomial", r("BaseTexture", "sphericalPolynomial"));
//#endregion
export { _ as i, x as n, y as r, C as t };

//# sourceMappingURL=baseTexture.pure-CaUfUMOl.js.map