...
///     serializes entities either as lightweight structs or as full component payloads.
/// </summary>
public partial class EntityFormatter : IMessagePackFormatter<Entity>
{
    private readonly bool _serializeFullEntity;
    ...
    public EntityFormatter(bool serializeFullEntity)
    {
        _serializeFullEntity = serializeFullEntity;
    }
